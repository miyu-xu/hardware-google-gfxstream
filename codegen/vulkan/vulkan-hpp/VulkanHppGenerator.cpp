                                                           ...
                                                           bool                                      raii ) const
{
  ...
  if ( !templatedParams.empty() )
  {
    ...
    {
      fprintf(stderr, "jasonjason  params[t].name:%s\n",
              params[t].name.c_str());
                                                                                        ...
                                                                                        bool                                               definition ) const
{
  ...
  fprintf(stderr, "jasonjason num return params:%d\n", (int)returnParams.size());
  return "";
}
                                                         ...
                                                         bool                                          onlyThrows ) const
{
  ...
  for ( auto const & cvm : countToVectorMap )
  {
    ...
    if ( cvm.second.size() == 1 )
    {
      fprintf(stderr, "jasonjason commandName:%s paramName:%s paramLen:%s\n",
              commandName.c_str(),
              commandData.params[cvm.second[0]].name.c_str(),
              commandData.params[cvm.second[0]].len.c_str());
