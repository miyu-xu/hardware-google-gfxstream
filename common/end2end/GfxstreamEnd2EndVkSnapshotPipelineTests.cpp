...
TEST_P(GfxstreamEnd2EndVkSnapshotPipelineTest, CanSubmitQueue) {
    ...
    const vkhpp::ImageMemoryBarrier colorAttachmentBarrier{
        ...
        .dstAccessMask = vkhpp::AccessFlagBits::eColorAttachmentRead | vkhpp::AccessFlagBits::eColorAttachmentWrite,
    ...
    commandBuffer->pipelineBarrier(
        vkhpp::PipelineStageFlagBits::eTopOfPipe | vkhpp::PipelineStageFlagBits::eTransfer, vkhpp::PipelineStageFlagBits::eColorAttachmentOutput,
        vkhpp::DependencyFlags(), nullptr, nullptr, colorAttachmentBarrier);
