...
class GfxstreamEnd2EndVkSnapshotPipelineWithMultiSamplingTest : public GfxstreamEnd2EndVkSnapshotPipelineTest { };
...
INSTANTIATE_TEST_CASE_P(GfxstreamEnd2EndTests, GfxstreamEnd2EndVkSnapshotPipelineWithMultiSamplingTest,
                        ::testing::ValuesIn({
                            TestParams{
                                .with_gl = false,
                                .with_vk = true,
