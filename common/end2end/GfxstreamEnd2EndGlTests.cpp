...
TEST_P(GfxstreamEnd2EndGlTest, AhbTextureUploadAndExternalOesBlit) {
    ...
    // Update AHB with `uploadPixel` via texture upload:
    {
        EGLImageKHR uploadAhbImage = mGl->eglCreateImageKHR(mDisplay, EGL_NO_CONTEXT, EGL_NATIVE_BUFFER_ANDROID, ahb, ahbImageAttribs);
    ...
    // Blit from AHB to an additional framebuffer and readback:
    {
        ...
        EGLImageKHR blitAhbImage = mGl->eglCreateImageKHR(mDisplay, EGL_NO_CONTEXT, EGL_NATIVE_BUFFER_ANDROID, ahb, ahbImageAttribs);
