...
TEST_P(GfxstreamEnd2EndVkSnapshotImageTest, ImageContent) {
    ...
    readbackCommandBuffer->copyImageToBuffer(*image, vkhpp::ImageLayout::eTransferDstOptimal, *stagingBuffer, 1, &bufferImageCopy);
    ...
    auto readbackWaitResult = device->waitForFences(*transferFence, VK_TRUE, 3000000000L);
