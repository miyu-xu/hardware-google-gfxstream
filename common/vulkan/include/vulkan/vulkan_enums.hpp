...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  template <> struct FlagTraits<FormatFeatureFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR FormatFeatureFlags allFlags = 
        ...
        | FormatFeatureFlagBits::eSampledImageFilterCubicIMG
#if defined( VK_ENABLE_BETA_EXTENSIONS )
...
;
  ...
  template <> struct FlagTraits<PipelineStageFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineStageFlags allFlags = 
        ...
        | PipelineStageFlagBits::eTaskShaderNV
        | PipelineStageFlagBits::eMeshShaderNV
        ...
        | PipelineStageFlagBits::eNoneKHR;
  };
  ...
  template <> struct FlagTraits<EventCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR EventCreateFlags allFlags = 
          EventCreateFlagBits::eDeviceOnlyKHR;
  };
...
;
  ...
  template <> struct FlagTraits<PipelineCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineCreateFlags allFlags = 
        ...
        | PipelineCreateFlagBits::eVkPipelineRasterizationStateCreateFragmentDensityMapAttachmentEXT
        ...
        | PipelineCreateFlagBits::eFailOnPipelineCompileRequiredEXT
        | PipelineCreateFlagBits::eEarlyReturnOnFailureEXT
  ...
  template <> struct FlagTraits<PipelineShaderStageCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineShaderStageCreateFlags allFlags = 
        ...
        | PipelineShaderStageCreateFlagBits::eRequireFullSubgroupsEXT;
  };
  ...
  template <> struct FlagTraits<ShaderStageFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR ShaderStageFlags allFlags = 
        ...
        | ShaderStageFlagBits::eTaskNV
        | ShaderStageFlagBits::eMeshNV
  ...
  template <> struct FlagTraits<DescriptorPoolCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DescriptorPoolCreateFlags allFlags = 
        ...
        | DescriptorPoolCreateFlagBits::eHostOnlyVALVE;
  };
...
;
  ...
  template <> struct FlagTraits<VideoCodecOperationFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoCodecOperationFlagsKHR allFlags = 
          VideoCodecOperationFlagBitsKHR::eInvalid
        | VideoCodecOperationFlagBitsKHR::eEncodeH264EXT
        | VideoCodecOperationFlagBitsKHR::eEncodeH265EXT
        | VideoCodecOperationFlagBitsKHR::eDecodeH264EXT
        | VideoCodecOperationFlagBitsKHR::eDecodeH265EXT;
  };
  ...
  template <> struct FlagTraits<VideoSessionCreateFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoSessionCreateFlagsKHR allFlags = 
          VideoSessionCreateFlagBitsKHR::eDefault
  ...
  template <> struct FlagTraits<VideoCodingControlFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoCodingControlFlagsKHR allFlags = 
          VideoCodingControlFlagBitsKHR::eDefault
  ...
  template <> struct FlagTraits<VideoCodingQualityPresetFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoCodingQualityPresetFlagsKHR allFlags = 
          VideoCodingQualityPresetFlagBitsKHR::eNormal
        | VideoCodingQualityPresetFlagBitsKHR::ePower
        | VideoCodingQualityPresetFlagBitsKHR::eQuality;
  };
  ...
  template <> struct FlagTraits<VideoDecodeFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoDecodeFlagsKHR allFlags = 
          VideoDecodeFlagBitsKHR::eDefault
        | VideoDecodeFlagBitsKHR::eReserved0;
  };
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
  ...
  template <> struct FlagTraits<VideoEncodeH264CreateFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeH264CreateFlagsEXT allFlags = 
          VideoEncodeH264CreateFlagBitsEXT::eDefault
        | VideoEncodeH264CreateFlagBitsEXT::eReserved0;
  };
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
  ...
  template <> struct FlagTraits<VideoEncodeH265InputModeFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeH265InputModeFlagsEXT allFlags = 
        ...
        | VideoEncodeH265InputModeFlagBitsEXT::eSlice
  ...
  template <> struct FlagTraits<VideoEncodeH265OutputModeFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeH265OutputModeFlagsEXT allFlags = 
        ...
        | VideoEncodeH265OutputModeFlagBitsEXT::eSlice
  ...
  template <> struct FlagTraits<VideoEncodeH265CtbSizeFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeH265CtbSizeFlagsEXT allFlags = 
          VideoEncodeH265CtbSizeFlagBitsEXT::e8
  ...
  template <> struct FlagTraits<VideoEncodeH265CreateFlagBitsEXT>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
  ...
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoDecodeH264PictureLayoutFlagsEXT allFlags = 
          VideoDecodeH264PictureLayoutFlagBitsEXT::eProgressive
  ...
  template <> struct FlagTraits<VideoDecodeH264CreateFlagBitsEXT>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
  ...
  template <> struct FlagTraits<RenderingFlagBitsKHR>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR RenderingFlagsKHR allFlags = 
          RenderingFlagBitsKHR::eContentsSecondaryCommandBuffers
        | RenderingFlagBitsKHR::eSuspending
        | RenderingFlagBitsKHR::eResuming;
  };
  ...
  template <> struct FlagTraits<VideoDecodeH265CreateFlagBitsEXT>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
  ...
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineCreationFeedbackFlagsEXT allFlags = 
          PipelineCreationFeedbackFlagBitsEXT::eValid
  ...
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR ToolPurposeFlagsEXT allFlags = 
          ToolPurposeFlagBitsEXT::eValidation
        | ToolPurposeFlagBitsEXT::eProfiling
        | ToolPurposeFlagBitsEXT::eTracing
        | ToolPurposeFlagBitsEXT::eAdditionalFeatures
        | ToolPurposeFlagBitsEXT::eModifyingFeatures
        | ToolPurposeFlagBitsEXT::eDebugReporting
  ...
  template <> struct FlagTraits<PrivateDataSlotCreateFlagBitsEXT>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
  ...
  template <> struct FlagTraits<PipelineCacheCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineCacheCreateFlags allFlags = 
          PipelineCacheCreateFlagBits::eExternallySynchronizedEXT;
  };
  ...
  template <> struct FlagTraits<VideoEncodeFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeFlagsKHR allFlags = 
          VideoEncodeFlagBitsKHR::eDefault
        | VideoEncodeFlagBitsKHR::eReserved0;
  };
  ...
  template <> struct FlagTraits<VideoEncodeRateControlFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeRateControlFlagsKHR allFlags = 
          VideoEncodeRateControlFlagBitsKHR::eDefault
        | VideoEncodeRateControlFlagBitsKHR::eReset;
  };
  ...
  template <> struct FlagTraits<PipelineStageFlagBits2KHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineStageFlags2KHR allFlags = 
          PipelineStageFlagBits2KHR::eNone
        | PipelineStageFlagBits2KHR::eTopOfPipe
        | PipelineStageFlagBits2KHR::eDrawIndirect
        | PipelineStageFlagBits2KHR::eVertexInput
        | PipelineStageFlagBits2KHR::eVertexShader
        | PipelineStageFlagBits2KHR::eTessellationControlShader
        | PipelineStageFlagBits2KHR::eTessellationEvaluationShader
        | PipelineStageFlagBits2KHR::eGeometryShader
        | PipelineStageFlagBits2KHR::eFragmentShader
        | PipelineStageFlagBits2KHR::eEarlyFragmentTests
        | PipelineStageFlagBits2KHR::eLateFragmentTests
        | PipelineStageFlagBits2KHR::eColorAttachmentOutput
        | PipelineStageFlagBits2KHR::eComputeShader
        | PipelineStageFlagBits2KHR::eAllTransfer
        | PipelineStageFlagBits2KHR::eBottomOfPipe
        | PipelineStageFlagBits2KHR::eHost
        | PipelineStageFlagBits2KHR::eAllGraphics
        | PipelineStageFlagBits2KHR::eAllCommands
        | PipelineStageFlagBits2KHR::eCopy
        | PipelineStageFlagBits2KHR::eResolve
        | PipelineStageFlagBits2KHR::eBlit
        | PipelineStageFlagBits2KHR::eClear
        | PipelineStageFlagBits2KHR::eIndexInput
        | PipelineStageFlagBits2KHR::eVertexAttributeInput
        | PipelineStageFlagBits2KHR::ePreRasterizationShaders
#if defined( VK_ENABLE_BETA_EXTENSIONS )
        | PipelineStageFlagBits2KHR::eVideoDecode
        | PipelineStageFlagBits2KHR::eVideoEncode
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
        | PipelineStageFlagBits2KHR::eTransformFeedbackEXT
        | PipelineStageFlagBits2KHR::eConditionalRenderingEXT
        | PipelineStageFlagBits2KHR::eCommandPreprocessNV
        | PipelineStageFlagBits2KHR::eFragmentShadingRateAttachment
        | PipelineStageFlagBits2KHR::eAccelerationStructureBuild
        | PipelineStageFlagBits2KHR::eRayTracingShader
        | PipelineStageFlagBits2KHR::eFragmentDensityProcessEXT
        | PipelineStageFlagBits2KHR::eTaskShaderNV
        | PipelineStageFlagBits2KHR::eMeshShaderNV
        | PipelineStageFlagBits2KHR::eSubpassShadingHUAWEI
        | PipelineStageFlagBits2KHR::eInvocationMaskHUAWEI;
  };
  ...
  template <> struct FlagTraits<AccessFlagBits2KHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR AccessFlags2KHR allFlags = 
          AccessFlagBits2KHR::eNone
        | AccessFlagBits2KHR::eIndirectCommandRead
        | AccessFlagBits2KHR::eIndexRead
        | AccessFlagBits2KHR::eVertexAttributeRead
        | AccessFlagBits2KHR::eUniformRead
        | AccessFlagBits2KHR::eInputAttachmentRead
        | AccessFlagBits2KHR::eShaderRead
        | AccessFlagBits2KHR::eShaderWrite
        | AccessFlagBits2KHR::eColorAttachmentRead
        | AccessFlagBits2KHR::eColorAttachmentWrite
        | AccessFlagBits2KHR::eDepthStencilAttachmentRead
        | AccessFlagBits2KHR::eDepthStencilAttachmentWrite
        | AccessFlagBits2KHR::eTransferRead
        | AccessFlagBits2KHR::eTransferWrite
        | AccessFlagBits2KHR::eHostRead
        | AccessFlagBits2KHR::eHostWrite
        | AccessFlagBits2KHR::eMemoryRead
        | AccessFlagBits2KHR::eMemoryWrite
        | AccessFlagBits2KHR::eShaderSampledRead
        | AccessFlagBits2KHR::eShaderStorageRead
        | AccessFlagBits2KHR::eShaderStorageWrite
#if defined( VK_ENABLE_BETA_EXTENSIONS )
        | AccessFlagBits2KHR::eVideoDecodeRead
        | AccessFlagBits2KHR::eVideoDecodeWrite
        | AccessFlagBits2KHR::eVideoEncodeRead
        | AccessFlagBits2KHR::eVideoEncodeWrite
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
        | AccessFlagBits2KHR::eTransformFeedbackWriteEXT
        | AccessFlagBits2KHR::eTransformFeedbackCounterReadEXT
        | AccessFlagBits2KHR::eTransformFeedbackCounterWriteEXT
        | AccessFlagBits2KHR::eConditionalRenderingReadEXT
        | AccessFlagBits2KHR::eCommandPreprocessReadNV
        | AccessFlagBits2KHR::eCommandPreprocessWriteNV
        | AccessFlagBits2KHR::eFragmentShadingRateAttachmentRead
        | AccessFlagBits2KHR::eAccelerationStructureRead
        | AccessFlagBits2KHR::eAccelerationStructureWrite
        | AccessFlagBits2KHR::eFragmentDensityMapReadEXT
        | AccessFlagBits2KHR::eColorAttachmentReadNoncoherentEXT
        | AccessFlagBits2KHR::eInvocationMaskReadHUAWEI;
  };
  ...
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR SubmitFlagsKHR allFlags = 
          SubmitFlagBitsKHR::eProtected;
  };
  ...
  template <> struct FlagTraits<FormatFeatureFlagBits2KHR>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR FormatFeatureFlags2KHR allFlags = 
          FormatFeatureFlagBits2KHR::eSampledImage
        | FormatFeatureFlagBits2KHR::eStorageImage
        | FormatFeatureFlagBits2KHR::eStorageImageAtomic
        | FormatFeatureFlagBits2KHR::eUniformTexelBuffer
        | FormatFeatureFlagBits2KHR::eStorageTexelBuffer
        | FormatFeatureFlagBits2KHR::eStorageTexelBufferAtomic
        | FormatFeatureFlagBits2KHR::eVertexBuffer
        | FormatFeatureFlagBits2KHR::eColorAttachment
        | FormatFeatureFlagBits2KHR::eColorAttachmentBlend
        | FormatFeatureFlagBits2KHR::eDepthStencilAttachment
        | FormatFeatureFlagBits2KHR::eBlitSrc
        | FormatFeatureFlagBits2KHR::eBlitDst
        | FormatFeatureFlagBits2KHR::eSampledImageFilterLinear
        | FormatFeatureFlagBits2KHR::eSampledImageFilterCubicEXT
        | FormatFeatureFlagBits2KHR::eTransferSrc
        | FormatFeatureFlagBits2KHR::eTransferDst
        | FormatFeatureFlagBits2KHR::eSampledImageFilterMinmax
        | FormatFeatureFlagBits2KHR::eMidpointChromaSamples
        ...
        | FormatFeatureFlagBits2KHR::eDisjoint
        | FormatFeatureFlagBits2KHR::eCositedChromaSamples
        | FormatFeatureFlagBits2KHR::eStorageReadWithoutFormat
        | FormatFeatureFlagBits2KHR::eStorageWriteWithoutFormat
        | FormatFeatureFlagBits2KHR::eSampledImageDepthComparison
#if defined( VK_ENABLE_BETA_EXTENSIONS )
        | FormatFeatureFlagBits2KHR::eVideoDecodeOutput
        | FormatFeatureFlagBits2KHR::eVideoDecodeDpb
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
        | FormatFeatureFlagBits2KHR::eAccelerationStructureVertexBuffer
        | FormatFeatureFlagBits2KHR::eFragmentDensityMapEXT
        | FormatFeatureFlagBits2KHR::eFragmentShadingRateAttachment
#if defined( VK_ENABLE_BETA_EXTENSIONS )
        | FormatFeatureFlagBits2KHR::eVideoEncodeInput
        | FormatFeatureFlagBits2KHR::eVideoEncodeDpb
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
;
  };
