...
#  endif
  ...
  //=== VK_KHR_dynamic_rendering ===
    ...
    void vkCmdBeginRenderingKHR( VkCommandBuffer commandBuffer, const VkRenderingInfoKHR * pRenderingInfo ) const VULKAN_HPP_NOEXCEPT
    {
  ...
  //=== VK_MVK_moltenvk ===
    ...
    void vkGetMTLDeviceMVK( VkPhysicalDevice physicalDevice, void ** pMTLDevice ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetMTLDeviceMVK( physicalDevice, pMTLDevice );
    }


    VkResult vkSetMTLTextureMVK( VkImage image, void * mtlTexture ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkSetMTLTextureMVK( image, mtlTexture );
    }


    void vkGetMTLTextureMVK( VkImage image, void ** pMTLTexture ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetMTLTextureMVK( image, pMTLTexture );
    }


    void vkGetMTLBufferMVK( VkBuffer buffer, void ** pMTLBuffer ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetMTLBufferMVK( buffer, pMTLBuffer );
    }


    VkResult vkUseIOSurfaceMVK( VkImage image, void * ioSurface ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkUseIOSurfaceMVK( image, ioSurface );
    }


    void vkGetIOSurfaceMVK( VkImage image, void ** pIOSurface ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetIOSurfaceMVK( image, pIOSurface );
    }
  ...
  //=== VK_KHR_maintenance4 ===
    ...
    void vkGetDeviceBufferMemoryRequirementsKHR( VkDevice device, const VkDeviceBufferMemoryRequirementsKHR * pInfo, VkMemoryRequirements2 * pMemoryRequirements ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetDeviceBufferMemoryRequirementsKHR( device, pInfo, pMemoryRequirements );
    }


    void vkGetDeviceImageMemoryRequirementsKHR( VkDevice device, const VkDeviceImageMemoryRequirementsKHR * pInfo, VkMemoryRequirements2 * pMemoryRequirements ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetDeviceImageMemoryRequirementsKHR( device, pInfo, pMemoryRequirements );
    }


    void vkGetDeviceImageSparseMemoryRequirementsKHR( VkDevice device, const VkDeviceImageMemoryRequirementsKHR * pInfo, uint32_t * pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2 * pSparseMemoryRequirements ) const VULKAN_HPP_NOEXCEPT
    {
...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  template <> struct StructExtends<DeviceGroupRenderPassBeginInfo, RenderingInfoKHR>{ enum { value = true }; };
...
#if defined( VK_USE_PLATFORM_ANDROID_KHR )
  //=== VK_ANDROID_native_buffer ===
  template <> struct StructExtends<NativeBufferANDROID, ImageCreateInfo>{ enum { value = true }; };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
  ...
  template <> struct StructExtends<VideoDecodeH264CapabilitiesEXT, VideoCapabilitiesKHR>{ enum { value = true }; };
  ...
  //=== VK_KHR_dynamic_rendering ===
  template <> struct StructExtends<PipelineRenderingCreateInfoKHR, GraphicsPipelineCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceDynamicRenderingFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceDynamicRenderingFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<CommandBufferInheritanceRenderingInfoKHR, CommandBufferInheritanceInfo>{ enum { value = true }; };
  template <> struct StructExtends<RenderingFragmentShadingRateAttachmentInfoKHR, RenderingInfoKHR>{ enum { value = true }; };
  template <> struct StructExtends<RenderingFragmentDensityMapAttachmentInfoEXT, RenderingInfoKHR>{ enum { value = true }; };
  ...
  template <> struct StructExtends<MultiviewPerViewAttributesInfoNVX, RenderingInfoKHR>{ enum { value = true }; };
  ...
  template <> struct StructExtends<VideoDecodeH265CapabilitiesEXT, VideoCapabilitiesKHR>{ enum { value = true }; };
  ...
  template <> struct StructExtends<PhysicalDeviceShaderIntegerDotProductFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceShaderIntegerDotProductFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceShaderIntegerDotProductPropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
  ...
  template <> struct StructExtends<FormatProperties3KHR, FormatProperties2>{ enum { value = true }; };
  ...
  template <> struct StructExtends<PhysicalDeviceGlobalPriorityQueryFeaturesEXT, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceGlobalPriorityQueryFeaturesEXT, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<QueueFamilyGlobalPriorityPropertiesEXT, QueueFamilyProperties2>{ enum { value = true }; };
  ...
  //=== VK_KHR_maintenance4 ===
  template <> struct StructExtends<PhysicalDeviceMaintenance4FeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance4FeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance4PropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
...
#  endif
  ...
  //=== VK_MVK_moltenvk ===
      ...
      vkSetMTLTextureMVK = PFN_vkSetMTLTextureMVK( vkGetInstanceProcAddr( instance, "vkSetMTLTextureMVK" ) );
      vkGetMTLTextureMVK = PFN_vkGetMTLTextureMVK( vkGetInstanceProcAddr( instance, "vkGetMTLTextureMVK" ) );
      vkGetMTLBufferMVK = PFN_vkGetMTLBufferMVK( vkGetInstanceProcAddr( instance, "vkGetMTLBufferMVK" ) );
      vkUseIOSurfaceMVK = PFN_vkUseIOSurfaceMVK( vkGetInstanceProcAddr( instance, "vkUseIOSurfaceMVK" ) );
      vkGetIOSurfaceMVK = PFN_vkGetIOSurfaceMVK( vkGetInstanceProcAddr( instance, "vkGetIOSurfaceMVK" ) );
