...
, vkEnumerateInstanceVersion( PFN_vkEnumerateInstanceVersion( getProcAddr( NULL, "vkEnumerateInstanceVersion" ) ) )
  ...
  //=== VK_MVK_moltenvk ===
        vkGetMTLDeviceMVK = PFN_vkGetMTLDeviceMVK( vkGetInstanceProcAddr( instance, "vkGetMTLDeviceMVK" ) );
  ...
  //=== VK_MVK_moltenvk ===
        vkSetMTLTextureMVK = PFN_vkSetMTLTextureMVK( vkGetDeviceProcAddr( device, "vkSetMTLTextureMVK" ) );
        vkGetMTLTextureMVK = PFN_vkGetMTLTextureMVK( vkGetDeviceProcAddr( device, "vkGetMTLTextureMVK" ) );
        vkGetMTLBufferMVK = PFN_vkGetMTLBufferMVK( vkGetDeviceProcAddr( device, "vkGetMTLBufferMVK" ) );
        vkUseIOSurfaceMVK = PFN_vkUseIOSurfaceMVK( vkGetDeviceProcAddr( device, "vkUseIOSurfaceMVK" ) );
        vkGetIOSurfaceMVK = PFN_vkGetIOSurfaceMVK( vkGetDeviceProcAddr( device, "vkGetIOSurfaceMVK" ) );
  ...
  //=== VK_MVK_moltenvk ===
      ...
      PFN_vkGetMTLTextureMVK vkGetMTLTextureMVK = 0;
      PFN_vkGetMTLBufferMVK vkGetMTLBufferMVK = 0;
      PFN_vkUseIOSurfaceMVK vkUseIOSurfaceMVK = 0;
      PFN_vkGetIOSurfaceMVK vkGetIOSurfaceMVK = 0;
  ...
  //=== VK_KHR_surface ===
    ...
    VULKAN_HPP_NODISCARD  std::vector<VULKAN_HPP_NAMESPACE::SurfaceFormatKHR> getSurfaceFormatsKHR( VULKAN_HPP_NAMESPACE::SurfaceKHR surface ) const ;

    
    VULKAN_HPP_NODISCARD  std::vector<VULKAN_HPP_NAMESPACE::PresentModeKHR> getSurfacePresentModesKHR( VULKAN_HPP_NAMESPACE::SurfaceKHR surface ) const ;
  ...
  //=== VK_MVK_moltenvk ===
    ...
    VULKAN_HPP_NODISCARD  void * getMTLDeviceMVK(  ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_EXT_tooling_info ===
    ...
    VULKAN_HPP_NODISCARD  std::vector<VULKAN_HPP_NAMESPACE::PhysicalDeviceToolPropertiesEXT> getToolPropertiesEXT(  ) const ;
  ...
  //=== VK_ANDROID_native_buffer ===
    ...
    VULKAN_HPP_NODISCARD  int getSwapchainGrallocUsageANDROID( VULKAN_HPP_NAMESPACE::Format format, VULKAN_HPP_NAMESPACE::ImageUsageFlags imageUsage ) const  VULKAN_HPP_NOEXCEPT;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
#ifndef VULKAN_HPP_NO_EXCEPTIONS
  VULKAN_HPP_NODISCARD VULKAN_HPP_RAII_NAMESPACE::PrivateDataSlotEXT createPrivateDataSlotEXT( VULKAN_HPP_NAMESPACE::PrivateDataSlotCreateInfoEXT const & createInfo, VULKAN_HPP_NAMESPACE::Optional<const VULKAN_HPP_NAMESPACE::AllocationCallbacks> allocator = nullptr ) const; 
#endif

    
     void setPrivateDataEXT( VULKAN_HPP_NAMESPACE::ObjectType objectType_, uint64_t objectHandle, VULKAN_HPP_NAMESPACE::PrivateDataSlotEXT privateDataSlot, uint64_t data ) const ;

    
    VULKAN_HPP_NODISCARD  uint64_t getPrivateDataEXT( VULKAN_HPP_NAMESPACE::ObjectType objectType_, uint64_t objectHandle, VULKAN_HPP_NAMESPACE::PrivateDataSlotEXT privateDataSlot ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_KHR_maintenance4 ===
    ...
    VULKAN_HPP_NODISCARD  VULKAN_HPP_NAMESPACE::MemoryRequirements2 getBufferMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceBufferMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT;

    template <typename X, typename Y, typename... Z>
    VULKAN_HPP_NODISCARD  StructureChain<X, Y, Z...> getBufferMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceBufferMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT;

    
    VULKAN_HPP_NODISCARD  VULKAN_HPP_NAMESPACE::MemoryRequirements2 getImageMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT;

    template <typename X, typename Y, typename... Z>
    VULKAN_HPP_NODISCARD  StructureChain<X, Y, Z...> getImageMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT;

    
    VULKAN_HPP_NODISCARD  std::vector<VULKAN_HPP_NAMESPACE::SparseImageMemoryRequirements2> getImageSparseMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const ;
  ...
  //=== VK_MVK_moltenvk ===
    ...
    VULKAN_HPP_NODISCARD  void * getMTLMVK(  ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_KHR_synchronization2 ===
     ...
     void setEvent2KHR( VULKAN_HPP_NAMESPACE::Event event, const VULKAN_HPP_NAMESPACE::DependencyInfoKHR & dependencyInfo ) const  VULKAN_HPP_NOEXCEPT;

    
     void resetEvent2KHR( VULKAN_HPP_NAMESPACE::Event event, VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stageMask ) const  VULKAN_HPP_NOEXCEPT;

    
     void waitEvents2KHR( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::Event> const & events, VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::DependencyInfoKHR> const & dependencyInfos ) const ;

    
     void pipelineBarrier2KHR( const VULKAN_HPP_NAMESPACE::DependencyInfoKHR & dependencyInfo ) const  VULKAN_HPP_NOEXCEPT;

    
     void writeTimestamp2KHR( VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stage, VULKAN_HPP_NAMESPACE::QueryPool queryPool, uint32_t query ) const  VULKAN_HPP_NOEXCEPT;

    
     void writeBufferMarker2AMD( VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stage, VULKAN_HPP_NAMESPACE::Buffer dstBuffer, VULKAN_HPP_NAMESPACE::DeviceSize dstOffset, uint32_t marker ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_KHR_copy_commands2 ===
     ...
     void copyBufferToImage2KHR( const VULKAN_HPP_NAMESPACE::CopyBufferToImageInfo2KHR & copyBufferToImageInfo ) const  VULKAN_HPP_NOEXCEPT;

    
     void copyImageToBuffer2KHR( const VULKAN_HPP_NAMESPACE::CopyImageToBufferInfo2KHR & copyImageToBufferInfo ) const  VULKAN_HPP_NOEXCEPT;

    
     void blitImage2KHR( const VULKAN_HPP_NAMESPACE::BlitImageInfo2KHR & blitImageInfo ) const  VULKAN_HPP_NOEXCEPT;

    
     void resolveImage2KHR( const VULKAN_HPP_NAMESPACE::ResolveImageInfo2KHR & resolveImageInfo ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_EXT_multi_draw ===
     ...
     void drawMultiEXT( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::MultiDrawInfoEXT> const & vertexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride ) const  VULKAN_HPP_NOEXCEPT;

    
     void drawMultiIndexedEXT( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::MultiDrawIndexedInfoEXT> const & indexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride, Optional<const int32_t> vertexOffset VULKAN_HPP_DEFAULT_ARGUMENT_NULLPTR_ASSIGNMENT ) const  VULKAN_HPP_NOEXCEPT;
  ...
  //=== VK_ANDROID_native_buffer ===
     ...
     void acquireANDROID( int nativeFenceFd, VULKAN_HPP_NAMESPACE::Semaphore semaphore, VULKAN_HPP_NAMESPACE::Fence fence ) const  VULKAN_HPP_NOEXCEPT;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/

  //=== VK_MVK_moltenvk ===

    template <typename mtlTextureType>
    VULKAN_HPP_NODISCARD  mtlTextureType setMTLTextureMVK(  ) const  VULKAN_HPP_NOEXCEPT;

    
    VULKAN_HPP_NODISCARD  void * getMTLTextureMVK(  ) const  VULKAN_HPP_NOEXCEPT;

    template <typename ioSurfaceType>
    VULKAN_HPP_NODISCARD  ioSurfaceType useIOSurfaceMVK(  ) const  VULKAN_HPP_NOEXCEPT;

    
    VULKAN_HPP_NODISCARD  void * getIOSurfaceMVK(  ) const  VULKAN_HPP_NOEXCEPT;
  ...
  public:
    ...
    static android::base::expected<PrivateDataSlotEXT, VULKAN_HPP_NAMESPACE::Result> create( VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device const & device, VULKAN_HPP_NAMESPACE::PrivateDataSlotCreateInfoEXT const & createInfo, VULKAN_HPP_NAMESPACE::Optional<const VULKAN_HPP_NAMESPACE::AllocationCallbacks> allocator = nullptr ) 
    {
      VkPrivateDataSlotEXT privateDataSlot;
      VULKAN_HPP_NAMESPACE::Result result = static_cast<VULKAN_HPP_NAMESPACE::Result>( device.getDispatcher()->vkCreatePrivateDataSlotEXT( static_cast<VkDevice>( *device ), reinterpret_cast<const VkPrivateDataSlotCreateInfoEXT *>( &createInfo ), reinterpret_cast<const VkAllocationCallbacks *>(static_cast<const VULKAN_HPP_NAMESPACE::AllocationCallbacks *>( allocator ) ), reinterpret_cast<VkPrivateDataSlotEXT*>( &privateDataSlot ) ) );
      if ( result != VULKAN_HPP_NAMESPACE::Result::eSuccess )
      {
        return android::base::unexpected(result);
      }

      return VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::PrivateDataSlotEXT(device, privateDataSlot, allocator);
    }



#ifndef VULKAN_HPP_NO_EXCEPTIONS
    PrivateDataSlotEXT( VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device const & device, VULKAN_HPP_NAMESPACE::PrivateDataSlotCreateInfoEXT const & createInfo, VULKAN_HPP_NAMESPACE::Optional<const VULKAN_HPP_NAMESPACE::AllocationCallbacks> allocator = nullptr )
      : m_device( *device ), m_allocator( static_cast<const VULKAN_HPP_NAMESPACE::AllocationCallbacks *>( allocator ) ), m_dispatcher( device.getDispatcher() )
    {
      VULKAN_HPP_NAMESPACE::Result result = static_cast<VULKAN_HPP_NAMESPACE::Result>( device.getDispatcher()->vkCreatePrivateDataSlotEXT( static_cast<VkDevice>( *device ), reinterpret_cast<const VkPrivateDataSlotCreateInfoEXT *>( &createInfo ), reinterpret_cast<const VkAllocationCallbacks *>( m_allocator ), reinterpret_cast<VkPrivateDataSlotEXT*>( &privateDataSlot ) ) );
      if ( result != VULKAN_HPP_NAMESPACE::Result::eSuccess )
      {
    ...
    PrivateDataSlotEXT( VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device const & device, VkPrivateDataSlotEXT privateDataSlot, VULKAN_HPP_NAMESPACE::Optional<const VULKAN_HPP_NAMESPACE::AllocationCallbacks> allocator = nullptr )
    ...
    void clear() VULKAN_HPP_NOEXCEPT
    {
        ...
        {
          getDispatcher()->vkDestroyPrivateDataSlotEXT( static_cast<VkDevice>( m_device ), static_cast<VkPrivateDataSlotEXT>( m_privateDataSlot ), reinterpret_cast<const VkAllocationCallbacks *>( m_allocator ) );
        }
      m_device = nullptr;
    ...
    VULKAN_HPP_NAMESPACE::PrivateDataSlotEXT release()
    {
    ...
    void swap( VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::PrivateDataSlotEXT & rhs ) VULKAN_HPP_NOEXCEPT
    {
  ...
  //=== VK_ANDROID_native_buffer ===
    ...
    VULKAN_HPP_NODISCARD  int signalReleaseImageANDROID( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::Semaphore> const & waitSemaphores, VULKAN_HPP_NAMESPACE::Image image ) const  VULKAN_HPP_NOEXCEPT;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
  ...
  //=== VK_KHR_synchronization2 ===
     ...
     void submit2KHR( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::SubmitInfo2KHR> const & submits, VULKAN_HPP_NAMESPACE::Fence fence VULKAN_HPP_DEFAULT_ARGUMENT_ASSIGNMENT ) const ;
  ...
  //=== VK_KHR_video_queue ===
    ...
    VULKAN_HPP_NODISCARD  std::vector<VULKAN_HPP_NAMESPACE::VideoGetMemoryPropertiesKHR> getMemoryRequirements(  ) const ;
     ...
     void bindMemory( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::VideoBindMemoryKHR> const & videoSessionBindMemories ) const ;
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetPhysicalDeviceWin32PresentationSupportKHR && "Function <vkGetPhysicalDeviceWin32PresentationSupportKHR> needs extension <VK_KHR_win32_surface> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE int Device::getSwapchainGrallocUsageANDROID( VULKAN_HPP_NAMESPACE::Format format, VULKAN_HPP_NAMESPACE::ImageUsageFlags imageUsage ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetSwapchainGrallocUsageANDROID && "Function <vkGetSwapchainGrallocUsageANDROID> needs extension <VK_ANDROID_native_buffer> enabled!" );

    
    int grallocUsage;
    getDispatcher()->vkGetSwapchainGrallocUsageANDROID( static_cast<VkDevice>( m_device ), static_cast<VkFormat>( format ), static_cast<VkImageUsageFlags>( imageUsage ), &grallocUsage );
   ...
   VULKAN_HPP_INLINE void Image::acquireANDROID( int nativeFenceFd, VULKAN_HPP_NAMESPACE::Semaphore semaphore, VULKAN_HPP_NAMESPACE::Fence fence ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkAcquireImageANDROID && "Function <vkAcquireImageANDROID> needs extension <VK_ANDROID_native_buffer> enabled!" );

    
    
    getDispatcher()->vkAcquireImageANDROID( static_cast<VkDevice>( m_device ), static_cast<VkImage>( m_image ), nativeFenceFd, static_cast<VkSemaphore>( semaphore ), static_cast<VkFence>( fence ) );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE int Queue::signalReleaseImageANDROID( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::Semaphore> const & waitSemaphores, VULKAN_HPP_NAMESPACE::Image image ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkQueueSignalReleaseImageANDROID && "Function <vkQueueSignalReleaseImageANDROID> needs extension <VK_ANDROID_native_buffer> enabled!" );

    
    int nativeFenceFd;
    getDispatcher()->vkQueueSignalReleaseImageANDROID( static_cast<VkQueue>( m_queue ), waitSemaphores.size(), reinterpret_cast<const VkSemaphore *>( waitSemaphores.data() ), static_cast<VkImage>( image ), &nativeFenceFd );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetPhysicalDeviceVideoCapabilitiesKHR && "Function <vkGetPhysicalDeviceVideoCapabilitiesKHR> needs extension <VK_KHR_video_queue> enabled!" );
    ...
    VkResult result = getDispatcher()->vkGetPhysicalDeviceVideoCapabilitiesKHR( static_cast<VkPhysicalDevice>( m_physicalDevice ), reinterpret_cast<const VkVideoProfileKHR *>( &videoProfile ), reinterpret_cast<VkVideoCapabilitiesKHR *>( &capabilities ) );
  ...
  template <typename X, typename Y, typename... Z>
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE StructureChain<X, Y, Z...> PhysicalDevice::getVideoCapabilitiesKHR( const VULKAN_HPP_NAMESPACE::VideoProfileKHR & videoProfile ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetPhysicalDeviceVideoCapabilitiesKHR && "Function <vkGetPhysicalDeviceVideoCapabilitiesKHR> needs extension <VK_KHR_video_queue> enabled!" );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetVideoSessionMemoryRequirementsKHR && "Function <vkGetVideoSessionMemoryRequirementsKHR> needs extension <VK_KHR_video_queue> enabled!" );
    ...
    do
    {
      result = getDispatcher()->vkGetVideoSessionMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), static_cast<VkVideoSessionKHR>( m_videoSession ), &videoSessionMemoryRequirementsCount, nullptr );
      if ( ( result == VK_SUCCESS ) && videoSessionMemoryRequirementsCount )
      {
        ...
        result = getDispatcher()->vkGetVideoSessionMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), static_cast<VkVideoSessionKHR>( m_videoSession ), &videoSessionMemoryRequirementsCount, reinterpret_cast<VkVideoGetMemoryPropertiesKHR *>( videoSessionMemoryRequirements.data() ) );
      }
    } while ( result == VK_INCOMPLETE );
   ...
   VULKAN_HPP_INLINE void VideoSessionKHR::bindMemory( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::VideoBindMemoryKHR> const & videoSessionBindMemories ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkBindVideoSessionMemoryKHR && "Function <vkBindVideoSessionMemoryKHR> needs extension <VK_KHR_video_queue> enabled!" );
    ...
    VkResult result = getDispatcher()->vkBindVideoSessionMemoryKHR( static_cast<VkDevice>( m_device ), static_cast<VkVideoSessionKHR>( m_videoSession ), videoSessionBindMemories.size(), reinterpret_cast<const VkVideoBindMemoryKHR *>( videoSessionBindMemories.data() ) );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetShaderInfoAMD && "Function <vkGetShaderInfoAMD> needs extension <VK_AMD_shader_info> enabled!" );
  ...
  //=== VK_KHR_dynamic_rendering ===
   ...
   VULKAN_HPP_INLINE void CommandBuffer::beginRenderingKHR( const VULKAN_HPP_NAMESPACE::RenderingInfoKHR & renderingInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDisplayPlaneCapabilities2KHR && "Function <vkGetDisplayPlaneCapabilities2KHR> needs extension <VK_KHR_get_display_properties2> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE void * PhysicalDevice::getMTLDeviceMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetMTLDeviceMVK && "Function <vkGetMTLDeviceMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    void * mTLDevice;
    getDispatcher()->vkGetMTLDeviceMVK( static_cast<VkPhysicalDevice>( m_physicalDevice ), &mTLDevice );
  ...
  template <typename mtlTextureType>
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE mtlTextureType Image::setMTLTextureMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkSetMTLTextureMVK && "Function <vkSetMTLTextureMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    mtlTextureType mtlTexture;
    getDispatcher()->vkSetMTLTextureMVK( static_cast<VkImage>( m_image ), &mtlTexture );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE void * Image::getMTLTextureMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetMTLTextureMVK && "Function <vkGetMTLTextureMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    void * mTLTexture;
    getDispatcher()->vkGetMTLTextureMVK( static_cast<VkImage>( m_image ), &mTLTexture );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE void * Buffer::getMTLMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetMTLBufferMVK && "Function <vkGetMTLBufferMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    void * mTLBuffer;
    getDispatcher()->vkGetMTLBufferMVK( static_cast<VkBuffer>( m_buffer ), &mTLBuffer );
  ...
  template <typename ioSurfaceType>
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE ioSurfaceType Image::useIOSurfaceMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkUseIOSurfaceMVK && "Function <vkUseIOSurfaceMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    ioSurfaceType ioSurface;
    getDispatcher()->vkUseIOSurfaceMVK( static_cast<VkImage>( m_image ), &ioSurface );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE void * Image::getIOSurfaceMVK(  ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetIOSurfaceMVK && "Function <vkGetIOSurfaceMVK> needs extension <VK_MVK_moltenvk> enabled!" );

    
    void * iOSurface;
    getDispatcher()->vkGetIOSurfaceMVK( static_cast<VkImage>( m_image ), &iOSurface );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkGetBufferDeviceAddressEXT && "Function <vkGetBufferDeviceAddressEXT> needs extension <VK_EXT_buffer_device_address> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE std::vector<VULKAN_HPP_NAMESPACE::PhysicalDeviceToolPropertiesEXT> PhysicalDevice::getToolPropertiesEXT(  ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetPhysicalDeviceToolPropertiesEXT && "Function <vkGetPhysicalDeviceToolPropertiesEXT> needs extension <VK_EXT_tooling_info> enabled!" );
    ...
    do
    {
      ...
      if ( ( result == VK_SUCCESS ) && toolCount )
      {
        ...
        result = getDispatcher()->vkGetPhysicalDeviceToolPropertiesEXT( static_cast<VkPhysicalDevice>( m_physicalDevice ), &toolCount, reinterpret_cast<VkPhysicalDeviceToolPropertiesEXT *>( toolProperties.data() ) );
      }
    } while ( result == VK_INCOMPLETE );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkWaitForPresentKHR && "Function <vkWaitForPresentKHR> needs extension <VK_KHR_present_wait> enabled!" );
    ...
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::SwapchainKHR::waitForPresent", { VULKAN_HPP_NAMESPACE::Result::eSuccess, VULKAN_HPP_NAMESPACE::Result::eTimeout } );
...
#ifndef VULKAN_HPP_NO_EXCEPTIONS
  VULKAN_HPP_NODISCARD VULKAN_HPP_INLINE VULKAN_HPP_RAII_NAMESPACE::PrivateDataSlotEXT Device::createPrivateDataSlotEXT( VULKAN_HPP_NAMESPACE::PrivateDataSlotCreateInfoEXT const & createInfo, VULKAN_HPP_NAMESPACE::Optional<const VULKAN_HPP_NAMESPACE::AllocationCallbacks> allocator ) const 
  {
   ...
   VULKAN_HPP_INLINE void Device::setPrivateDataEXT( VULKAN_HPP_NAMESPACE::ObjectType objectType_, uint64_t objectHandle, VULKAN_HPP_NAMESPACE::PrivateDataSlotEXT privateDataSlot, uint64_t data ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkSetPrivateDataEXT && "Function <vkSetPrivateDataEXT> needs extension <VK_EXT_private_data> enabled!" );
    ...
    VkResult result = getDispatcher()->vkSetPrivateDataEXT( static_cast<VkDevice>( m_device ), static_cast<VkObjectType>( objectType_ ), objectHandle, static_cast<VkPrivateDataSlotEXT>( privateDataSlot ), data );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE uint64_t Device::getPrivateDataEXT( VULKAN_HPP_NAMESPACE::ObjectType objectType_, uint64_t objectHandle, VULKAN_HPP_NAMESPACE::PrivateDataSlotEXT privateDataSlot ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetPrivateDataEXT && "Function <vkGetPrivateDataEXT> needs extension <VK_EXT_private_data> enabled!" );
    ...
    uint64_t data;
    getDispatcher()->vkGetPrivateDataEXT( static_cast<VkDevice>( m_device ), static_cast<VkObjectType>( objectType_ ), objectHandle, static_cast<VkPrivateDataSlotEXT>( privateDataSlot ), &data );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdEncodeVideoKHR && "Function <vkCmdEncodeVideoKHR> needs extension <VK_KHR_video_encode_queue> enabled!" );
  ...
  //=== VK_KHR_synchronization2 ===
   ...
   VULKAN_HPP_INLINE void CommandBuffer::setEvent2KHR( VULKAN_HPP_NAMESPACE::Event event, const VULKAN_HPP_NAMESPACE::DependencyInfoKHR & dependencyInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdSetEvent2KHR && "Function <vkCmdSetEvent2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    getDispatcher()->vkCmdSetEvent2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), static_cast<VkEvent>( event ), reinterpret_cast<const VkDependencyInfoKHR *>( &dependencyInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::resetEvent2KHR( VULKAN_HPP_NAMESPACE::Event event, VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stageMask ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdResetEvent2KHR && "Function <vkCmdResetEvent2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    getDispatcher()->vkCmdResetEvent2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), static_cast<VkEvent>( event ), static_cast<VkPipelineStageFlags2KHR>( stageMask ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::waitEvents2KHR( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::Event> const & events, VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::DependencyInfoKHR> const & dependencyInfos ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdWaitEvents2KHR && "Function <vkCmdWaitEvents2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    if ( events.size() != dependencyInfos.size() )
  {
    ...
    getDispatcher()->vkCmdWaitEvents2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), events.size(), reinterpret_cast<const VkEvent *>( events.data() ), reinterpret_cast<const VkDependencyInfoKHR *>( dependencyInfos.data() ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::pipelineBarrier2KHR( const VULKAN_HPP_NAMESPACE::DependencyInfoKHR & dependencyInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdPipelineBarrier2KHR && "Function <vkCmdPipelineBarrier2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    getDispatcher()->vkCmdPipelineBarrier2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkDependencyInfoKHR *>( &dependencyInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::writeTimestamp2KHR( VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stage, VULKAN_HPP_NAMESPACE::QueryPool queryPool, uint32_t query ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdWriteTimestamp2KHR && "Function <vkCmdWriteTimestamp2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    getDispatcher()->vkCmdWriteTimestamp2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), static_cast<VkPipelineStageFlags2KHR>( stage ), static_cast<VkQueryPool>( queryPool ), query );
   ...
   VULKAN_HPP_INLINE void Queue::submit2KHR( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::SubmitInfo2KHR> const & submits, VULKAN_HPP_NAMESPACE::Fence fence ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkQueueSubmit2KHR && "Function <vkQueueSubmit2KHR> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    VkResult result = getDispatcher()->vkQueueSubmit2KHR( static_cast<VkQueue>( m_queue ), submits.size(), reinterpret_cast<const VkSubmitInfo2KHR *>( submits.data() ), static_cast<VkFence>( fence ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::writeBufferMarker2AMD( VULKAN_HPP_NAMESPACE::PipelineStageFlags2KHR stage, VULKAN_HPP_NAMESPACE::Buffer dstBuffer, VULKAN_HPP_NAMESPACE::DeviceSize dstOffset, uint32_t marker ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdWriteBufferMarker2AMD && "Function <vkCmdWriteBufferMarker2AMD> needs extension <VK_KHR_synchronization2> enabled!" );
    ...
    getDispatcher()->vkCmdWriteBufferMarker2AMD( static_cast<VkCommandBuffer>( m_commandBuffer ), static_cast<VkPipelineStageFlags2KHR>( stage ), static_cast<VkBuffer>( dstBuffer ), static_cast<VkDeviceSize>( dstOffset ), marker );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdSetFragmentShadingRateEnumNV && "Function <vkCmdSetFragmentShadingRateEnumNV> needs extension <VK_NV_fragment_shading_rate_enums> enabled!" );
  ...
  //=== VK_KHR_copy_commands2 ===
   ...
   VULKAN_HPP_INLINE void CommandBuffer::copyBuffer2KHR( const VULKAN_HPP_NAMESPACE::CopyBufferInfo2KHR & copyBufferInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdCopyBuffer2KHR && "Function <vkCmdCopyBuffer2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdCopyBuffer2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkCopyBufferInfo2KHR *>( &copyBufferInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::copyImage2KHR( const VULKAN_HPP_NAMESPACE::CopyImageInfo2KHR & copyImageInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdCopyImage2KHR && "Function <vkCmdCopyImage2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdCopyImage2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkCopyImageInfo2KHR *>( &copyImageInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::copyBufferToImage2KHR( const VULKAN_HPP_NAMESPACE::CopyBufferToImageInfo2KHR & copyBufferToImageInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdCopyBufferToImage2KHR && "Function <vkCmdCopyBufferToImage2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdCopyBufferToImage2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkCopyBufferToImageInfo2KHR *>( &copyBufferToImageInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::copyImageToBuffer2KHR( const VULKAN_HPP_NAMESPACE::CopyImageToBufferInfo2KHR & copyImageToBufferInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdCopyImageToBuffer2KHR && "Function <vkCmdCopyImageToBuffer2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdCopyImageToBuffer2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkCopyImageToBufferInfo2KHR *>( &copyImageToBufferInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::blitImage2KHR( const VULKAN_HPP_NAMESPACE::BlitImageInfo2KHR & blitImageInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdBlitImage2KHR && "Function <vkCmdBlitImage2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdBlitImage2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkBlitImageInfo2KHR *>( &blitImageInfo ) );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::resolveImage2KHR( const VULKAN_HPP_NAMESPACE::ResolveImageInfo2KHR & resolveImageInfo ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdResolveImage2KHR && "Function <vkCmdResolveImage2KHR> needs extension <VK_KHR_copy_commands2> enabled!" );
    ...
    getDispatcher()->vkCmdResolveImage2KHR( static_cast<VkCommandBuffer>( m_commandBuffer ), reinterpret_cast<const VkResolveImageInfo2KHR *>( &resolveImageInfo ) );
...
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdSetColorWriteEnableEXT && "Function <vkCmdSetColorWriteEnableEXT> needs extension <VK_EXT_color_write_enable> enabled!" );
  ...
  //=== VK_EXT_multi_draw ===
   ...
   VULKAN_HPP_INLINE void CommandBuffer::drawMultiEXT( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::MultiDrawInfoEXT> const & vertexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkCmdDrawMultiEXT && "Function <vkCmdDrawMultiEXT> needs extension <VK_EXT_multi_draw> enabled!" );
   ...
   VULKAN_HPP_INLINE void CommandBuffer::drawMultiIndexedEXT( VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::MultiDrawIndexedInfoEXT> const & indexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride, Optional<const int32_t> vertexOffset ) const  VULKAN_HPP_NOEXCEPT 
  {
...
VULKAN_HPP_ASSERT( getDispatcher()->vkSetDeviceMemoryPriorityEXT && "Function <vkSetDeviceMemoryPriorityEXT> needs extension <VK_EXT_pageable_device_local_memory> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::MemoryRequirements2 Device::getBufferMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceBufferMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDeviceBufferMemoryRequirementsKHR && "Function <vkGetDeviceBufferMemoryRequirementsKHR> needs extension <VK_KHR_maintenance4> enabled!" );
    ...
    VULKAN_HPP_NAMESPACE::MemoryRequirements2 memoryRequirements;
    getDispatcher()->vkGetDeviceBufferMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), reinterpret_cast<const VkDeviceBufferMemoryRequirementsKHR *>( &info ), reinterpret_cast<VkMemoryRequirements2 *>( &memoryRequirements ) );
  ...
  template <typename X, typename Y, typename... Z>
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE StructureChain<X, Y, Z...> Device::getBufferMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceBufferMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDeviceBufferMemoryRequirementsKHR && "Function <vkGetDeviceBufferMemoryRequirementsKHR> needs extension <VK_KHR_maintenance4> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::MemoryRequirements2 Device::getImageMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDeviceImageMemoryRequirementsKHR && "Function <vkGetDeviceImageMemoryRequirementsKHR> needs extension <VK_KHR_maintenance4> enabled!" );
    ...
    VULKAN_HPP_NAMESPACE::MemoryRequirements2 memoryRequirements;
    getDispatcher()->vkGetDeviceImageMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), reinterpret_cast<const VkDeviceImageMemoryRequirementsKHR *>( &info ), reinterpret_cast<VkMemoryRequirements2 *>( &memoryRequirements ) );
  ...
  template <typename X, typename Y, typename... Z>
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE StructureChain<X, Y, Z...> Device::getImageMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const  VULKAN_HPP_NOEXCEPT 
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDeviceImageMemoryRequirementsKHR && "Function <vkGetDeviceImageMemoryRequirementsKHR> needs extension <VK_KHR_maintenance4> enabled!" );
  ...
  VULKAN_HPP_NODISCARD  VULKAN_HPP_INLINE std::vector<VULKAN_HPP_NAMESPACE::SparseImageMemoryRequirements2> Device::getImageSparseMemoryRequirementsKHR( const VULKAN_HPP_NAMESPACE::DeviceImageMemoryRequirementsKHR & info ) const  
  {
VULKAN_HPP_ASSERT( getDispatcher()->vkGetDeviceImageSparseMemoryRequirementsKHR && "Function <vkGetDeviceImageSparseMemoryRequirementsKHR> needs extension <VK_KHR_maintenance4> enabled!" );
    ...
    std::vector<VULKAN_HPP_NAMESPACE::SparseImageMemoryRequirements2> sparseMemoryRequirements;
    uint32_t sparseMemoryRequirementCount;
    getDispatcher()->vkGetDeviceImageSparseMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), reinterpret_cast<const VkDeviceImageMemoryRequirementsKHR *>( &info ), &sparseMemoryRequirementCount, nullptr );
    sparseMemoryRequirements.resize( sparseMemoryRequirementCount );
    getDispatcher()->vkGetDeviceImageSparseMemoryRequirementsKHR( static_cast<VkDevice>( m_device ), reinterpret_cast<const VkDeviceImageMemoryRequirementsKHR *>( &info ), &sparseMemoryRequirementCount, reinterpret_cast<VkSparseImageMemoryRequirements2 *>( sparseMemoryRequirements.data() ) );
