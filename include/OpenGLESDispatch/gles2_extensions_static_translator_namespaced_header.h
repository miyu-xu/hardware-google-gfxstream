// Auto-generated with: android/scripts/gen-entries.py --mode=static_translator_namespaced_header host/gl/OpenGLESDispatch/gles2_extensions.entries --output=include/OpenGLESDispatch/gles2_extensions_static_translator_namespaced_header.h
