// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs host/gl/OpenGLESDispatch/gles2_extensions.entries --output=include/OpenGLESDispatch/gles2_extensions_functions.h
...
#define LIST_GLES2_EXTENSIONS_FUNCTIONS(X) \
  ...
  X(void, glGetObjectLabelEXT, (GLenum type, GLuint object, GLsizei bufSize, GLsizei * length, GLchar * label), (type, object, bufSize, length, label)) \
  X(void, glLabelObjectEXT, (GLenum type, GLuint object, GLsizei length, const GLchar * label), (type, object, length, label)) \
