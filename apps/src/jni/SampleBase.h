...
class SampleBase {
  public:
    ...
    virtual Result<Ok> CreateSwapchainDependents(const SwapchainInfo& /*info*/) { return Ok{}; }
  ...
  protected:
    ...
    Result<Ok> LoadYuvImage(const vkhpp::UniqueImage& image,
                            uint32_t width,
                            uint32_t height,
