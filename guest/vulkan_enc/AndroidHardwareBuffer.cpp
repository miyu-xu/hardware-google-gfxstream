    ...
    if (ahbFormatProps) {
        switch (format) {
            ...
            case AHARDWAREBUFFER_FORMAT_R8G8B8A8_UNORM:
                ...
                ahbFormatProps->externalFormat = DRM_FORMAT_RGBA8888;
                break;
            case AHARDWAREBUFFER_FORMAT_R8G8B8X8_UNORM:
                ahbFormatProps->format = VK_FORMAT_R8G8B8A8_UNORM;
                ahbFormatProps->externalFormat = DRM_FORMAT_RGBX8888;
                break;
            case AHARDWAREBUFFER_FORMAT_R8G8B8_UNORM:
                ahbFormatProps->format = VK_FORMAT_R8G8B8_UNORM;
                ahbFormatProps->externalFormat = DRM_FORMAT_RGB888;
                break;
            ...
            case AHARDWAREBUFFER_FORMAT_R16G16B16A16_FLOAT:
                ...
                ahbFormatProps->externalFormat = DRM_FORMAT_ARGB16161616F;
                break;
            case AHARDWAREBUFFER_FORMAT_R10G10B10A2_UNORM:
                ahbFormatProps->format = VK_FORMAT_A2B10G10R10_UNORM_PACK32;
                ahbFormatProps->externalFormat = DRM_FORMAT_RGBA1010102;
                break;
