...
static int gfxstream_vk_hal_open(const struct hw_module_t* mod, const char* id, struct hw_device_t** dev);
...
static int
gfxstream_vk_hal_open(const struct hw_module_t* mod, const char* id,
...
static int
gfxstream_vk_hal_close(struct hw_device_t *dev)
{
