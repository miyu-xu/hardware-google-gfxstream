...
class FuchsiaVirtGpuBlob : public std::enable_shared_from_this<FuchsiaVirtGpuBlob>, public VirtGpuBlob {
  public:
    // |device| must outlive this.
    FuchsiaVirtGpuBlob(FuchsiaVirtGpuDevice* device, uint32_t blobHandle, uint32_t resourceHandle, uint64_t size);
    ~FuchsiaVirtGpuBlob();
