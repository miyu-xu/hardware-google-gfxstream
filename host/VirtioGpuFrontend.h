...
class VirtioGpuFrontend {
   public:
    ...
    int createResource(const struct stream_renderer_resource_create_args* args, struct iovec* iov,
                       uint32_t num_iovs, const struct stream_renderer_handle *import_handle);
