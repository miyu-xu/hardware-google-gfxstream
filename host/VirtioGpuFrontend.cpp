...
int VirtioGpuFrontend::attachIov(int resId, struct stream_renderer_iovec* iov, int num_iovs) {
...
int VirtioGpuFrontend::transferReadIov(int resId, uint64_t offset, stream_renderer_box* box,
    ...
    if (iovec_cnt) {
        VirtioGpuResource e = {
            ...
            .iovs = std::vector<struct stream_renderer_iovec>(iov, iov + iovec_cnt),
            .linear = entry.linear,
...
void VirtioGpuFrontend::allocResource(VirtioGpuResource& entry, struct stream_renderer_iovec* iov,
                                      int num_iovs) {
