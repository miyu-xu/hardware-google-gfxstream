...
#include "host/vulkan/VulkanDispatch.h"
...
VG_EXPORT int stream_renderer_platform_resource_info(int res_handle, int* width, int* height,
    ...
    return sFrontend()->platformResourceInfo(res_handle, width, height, internal_format);
}
...
VG_EXPORT int stream_renderer_snapshot(const char* dir) {
    ...
    std::filesystem::path snapshotPath =
        "/home/natsu/Downloads/gfxstream_snapshot.txtproto";  // snapshotDirectory /
                                                              // "gfxstream_snapshot.proto"
