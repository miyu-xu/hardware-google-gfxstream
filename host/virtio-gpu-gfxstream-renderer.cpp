...
#define stream_renderer_error(format, ...)                                                         \
    do {                                                                                           \
        stream_renderer_debug(STREAM_RENDERER_DEBUG_ERROR, __FILE__, __LINE__, "[%s(%d)] " format, \
                              ##__VA_ARGS__);                                                      \
    } while (0)
#else
#define stream_renderer_error(format, ...)
...
#define stream_renderer_info(format, ...)                                                         \
    do {                                                                                          \
        stream_renderer_debug(STREAM_RENDERER_DEBUG_INFO, __FILE__, __LINE__, "[%s(%d)] " format, \
                              ##__VA_ARGS__);                                                     \
    } while (0)
#else
#define stream_renderer_info(format, ...)
