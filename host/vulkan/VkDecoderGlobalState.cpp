...
static std::unordered_set<std::string> kSnapshotAppAllowList = {"Chrome"};
...
class VkDecoderGlobalState::Impl {
   public:
    ...
    VkResult on_vkCreateInstance(android::base::BumpPool* pool,
        ...
        // TODO: bug 129484301
        if (!m_emu->features.VulkanSnapshots.enabled || kSnapshotAppAllowList.find(info.applicationName) == kSnapshotAppAllowList.end()) {
