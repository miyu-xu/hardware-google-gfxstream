    ...
    VkResult on_vkAllocateMemory(android::base::BumpPool* pool, VkDevice boxed_device,
        ...
        if (importCbInfoPtr) {
            ...
            if (!getColorBufferAllocationInfo(importCbInfoPtr->colorBuffer,
                ...
                // During snapshot load there could be invalidated reference to
                // color buffers.
                // Here we just create a placeholder for it. Alternatively, we could
                // consider building the right dependency in VkReconstruct.
