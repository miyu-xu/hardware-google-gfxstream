...
//
// (header) generated by codegen/vulkan/scripts/genvk.py -registry codegen/vulkan/xml/vk.xml cereal -o host/vulkan/cereal
//
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPipelineRenderingCreateInfo, checkEqual_VkPipelineRenderingCreateInfoKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceDynamicRenderingFeatures, checkEqual_VkPhysicalDeviceDynamicRenderingFeaturesKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkCommandBufferInheritanceRenderingInfo, checkEqual_VkCommandBufferInheritanceRenderingInfoKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceShaderTerminateInvocationFeatures, checkEqual_VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceShaderIntegerDotProductFeatures, checkEqual_VkPhysicalDeviceShaderIntegerDotProductFeaturesKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceShaderIntegerDotProductProperties, checkEqual_VkPhysicalDeviceShaderIntegerDotProductPropertiesKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceSynchronization2Features, checkEqual_VkPhysicalDeviceSynchronization2FeaturesKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures, checkEqual_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceMaintenance4Features, checkEqual_VkPhysicalDeviceMaintenance4FeaturesKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceMaintenance4Properties, checkEqual_VkPhysicalDeviceMaintenance4PropertiesKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkDeviceBufferMemoryRequirements, checkEqual_VkDeviceBufferMemoryRequirementsKHR)

DEFINE_ALIAS_FUNCTION(checkEqual_VkDeviceImageMemoryRequirements, checkEqual_VkDeviceImageMemoryRequirementsKHR)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceTextureCompressionASTCHDRFeatures, checkEqual_VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceInlineUniformBlockFeatures, checkEqual_VkPhysicalDeviceInlineUniformBlockFeaturesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceInlineUniformBlockProperties, checkEqual_VkPhysicalDeviceInlineUniformBlockPropertiesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkWriteDescriptorSetInlineUniformBlock, checkEqual_VkWriteDescriptorSetInlineUniformBlockEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkDescriptorPoolInlineUniformBlockCreateInfo, checkEqual_VkDescriptorPoolInlineUniformBlockCreateInfoEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkDeviceQueueGlobalPriorityCreateInfoKHR, checkEqual_VkDeviceQueueGlobalPriorityCreateInfoEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPipelineCreationFeedbackCreateInfo, checkEqual_VkPipelineCreationFeedbackCreateInfoEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPipelineCreationFeedback, checkEqual_VkPipelineCreationFeedbackEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR, checkEqual_VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceSubgroupSizeControlFeatures, checkEqual_VkPhysicalDeviceSubgroupSizeControlFeaturesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceSubgroupSizeControlProperties, checkEqual_VkPhysicalDeviceSubgroupSizeControlPropertiesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo, checkEqual_VkPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceToolProperties, checkEqual_VkPhysicalDeviceToolPropertiesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures, checkEqual_VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceTexelBufferAlignmentProperties, checkEqual_VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDevicePrivateDataFeatures, checkEqual_VkPhysicalDevicePrivateDataFeaturesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkDevicePrivateDataCreateInfo, checkEqual_VkDevicePrivateDataCreateInfoEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkPrivateDataSlotCreateInfo, checkEqual_VkPrivateDataSlotCreateInfoEXT)

#endif
#ifdef VK_EXT_pipeline_creation_cache_control
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDevicePipelineCreationCacheControlFeatures, checkEqual_VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceImageRobustnessFeatures, checkEqual_VkPhysicalDeviceImageRobustnessFeaturesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT, checkEqual_VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT, checkEqual_VkPhysicalDeviceMutableDescriptorTypeFeaturesVALVE)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkMutableDescriptorTypeListEXT, checkEqual_VkMutableDescriptorTypeListVALVE)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkMutableDescriptorTypeCreateInfoEXT, checkEqual_VkMutableDescriptorTypeCreateInfoVALVE)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR, checkEqual_VkPhysicalDeviceGlobalPriorityQueryFeaturesEXT)

DEFINE_ALIAS_FUNCTION(checkEqual_VkQueueFamilyGlobalPriorityPropertiesKHR, checkEqual_VkQueueFamilyGlobalPriorityPropertiesEXT)
...
DEFINE_ALIAS_FUNCTION(checkEqual_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo, checkEqual_VkShaderRequiredSubgroupSizeCreateInfoEXT)
