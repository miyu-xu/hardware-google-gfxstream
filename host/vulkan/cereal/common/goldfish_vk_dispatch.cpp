...
void init_vulkan_dispatch_from_system_loader(DlOpenFunc dlOpenFunc, DlSymFunc dlSymFunc,
    ...
    out->vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR =
        (PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR)dlSymFunc(
            lib, "vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR");
    out->vkGetEncodedVideoSessionParametersKHR =
        (PFN_vkGetEncodedVideoSessionParametersKHR)dlSymFunc(
            lib, "vkGetEncodedVideoSessionParametersKHR");
    ...
    out->vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR =
        (PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR)dlSymFunc(
            lib, "vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR");
#endif
    ...
    out->vkCreateExecutionGraphPipelinesAMDX = (PFN_vkCreateExecutionGraphPipelinesAMDX)dlSymFunc(
        lib, "vkCreateExecutionGraphPipelinesAMDX");
    out->vkGetExecutionGraphPipelineScratchSizeAMDX =
        (PFN_vkGetExecutionGraphPipelineScratchSizeAMDX)dlSymFunc(
            lib, "vkGetExecutionGraphPipelineScratchSizeAMDX");
    out->vkGetExecutionGraphPipelineNodeIndexAMDX =
        (PFN_vkGetExecutionGraphPipelineNodeIndexAMDX)dlSymFunc(
            lib, "vkGetExecutionGraphPipelineNodeIndexAMDX");
    out->vkCmdInitializeGraphScratchMemoryAMDX =
        (PFN_vkCmdInitializeGraphScratchMemoryAMDX)dlSymFunc(
            lib, "vkCmdInitializeGraphScratchMemoryAMDX");
    out->vkCmdDispatchGraphAMDX =
        (PFN_vkCmdDispatchGraphAMDX)dlSymFunc(lib, "vkCmdDispatchGraphAMDX");
    out->vkCmdDispatchGraphIndirectAMDX =
        (PFN_vkCmdDispatchGraphIndirectAMDX)dlSymFunc(lib, "vkCmdDispatchGraphIndirectAMDX");
    out->vkCmdDispatchGraphIndirectCountAMDX = (PFN_vkCmdDispatchGraphIndirectCountAMDX)dlSymFunc(
        lib, "vkCmdDispatchGraphIndirectCountAMDX");
#endif
    ...
    out->vkCmdSetDepthBias2EXT = (PFN_vkCmdSetDepthBias2EXT)dlSymFunc(lib, "vkCmdSetDepthBias2EXT");
#endif
    ...
    out->vkCreateCudaModuleNV = (PFN_vkCreateCudaModuleNV)dlSymFunc(lib, "vkCreateCudaModuleNV");
    out->vkGetCudaModuleCacheNV =
        (PFN_vkGetCudaModuleCacheNV)dlSymFunc(lib, "vkGetCudaModuleCacheNV");
    out->vkCreateCudaFunctionNV =
        (PFN_vkCreateCudaFunctionNV)dlSymFunc(lib, "vkCreateCudaFunctionNV");
    out->vkDestroyCudaModuleNV = (PFN_vkDestroyCudaModuleNV)dlSymFunc(lib, "vkDestroyCudaModuleNV");
    out->vkDestroyCudaFunctionNV =
        (PFN_vkDestroyCudaFunctionNV)dlSymFunc(lib, "vkDestroyCudaFunctionNV");
    out->vkCmdCudaLaunchKernelNV =
        (PFN_vkCmdCudaLaunchKernelNV)dlSymFunc(lib, "vkCmdCudaLaunchKernelNV");
#endif
    ...
    out->vkGetPipelineIndirectMemoryRequirementsNV =
        (PFN_vkGetPipelineIndirectMemoryRequirementsNV)dlSymFunc(
            lib, "vkGetPipelineIndirectMemoryRequirementsNV");
    out->vkCmdUpdatePipelineIndirectBufferNV = (PFN_vkCmdUpdatePipelineIndirectBufferNV)dlSymFunc(
        lib, "vkCmdUpdatePipelineIndirectBufferNV");
    out->vkGetPipelineIndirectDeviceAddressNV = (PFN_vkGetPipelineIndirectDeviceAddressNV)dlSymFunc(
        lib, "vkGetPipelineIndirectDeviceAddressNV");
#endif
    ...
    out->vkSetLatencySleepModeNV =
        (PFN_vkSetLatencySleepModeNV)dlSymFunc(lib, "vkSetLatencySleepModeNV");
    out->vkLatencySleepNV = (PFN_vkLatencySleepNV)dlSymFunc(lib, "vkLatencySleepNV");
    out->vkSetLatencyMarkerNV = (PFN_vkSetLatencyMarkerNV)dlSymFunc(lib, "vkSetLatencyMarkerNV");
    out->vkGetLatencyTimingsNV = (PFN_vkGetLatencyTimingsNV)dlSymFunc(lib, "vkGetLatencyTimingsNV");
    out->vkQueueNotifyOutOfBandNV =
        (PFN_vkQueueNotifyOutOfBandNV)dlSymFunc(lib, "vkQueueNotifyOutOfBandNV");
#endif
...
#ifdef VK_KHR_video_encode_queue
    out->vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR =
        (PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR)vk->vkGetInstanceProcAddr(
            instance, "vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR");
    out->vkGetEncodedVideoSessionParametersKHR =
        (PFN_vkGetEncodedVideoSessionParametersKHR)vk->vkGetInstanceProcAddr(
...
#ifdef VK_KHR_cooperative_matrix
    out->vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR =
        (PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR)vk->vkGetInstanceProcAddr(
...
#endif
#ifdef VK_AMDX_shader_enqueue
    out->vkCreateExecutionGraphPipelinesAMDX =
        (PFN_vkCreateExecutionGraphPipelinesAMDX)vk->vkGetInstanceProcAddr(
            instance, "vkCreateExecutionGraphPipelinesAMDX");
    out->vkGetExecutionGraphPipelineScratchSizeAMDX =
        (PFN_vkGetExecutionGraphPipelineScratchSizeAMDX)vk->vkGetInstanceProcAddr(
            instance, "vkGetExecutionGraphPipelineScratchSizeAMDX");
    out->vkGetExecutionGraphPipelineNodeIndexAMDX =
        (PFN_vkGetExecutionGraphPipelineNodeIndexAMDX)vk->vkGetInstanceProcAddr(
            instance, "vkGetExecutionGraphPipelineNodeIndexAMDX");
    out->vkCmdInitializeGraphScratchMemoryAMDX =
        (PFN_vkCmdInitializeGraphScratchMemoryAMDX)vk->vkGetInstanceProcAddr(
            instance, "vkCmdInitializeGraphScratchMemoryAMDX");
    out->vkCmdDispatchGraphAMDX =
        (PFN_vkCmdDispatchGraphAMDX)vk->vkGetInstanceProcAddr(instance, "vkCmdDispatchGraphAMDX");
    out->vkCmdDispatchGraphIndirectAMDX =
        (PFN_vkCmdDispatchGraphIndirectAMDX)vk->vkGetInstanceProcAddr(
            instance, "vkCmdDispatchGraphIndirectAMDX");
    out->vkCmdDispatchGraphIndirectCountAMDX =
        (PFN_vkCmdDispatchGraphIndirectCountAMDX)vk->vkGetInstanceProcAddr(
...
#endif
#ifdef VK_EXT_depth_bias_control
    out->vkCmdSetDepthBias2EXT =
        (PFN_vkCmdSetDepthBias2EXT)vk->vkGetInstanceProcAddr(instance, "vkCmdSetDepthBias2EXT");
#endif
#ifdef VK_EXT_acquire_drm_display
    out->vkAcquireDrmDisplayEXT =
...
#endif
#ifdef VK_NV_cuda_kernel_launch
    out->vkCreateCudaModuleNV =
        (PFN_vkCreateCudaModuleNV)vk->vkGetInstanceProcAddr(instance, "vkCreateCudaModuleNV");
    out->vkGetCudaModuleCacheNV =
        (PFN_vkGetCudaModuleCacheNV)vk->vkGetInstanceProcAddr(instance, "vkGetCudaModuleCacheNV");
    out->vkCreateCudaFunctionNV =
        (PFN_vkCreateCudaFunctionNV)vk->vkGetInstanceProcAddr(instance, "vkCreateCudaFunctionNV");
    out->vkDestroyCudaModuleNV =
        (PFN_vkDestroyCudaModuleNV)vk->vkGetInstanceProcAddr(instance, "vkDestroyCudaModuleNV");
    out->vkDestroyCudaFunctionNV =
        (PFN_vkDestroyCudaFunctionNV)vk->vkGetInstanceProcAddr(instance, "vkDestroyCudaFunctionNV");
    out->vkCmdCudaLaunchKernelNV =
        (PFN_vkCmdCudaLaunchKernelNV)vk->vkGetInstanceProcAddr(instance, "vkCmdCudaLaunchKernelNV");
#endif
#ifdef VK_EXT_metal_objects
    out->vkExportMetalObjectsEXT =
...
#ifdef VK_NV_device_generated_commands_compute
    out->vkGetPipelineIndirectMemoryRequirementsNV =
        (PFN_vkGetPipelineIndirectMemoryRequirementsNV)vk->vkGetInstanceProcAddr(
            instance, "vkGetPipelineIndirectMemoryRequirementsNV");
    out->vkCmdUpdatePipelineIndirectBufferNV =
        (PFN_vkCmdUpdatePipelineIndirectBufferNV)vk->vkGetInstanceProcAddr(
            instance, "vkCmdUpdatePipelineIndirectBufferNV");
    out->vkGetPipelineIndirectDeviceAddressNV =
        (PFN_vkGetPipelineIndirectDeviceAddressNV)vk->vkGetInstanceProcAddr(
...
#ifdef VK_NV_low_latency2
    out->vkSetLatencySleepModeNV =
        (PFN_vkSetLatencySleepModeNV)vk->vkGetInstanceProcAddr(instance, "vkSetLatencySleepModeNV");
    out->vkLatencySleepNV =
        (PFN_vkLatencySleepNV)vk->vkGetInstanceProcAddr(instance, "vkLatencySleepNV");
    out->vkSetLatencyMarkerNV =
        (PFN_vkSetLatencyMarkerNV)vk->vkGetInstanceProcAddr(instance, "vkSetLatencyMarkerNV");
    out->vkGetLatencyTimingsNV =
        (PFN_vkGetLatencyTimingsNV)vk->vkGetInstanceProcAddr(instance, "vkGetLatencyTimingsNV");
    out->vkQueueNotifyOutOfBandNV = (PFN_vkQueueNotifyOutOfBandNV)vk->vkGetInstanceProcAddr(
        instance, "vkQueueNotifyOutOfBandNV");
#endif
#ifdef VK_EXT_attachment_feedback_loop_dynamic_state
    out->vkCmdSetAttachmentFeedbackLoopEnableEXT =
...
#ifdef VK_KHR_video_encode_queue
    out->vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR =
        (PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR)vk->vkGetDeviceProcAddr(
            device, "vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR");
    out->vkGetEncodedVideoSessionParametersKHR =
        (PFN_vkGetEncodedVideoSessionParametersKHR)vk->vkGetDeviceProcAddr(
...
#ifdef VK_KHR_cooperative_matrix
    out->vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR =
        (PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR)vk->vkGetDeviceProcAddr(
...
#ifdef VK_AMDX_shader_enqueue
    out->vkCreateExecutionGraphPipelinesAMDX =
        (PFN_vkCreateExecutionGraphPipelinesAMDX)vk->vkGetDeviceProcAddr(
            device, "vkCreateExecutionGraphPipelinesAMDX");
    out->vkGetExecutionGraphPipelineScratchSizeAMDX =
        (PFN_vkGetExecutionGraphPipelineScratchSizeAMDX)vk->vkGetDeviceProcAddr(
            device, "vkGetExecutionGraphPipelineScratchSizeAMDX");
    out->vkGetExecutionGraphPipelineNodeIndexAMDX =
        (PFN_vkGetExecutionGraphPipelineNodeIndexAMDX)vk->vkGetDeviceProcAddr(
            device, "vkGetExecutionGraphPipelineNodeIndexAMDX");
    out->vkCmdInitializeGraphScratchMemoryAMDX =
        (PFN_vkCmdInitializeGraphScratchMemoryAMDX)vk->vkGetDeviceProcAddr(
            device, "vkCmdInitializeGraphScratchMemoryAMDX");
    out->vkCmdDispatchGraphAMDX =
        (PFN_vkCmdDispatchGraphAMDX)vk->vkGetDeviceProcAddr(device, "vkCmdDispatchGraphAMDX");
    out->vkCmdDispatchGraphIndirectAMDX =
        (PFN_vkCmdDispatchGraphIndirectAMDX)vk->vkGetDeviceProcAddr(
            device, "vkCmdDispatchGraphIndirectAMDX");
    out->vkCmdDispatchGraphIndirectCountAMDX =
        (PFN_vkCmdDispatchGraphIndirectCountAMDX)vk->vkGetDeviceProcAddr(
...
#ifdef VK_EXT_depth_bias_control
    out->vkCmdSetDepthBias2EXT =
        (PFN_vkCmdSetDepthBias2EXT)vk->vkGetDeviceProcAddr(device, "vkCmdSetDepthBias2EXT");
#endif
#ifdef VK_EXT_acquire_drm_display
    out->vkAcquireDrmDisplayEXT =
...
#ifdef VK_NV_cuda_kernel_launch
    out->vkCreateCudaModuleNV =
        (PFN_vkCreateCudaModuleNV)vk->vkGetDeviceProcAddr(device, "vkCreateCudaModuleNV");
    out->vkGetCudaModuleCacheNV =
        (PFN_vkGetCudaModuleCacheNV)vk->vkGetDeviceProcAddr(device, "vkGetCudaModuleCacheNV");
    out->vkCreateCudaFunctionNV =
        (PFN_vkCreateCudaFunctionNV)vk->vkGetDeviceProcAddr(device, "vkCreateCudaFunctionNV");
    out->vkDestroyCudaModuleNV =
        (PFN_vkDestroyCudaModuleNV)vk->vkGetDeviceProcAddr(device, "vkDestroyCudaModuleNV");
    out->vkDestroyCudaFunctionNV =
        (PFN_vkDestroyCudaFunctionNV)vk->vkGetDeviceProcAddr(device, "vkDestroyCudaFunctionNV");
    out->vkCmdCudaLaunchKernelNV =
        (PFN_vkCmdCudaLaunchKernelNV)vk->vkGetDeviceProcAddr(device, "vkCmdCudaLaunchKernelNV");
#endif
#ifdef VK_EXT_metal_objects
    out->vkExportMetalObjectsEXT =
...
#ifdef VK_NV_device_generated_commands_compute
    out->vkGetPipelineIndirectMemoryRequirementsNV =
        (PFN_vkGetPipelineIndirectMemoryRequirementsNV)vk->vkGetDeviceProcAddr(
            device, "vkGetPipelineIndirectMemoryRequirementsNV");
    out->vkCmdUpdatePipelineIndirectBufferNV =
        (PFN_vkCmdUpdatePipelineIndirectBufferNV)vk->vkGetDeviceProcAddr(
            device, "vkCmdUpdatePipelineIndirectBufferNV");
    out->vkGetPipelineIndirectDeviceAddressNV =
        (PFN_vkGetPipelineIndirectDeviceAddressNV)vk->vkGetDeviceProcAddr(
...
#ifdef VK_NV_low_latency2
    out->vkSetLatencySleepModeNV =
        (PFN_vkSetLatencySleepModeNV)vk->vkGetDeviceProcAddr(device, "vkSetLatencySleepModeNV");
    out->vkLatencySleepNV =
        (PFN_vkLatencySleepNV)vk->vkGetDeviceProcAddr(device, "vkLatencySleepNV");
    out->vkSetLatencyMarkerNV =
        (PFN_vkSetLatencyMarkerNV)vk->vkGetDeviceProcAddr(device, "vkSetLatencyMarkerNV");
    out->vkGetLatencyTimingsNV =
        (PFN_vkGetLatencyTimingsNV)vk->vkGetDeviceProcAddr(device, "vkGetLatencyTimingsNV");
    out->vkQueueNotifyOutOfBandNV =
        (PFN_vkQueueNotifyOutOfBandNV)vk->vkGetDeviceProcAddr(device, "vkQueueNotifyOutOfBandNV");
#endif
#ifdef VK_EXT_attachment_feedback_loop_dynamic_state
    out->vkCmdSetAttachmentFeedbackLoopEnableEXT =
