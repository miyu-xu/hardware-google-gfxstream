    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pWaitDstStageMask) && !(b->pWaitDstStageMask)) || ((a->pWaitDstStageMask) && (b->pWaitDstStageMask)))) { onFail("a->pWaitDstStageMask (Error: Mismatch in optional field)"); };
    if (a->pWaitDstStageMask && b->pWaitDstStageMask)
    {
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pName) && !(b->pName)) || ((a->pName) && (b->pName)))) { onFail("a->pName (Error: Mismatch in optional field)"); };
    if (a->pName && b->pName)
    {
        if (!((!(a->pName) && !(b->pName)) || ((a->pName) && (b->pName)))) { onFail("a->pName (Error: Mismatch in string pointer nullness)"); };
        if ((a->pName) && (b->pName))
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pStages) && !(b->pStages)) || ((a->pStages) && (b->pStages)))) { onFail("a->pStages (Error: Mismatch in optional field)"); };
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pSetLayouts) && !(b->pSetLayouts)) || ((a->pSetLayouts) && (b->pSetLayouts)))) { onFail("a->pSetLayouts (Error: Mismatch in optional field)"); };
...
void checkEqual_VkPhysicalDeviceVulkan13Features(
    const VkPhysicalDeviceVulkan13Features* a,
...
void checkEqual_VkPhysicalDeviceVulkan13Properties(
    const VkPhysicalDeviceVulkan13Properties* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->maxInlineUniformTotalSize) == (b->maxInlineUniformTotalSize))) { onFail("a->maxInlineUniformTotalSize (Error: Value not equal)"); };
...
void checkEqual_VkPipelineCreationFeedback(
    const VkPipelineCreationFeedback* a,
...
void checkEqual_VkPipelineCreationFeedbackCreateInfo(
    const VkPipelineCreationFeedbackCreateInfo* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        checkEqual_VkPipelineCreationFeedback(a->pPipelineCreationFeedback, b->pPipelineCreationFeedback, onFail);
    }
    ...
    if ((a->pPipelineStageCreationFeedbacks) && (b->pPipelineStageCreationFeedbacks))
    {
        ...
        if ((a->pipelineStageCreationFeedbackCount) == (b->pipelineStageCreationFeedbackCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkPipelineCreationFeedback(a->pPipelineStageCreationFeedbacks + i, b->pPipelineStageCreationFeedbacks + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPhysicalDeviceShaderTerminateInvocationFeatures(
    ...
    const VkPhysicalDeviceShaderTerminateInvocationFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceToolProperties(
    const VkPhysicalDeviceToolProperties* a,
...
void checkEqual_VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(
    ...
    const VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDevicePrivateDataFeatures(
    const VkPhysicalDevicePrivateDataFeatures* a,
...
void checkEqual_VkDevicePrivateDataCreateInfo(
    const VkDevicePrivateDataCreateInfo* a,
...
void checkEqual_VkPrivateDataSlotCreateInfo(
    const VkPrivateDataSlotCreateInfo* a,
...
void checkEqual_VkPhysicalDevicePipelineCreationCacheControlFeatures(
    ...
    const VkPhysicalDevicePipelineCreationCacheControlFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkMemoryBarrier2(
    const VkMemoryBarrier2* a,
    const VkMemoryBarrier2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkBufferMemoryBarrier2(
    const VkBufferMemoryBarrier2* a,
...
void checkEqual_VkImageMemoryBarrier2(
    const VkImageMemoryBarrier2* a,
...
void checkEqual_VkDependencyInfo(
    const VkDependencyInfo* a,
    const VkDependencyInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if ((a->pMemoryBarriers) && (b->pMemoryBarriers))
    {
        ...
        if ((a->memoryBarrierCount) == (b->memoryBarrierCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkMemoryBarrier2(a->pMemoryBarriers + i, b->pMemoryBarriers + i, onFail);
                }
            }
        }
    }
    ...
    if ((a->pBufferMemoryBarriers) && (b->pBufferMemoryBarriers))
    {
        ...
        if ((a->bufferMemoryBarrierCount) == (b->bufferMemoryBarrierCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkBufferMemoryBarrier2(a->pBufferMemoryBarriers + i, b->pBufferMemoryBarriers + i, onFail);
                }
            }
        }
    }
    ...
    if ((a->pImageMemoryBarriers) && (b->pImageMemoryBarriers))
    {
        ...
        if ((a->imageMemoryBarrierCount) == (b->imageMemoryBarrierCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkImageMemoryBarrier2(a->pImageMemoryBarriers + i, b->pImageMemoryBarriers + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkSemaphoreSubmitInfo(
    const VkSemaphoreSubmitInfo* a,
    const VkSemaphoreSubmitInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkCommandBufferSubmitInfo(
    const VkCommandBufferSubmitInfo* a,
...
void checkEqual_VkSubmitInfo2(
    const VkSubmitInfo2* a,
    const VkSubmitInfo2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if ((a->pWaitSemaphoreInfos) && (b->pWaitSemaphoreInfos))
    {
        ...
        if ((a->waitSemaphoreInfoCount) == (b->waitSemaphoreInfoCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkSemaphoreSubmitInfo(a->pWaitSemaphoreInfos + i, b->pWaitSemaphoreInfos + i, onFail);
                }
            }
        }
    }
    ...
    if ((a->pCommandBufferInfos) && (b->pCommandBufferInfos))
    {
        ...
        if ((a->commandBufferInfoCount) == (b->commandBufferInfoCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkCommandBufferSubmitInfo(a->pCommandBufferInfos + i, b->pCommandBufferInfos + i, onFail);
                }
            }
        }
    }
    ...
    if ((a->pSignalSemaphoreInfos) && (b->pSignalSemaphoreInfos))
    {
        ...
        if ((a->signalSemaphoreInfoCount) == (b->signalSemaphoreInfoCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkSemaphoreSubmitInfo(a->pSignalSemaphoreInfos + i, b->pSignalSemaphoreInfos + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPhysicalDeviceSynchronization2Features(
    ...
    const VkPhysicalDeviceSynchronization2Features* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures(
    ...
    const VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceImageRobustnessFeatures(
    ...
    const VkPhysicalDeviceImageRobustnessFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkBufferCopy2(
    const VkBufferCopy2* a,
    const VkBufferCopy2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkCopyBufferInfo2(
    const VkCopyBufferInfo2* a,
    const VkCopyBufferInfo2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkImageCopy2(
    const VkImageCopy2* a,
    const VkImageCopy2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkCopyImageInfo2(
    const VkCopyImageInfo2* a,
    const VkCopyImageInfo2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkBufferImageCopy2(
    const VkBufferImageCopy2* a,
    const VkBufferImageCopy2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkCopyBufferToImageInfo2(
...
void checkEqual_VkCopyImageToBufferInfo2(
    const VkCopyImageToBufferInfo2* a,
...
void checkEqual_VkImageBlit2(
    const VkImageBlit2* a,
    const VkImageBlit2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkBlitImageInfo2(
    const VkBlitImageInfo2* a,
    const VkBlitImageInfo2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkImageResolve2(
    const VkImageResolve2* a,
    const VkImageResolve2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkResolveImageInfo2(
    const VkResolveImageInfo2* a,
    const VkResolveImageInfo2* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceSubgroupSizeControlFeatures(
    ...
    const VkPhysicalDeviceSubgroupSizeControlFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceSubgroupSizeControlProperties(
    ...
    const VkPhysicalDeviceSubgroupSizeControlProperties* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(
    ...
    const VkPipelineShaderStageRequiredSubgroupSizeCreateInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceInlineUniformBlockFeatures(
    ...
    const VkPhysicalDeviceInlineUniformBlockFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceInlineUniformBlockProperties(
    ...
    const VkPhysicalDeviceInlineUniformBlockProperties* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkWriteDescriptorSetInlineUniformBlock(
    ...
    const VkWriteDescriptorSetInlineUniformBlock* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkDescriptorPoolInlineUniformBlockCreateInfo(
    ...
    const VkDescriptorPoolInlineUniformBlockCreateInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(
    ...
    const VkPhysicalDeviceTextureCompressionASTCHDRFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkRenderingAttachmentInfo(
    const VkRenderingAttachmentInfo* a,
...
void checkEqual_VkRenderingInfo(
    const VkRenderingInfo* a,
    const VkRenderingInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if ((a->pColorAttachments) && (b->pColorAttachments))
    {
        ...
        if ((a->colorAttachmentCount) == (b->colorAttachmentCount))
        {
            if (a)
            {
                for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
                {
                    checkEqual_VkRenderingAttachmentInfo(a->pColorAttachments + i, b->pColorAttachments + i, onFail);
                }
            }
        }
    }
    ...
    if (a->pStencilAttachment && b->pStencilAttachment)
    {
        if ((a->pStencilAttachment) && (b->pStencilAttachment))
        {
            checkEqual_VkRenderingAttachmentInfo(a->pStencilAttachment, b->pStencilAttachment, onFail);
        }
    }
}

void checkEqual_VkPipelineRenderingCreateInfo(
    const VkPipelineRenderingCreateInfo* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->viewMask) == (b->viewMask))) { onFail("a->viewMask (Error: Value not equal)"); };
    if (!((a->colorAttachmentCount) == (b->colorAttachmentCount))) { onFail("a->colorAttachmentCount (Error: Value not equal)"); };
    if (!((!(a->pColorAttachmentFormats) && !(b->pColorAttachmentFormats)) || ((a->pColorAttachmentFormats) && (b->pColorAttachmentFormats)))) { onFail("a->pColorAttachmentFormats (Error: Mismatch in optional field)"); };
...
void checkEqual_VkPhysicalDeviceDynamicRenderingFeatures(
    ...
    const VkPhysicalDeviceDynamicRenderingFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkCommandBufferInheritanceRenderingInfo(
    ...
    const VkCommandBufferInheritanceRenderingInfo* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceShaderIntegerDotProductFeatures(
    ...
    const VkPhysicalDeviceShaderIntegerDotProductFeatures* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceShaderIntegerDotProductProperties(
    ...
    const VkPhysicalDeviceShaderIntegerDotProductProperties* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceTexelBufferAlignmentProperties(
    ...
    const VkPhysicalDeviceTexelBufferAlignmentProperties* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkFormatProperties3(
    const VkFormatProperties3* a,
    const VkFormatProperties3* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceMaintenance4Features(
    const VkPhysicalDeviceMaintenance4Features* a,
...
void checkEqual_VkPhysicalDeviceMaintenance4Properties(
    ...
    const VkPhysicalDeviceMaintenance4Properties* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkDeviceBufferMemoryRequirements(
    const VkDeviceBufferMemoryRequirements* a,
...
void checkEqual_VkDeviceImageMemoryRequirements(
    const VkDeviceImageMemoryRequirements* a,
...
void checkEqual_VkQueueFamilyQueryResultStatusPropertiesKHR(
    ...
    const VkQueueFamilyQueryResultStatusPropertiesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->queryResultStatusSupport) == (b->queryResultStatusSupport))) { onFail("a->queryResultStatusSupport (Error: Value not equal)"); };
}

void checkEqual_VkQueueFamilyVideoPropertiesKHR(
    const VkQueueFamilyVideoPropertiesKHR* a,
...
void checkEqual_VkVideoProfileInfoKHR(
    const VkVideoProfileInfoKHR* a,
    const VkVideoProfileInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkVideoProfileListInfoKHR(
    const VkVideoProfileListInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        if (!((a->profileCount) == (b->profileCount))) { onFail("a->pProfiles (Error: Lengths not equal)"); };
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->maxDpbSlots) == (b->maxDpbSlots))) { onFail("a->maxDpbSlots (Error: Value not equal)"); };
    if (!((a->maxActiveReferencePictures) == (b->maxActiveReferencePictures))) { onFail("a->maxActiveReferencePictures (Error: Value not equal)"); };
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->imageCreateFlags) == (b->imageCreateFlags))) { onFail("a->imageCreateFlags (Error: Value not equal)"); };
    if (!((a->imageType) == (b->imageType))) { onFail("a->imageType (Error: Value not equal)"); };
    if (!((a->imageTiling) == (b->imageTiling))) { onFail("a->imageTiling (Error: Value not equal)"); };
    if (!((a->imageUsageFlags) == (b->imageUsageFlags))) { onFail("a->imageUsageFlags (Error: Value not equal)"); };
}

void checkEqual_VkVideoPictureResourceInfoKHR(
    const VkVideoPictureResourceInfoKHR* a,
...
void checkEqual_VkVideoReferenceSlotInfoKHR(
    const VkVideoReferenceSlotInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pPictureResource) && !(b->pPictureResource)) || ((a->pPictureResource) && (b->pPictureResource)))) { onFail("a->pPictureResource (Error: Mismatch in optional field)"); };
    if (a->pPictureResource && b->pPictureResource)
    {
        if ((a->pPictureResource) && (b->pPictureResource))
        {
            checkEqual_VkVideoPictureResourceInfoKHR(a->pPictureResource, b->pPictureResource, onFail);
        }
    }
}

void checkEqual_VkVideoSessionMemoryRequirementsKHR(
    const VkVideoSessionMemoryRequirementsKHR* a,
...
void checkEqual_VkBindVideoSessionMemoryInfoKHR(
    const VkBindVideoSessionMemoryInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    checkEqual_VkExtent2D(&a->maxCodedExtent, &b->maxCodedExtent, onFail);
    if (!((a->referencePictureFormat) == (b->referencePictureFormat))) { onFail("a->referencePictureFormat (Error: Value not equal)"); };
    if (!((a->maxDpbSlots) == (b->maxDpbSlots))) { onFail("a->maxDpbSlots (Error: Value not equal)"); };
    if (!((a->maxActiveReferencePictures) == (b->maxActiveReferencePictures))) { onFail("a->maxActiveReferencePictures (Error: Value not equal)"); };
    ...
    if ((a->pReferenceSlots) && (b->pReferenceSlots))
    {
        ...
        if ((a->referenceSlotCount) == (b->referenceSlotCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkVideoReferenceSlotInfoKHR(a->pReferenceSlots + i, b->pReferenceSlots + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkVideoDecodeCapabilitiesKHR(
    const VkVideoDecodeCapabilitiesKHR* a,
...
void checkEqual_VkVideoDecodeUsageInfoKHR(
    const VkVideoDecodeUsageInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->videoUsageHints) == (b->videoUsageHints))) { onFail("a->videoUsageHints (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    checkEqual_VkVideoPictureResourceInfoKHR(&a->dstPictureResource, &b->dstPictureResource, onFail);
    if (!((!(a->pSetupReferenceSlot) && !(b->pSetupReferenceSlot)) || ((a->pSetupReferenceSlot) && (b->pSetupReferenceSlot)))) { onFail("a->pSetupReferenceSlot (Error: Mismatch in optional field)"); };
    if (a->pSetupReferenceSlot && b->pSetupReferenceSlot)
    {
        if ((a->pSetupReferenceSlot) && (b->pSetupReferenceSlot))
        {
            checkEqual_VkVideoReferenceSlotInfoKHR(a->pSetupReferenceSlot, b->pSetupReferenceSlot, onFail);
        }
    }
    if (!((a->referenceSlotCount) == (b->referenceSlotCount))) { onFail("a->referenceSlotCount (Error: Value not equal)"); };
    if ((a->pReferenceSlots) && (b->pReferenceSlots))
...
void checkEqual_VkVideoDecodeH264ProfileInfoKHR(
    const VkVideoDecodeH264ProfileInfoKHR* a,
...
void checkEqual_VkVideoDecodeH264CapabilitiesKHR(
    const VkVideoDecodeH264CapabilitiesKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->maxLevelIdc) == (b->maxLevelIdc))) { onFail("a->maxLevelIdc (Error: Value not equal)"); };
...
void checkEqual_VkVideoDecodeH264SessionParametersAddInfoKHR(
    ...
    const VkVideoDecodeH264SessionParametersAddInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->stdSPSCount) == (b->stdSPSCount))) { onFail("a->stdSPSCount (Error: Value not equal)"); };
    if (!((a->stdSPSCount) == (b->stdSPSCount))) { onFail("a->pStdSPSs (Error: Lengths not equal)"); };
    if (!((memcmp(a->pStdSPSs, b->pStdSPSs, a->stdSPSCount * sizeof(const StdVideoH264SequenceParameterSet)) == 0))) { onFail("a->pStdSPSs (Error: Unequal dyn array)"); };
    if (!((a->stdPPSCount) == (b->stdPPSCount))) { onFail("a->stdPPSCount (Error: Value not equal)"); };
    if (!((a->stdPPSCount) == (b->stdPPSCount))) { onFail("a->pStdPPSs (Error: Lengths not equal)"); };
    if (!((memcmp(a->pStdPPSs, b->pStdPPSs, a->stdPPSCount * sizeof(const StdVideoH264PictureParameterSet)) == 0))) { onFail("a->pStdPPSs (Error: Unequal dyn array)"); };
}

void checkEqual_VkVideoDecodeH264SessionParametersCreateInfoKHR(
    const VkVideoDecodeH264SessionParametersCreateInfoKHR* a,
    const VkVideoDecodeH264SessionParametersCreateInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxStdSPSCount) == (b->maxStdSPSCount))) { onFail("a->maxStdSPSCount (Error: Value not equal)"); };
    if (!((a->maxStdPPSCount) == (b->maxStdPPSCount))) { onFail("a->maxStdPPSCount (Error: Value not equal)"); };
    ...
    if (a->pParametersAddInfo && b->pParametersAddInfo)
    {
        if ((a->pParametersAddInfo) && (b->pParametersAddInfo))
        {
            checkEqual_VkVideoDecodeH264SessionParametersAddInfoKHR(a->pParametersAddInfo, b->pParametersAddInfo, onFail);
        }
    }
}

void checkEqual_VkVideoDecodeH264PictureInfoKHR(
    const VkVideoDecodeH264PictureInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->sliceCount) == (b->sliceCount))) { onFail("a->sliceCount (Error: Value not equal)"); };
    if (!((a->sliceCount) == (b->sliceCount))) { onFail("a->pSliceOffsets (Error: Lengths not equal)"); };
    if (!((memcmp(a->pSliceOffsets, b->pSliceOffsets, a->sliceCount * sizeof(const uint32_t)) == 0))) { onFail("a->pSliceOffsets (Error: Unequal dyn array)"); };
}

void checkEqual_VkVideoDecodeH264DpbSlotInfoKHR(
    const VkVideoDecodeH264DpbSlotInfoKHR* a,
...
void checkEqual_VkVideoDecodeH265ProfileInfoKHR(
    const VkVideoDecodeH265ProfileInfoKHR* a,
...
void checkEqual_VkVideoDecodeH265CapabilitiesKHR(
    const VkVideoDecodeH265CapabilitiesKHR* a,
...
void checkEqual_VkVideoDecodeH265SessionParametersAddInfoKHR(
    ...
    const VkVideoDecodeH265SessionParametersAddInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->stdVPSCount) == (b->stdVPSCount))) { onFail("a->stdVPSCount (Error: Value not equal)"); };
    if (!((a->stdVPSCount) == (b->stdVPSCount))) { onFail("a->pStdVPSs (Error: Lengths not equal)"); };
    if (!((memcmp(a->pStdVPSs, b->pStdVPSs, a->stdVPSCount * sizeof(const StdVideoH265VideoParameterSet)) == 0))) { onFail("a->pStdVPSs (Error: Unequal dyn array)"); };
    if (!((a->stdSPSCount) == (b->stdSPSCount))) { onFail("a->stdSPSCount (Error: Value not equal)"); };
    if (!((a->stdSPSCount) == (b->stdSPSCount))) { onFail("a->pStdSPSs (Error: Lengths not equal)"); };
    if (!((memcmp(a->pStdSPSs, b->pStdSPSs, a->stdSPSCount * sizeof(const StdVideoH265SequenceParameterSet)) == 0))) { onFail("a->pStdSPSs (Error: Unequal dyn array)"); };
    if (!((a->stdPPSCount) == (b->stdPPSCount))) { onFail("a->stdPPSCount (Error: Value not equal)"); };
    if (!((a->stdPPSCount) == (b->stdPPSCount))) { onFail("a->pStdPPSs (Error: Lengths not equal)"); };
    if (!((memcmp(a->pStdPPSs, b->pStdPPSs, a->stdPPSCount * sizeof(const StdVideoH265PictureParameterSet)) == 0))) { onFail("a->pStdPPSs (Error: Unequal dyn array)"); };
}

void checkEqual_VkVideoDecodeH265SessionParametersCreateInfoKHR(
    const VkVideoDecodeH265SessionParametersCreateInfoKHR* a,
    const VkVideoDecodeH265SessionParametersCreateInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxStdVPSCount) == (b->maxStdVPSCount))) { onFail("a->maxStdVPSCount (Error: Value not equal)"); };
    if (!((a->maxStdSPSCount) == (b->maxStdSPSCount))) { onFail("a->maxStdSPSCount (Error: Value not equal)"); };
    if (!((a->maxStdPPSCount) == (b->maxStdPPSCount))) { onFail("a->maxStdPPSCount (Error: Value not equal)"); };
    if (!((!(a->pParametersAddInfo) && !(b->pParametersAddInfo)) || ((a->pParametersAddInfo) && (b->pParametersAddInfo)))) { onFail("a->pParametersAddInfo (Error: Mismatch in optional field)"); };
    if (a->pParametersAddInfo && b->pParametersAddInfo)
    {
        if ((a->pParametersAddInfo) && (b->pParametersAddInfo))
        {
            checkEqual_VkVideoDecodeH265SessionParametersAddInfoKHR(a->pParametersAddInfo, b->pParametersAddInfo, onFail);
        }
    }
}

void checkEqual_VkVideoDecodeH265PictureInfoKHR(
    const VkVideoDecodeH265PictureInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((memcmp(a->pStdPictureInfo, b->pStdPictureInfo, sizeof(const StdVideoDecodeH265PictureInfo)) == 0))) { onFail("a->pStdPictureInfo (Error: Unequal dyn array)"); };
    if (!((a->sliceSegmentCount) == (b->sliceSegmentCount))) { onFail("a->sliceSegmentCount (Error: Value not equal)"); };
    if (!((a->sliceSegmentCount) == (b->sliceSegmentCount))) { onFail("a->pSliceSegmentOffsets (Error: Lengths not equal)"); };
    if (!((memcmp(a->pSliceSegmentOffsets, b->pSliceSegmentOffsets, a->sliceSegmentCount * sizeof(const uint32_t)) == 0))) { onFail("a->pSliceSegmentOffsets (Error: Unequal dyn array)"); };
}

void checkEqual_VkVideoDecodeH265DpbSlotInfoKHR(
    const VkVideoDecodeH265DpbSlotInfoKHR* a,
...
void checkEqual_VkDeviceQueueGlobalPriorityCreateInfoKHR(
    ...
    const VkDeviceQueueGlobalPriorityCreateInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR(
    ...
    const VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkQueueFamilyGlobalPriorityPropertiesKHR(
    ...
    const VkQueueFamilyGlobalPriorityPropertiesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((memcmp(a->priorities, b->priorities, VK_MAX_GLOBAL_PRIORITY_SIZE_KHR * sizeof(VkQueueGlobalPriorityKHR)) == 0))) { onFail("a->priorities (Error: Unequal static array)"); };
}
...
void checkEqual_VkMemoryMapInfoKHR(
    const VkMemoryMapInfoKHR* a,
    const VkMemoryMapInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkMemoryUnmapInfoKHR(
    const VkMemoryUnmapInfoKHR* a,
    const VkMemoryUnmapInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->dstBuffer) == (b->dstBuffer))) { onFail("a->dstBuffer (Error: Value not equal)"); };
    if (!((a->dstBufferOffset) == (b->dstBufferOffset))) { onFail("a->dstBufferOffset (Error: Value not equal)"); };
    if (!((a->dstBufferRange) == (b->dstBufferRange))) { onFail("a->dstBufferRange (Error: Value not equal)"); };
    checkEqual_VkVideoPictureResourceInfoKHR(&a->srcPictureResource, &b->srcPictureResource, onFail);
    if (!((!(a->pSetupReferenceSlot) && !(b->pSetupReferenceSlot)) || ((a->pSetupReferenceSlot) && (b->pSetupReferenceSlot)))) { onFail("a->pSetupReferenceSlot (Error: Mismatch in optional field)"); };
    if (a->pSetupReferenceSlot && b->pSetupReferenceSlot)
    {
        if ((a->pSetupReferenceSlot) && (b->pSetupReferenceSlot))
    ...
    if (!((a->precedingExternallyEncodedBytes) == (b->precedingExternallyEncodedBytes))) { onFail("a->precedingExternallyEncodedBytes (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeCapabilitiesKHR(
    const VkVideoEncodeCapabilitiesKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->rateControlModes) == (b->rateControlModes))) { onFail("a->rateControlModes (Error: Value not equal)"); };
    if (!((a->maxRateControlLayers) == (b->maxRateControlLayers))) { onFail("a->maxRateControlLayers (Error: Value not equal)"); };
    if (!((a->maxQualityLevels) == (b->maxQualityLevels))) { onFail("a->maxQualityLevels (Error: Value not equal)"); };
    checkEqual_VkExtent2D(&a->inputImageDataFillAlignment, &b->inputImageDataFillAlignment, onFail);
    if (!((a->supportedEncodeFeedbackFlags) == (b->supportedEncodeFeedbackFlags))) { onFail("a->supportedEncodeFeedbackFlags (Error: Value not equal)"); };
}

void checkEqual_VkQueryPoolVideoEncodeFeedbackCreateInfoKHR(
    const VkQueryPoolVideoEncodeFeedbackCreateInfoKHR* a,
    const VkQueryPoolVideoEncodeFeedbackCreateInfoKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->encodeFeedbackFlags) == (b->encodeFeedbackFlags))) { onFail("a->encodeFeedbackFlags (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeUsageInfoKHR(
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->videoUsageHints) == (b->videoUsageHints))) { onFail("a->videoUsageHints (Error: Value not equal)"); };
    if (!((a->videoContentHints) == (b->videoContentHints))) { onFail("a->videoContentHints (Error: Value not equal)"); };
    if (!((a->tuningMode) == (b->tuningMode))) { onFail("a->tuningMode (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeRateControlLayerInfoKHR(
    const VkVideoEncodeRateControlLayerInfoKHR* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->maxBitrate) == (b->maxBitrate))) { onFail("a->maxBitrate (Error: Value not equal)"); };
    ...
    if (!((a->initialVirtualBufferSizeInMs) == (b->initialVirtualBufferSizeInMs))) { onFail("a->initialVirtualBufferSizeInMs (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        if (!((a->layerCount) == (b->layerCount))) { onFail("a->pLayers (Error: Lengths not equal)"); };
        if ((a->layerCount) == (b->layerCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkVideoEncodeRateControlLayerInfoKHR(a->pLayers + i, b->pLayers + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(
    ...
    const VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR(
    ...
    const VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->triStripVertexOrderIndependentOfProvokingVertex) == (b->triStripVertexOrderIndependentOfProvokingVertex))) { onFail("a->triStripVertexOrderIndependentOfProvokingVertex (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR(
    ...
    const VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->rayTracingMaintenance1) == (b->rayTracingMaintenance1))) { onFail("a->rayTracingMaintenance1 (Error: Value not equal)"); };
    if (!((a->rayTracingPipelineTraceRaysIndirect2) == (b->rayTracingPipelineTraceRaysIndirect2))) { onFail("a->rayTracingPipelineTraceRaysIndirect2 (Error: Value not equal)"); };
}

void checkEqual_VkTraceRaysIndirectCommand2KHR(
    const VkTraceRaysIndirectCommand2KHR* a,
    const VkTraceRaysIndirectCommand2KHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->raygenShaderRecordAddress) == (b->raygenShaderRecordAddress))) { onFail("a->raygenShaderRecordAddress (Error: Value not equal)"); };
    if (!((a->raygenShaderRecordSize) == (b->raygenShaderRecordSize))) { onFail("a->raygenShaderRecordSize (Error: Value not equal)"); };
    if (!((a->missShaderBindingTableAddress) == (b->missShaderBindingTableAddress))) { onFail("a->missShaderBindingTableAddress (Error: Value not equal)"); };
    if (!((a->missShaderBindingTableSize) == (b->missShaderBindingTableSize))) { onFail("a->missShaderBindingTableSize (Error: Value not equal)"); };
    if (!((a->missShaderBindingTableStride) == (b->missShaderBindingTableStride))) { onFail("a->missShaderBindingTableStride (Error: Value not equal)"); };
    if (!((a->hitShaderBindingTableAddress) == (b->hitShaderBindingTableAddress))) { onFail("a->hitShaderBindingTableAddress (Error: Value not equal)"); };
    if (!((a->hitShaderBindingTableSize) == (b->hitShaderBindingTableSize))) { onFail("a->hitShaderBindingTableSize (Error: Value not equal)"); };
    if (!((a->hitShaderBindingTableStride) == (b->hitShaderBindingTableStride))) { onFail("a->hitShaderBindingTableStride (Error: Value not equal)"); };
    if (!((a->callableShaderBindingTableAddress) == (b->callableShaderBindingTableAddress))) { onFail("a->callableShaderBindingTableAddress (Error: Value not equal)"); };
    if (!((a->callableShaderBindingTableSize) == (b->callableShaderBindingTableSize))) { onFail("a->callableShaderBindingTableSize (Error: Value not equal)"); };
    if (!((a->callableShaderBindingTableStride) == (b->callableShaderBindingTableStride))) { onFail("a->callableShaderBindingTableStride (Error: Value not equal)"); };
    if (!((a->width) == (b->width))) { onFail("a->width (Error: Value not equal)"); };
    if (!((a->height) == (b->height))) { onFail("a->height (Error: Value not equal)"); };
    if (!((a->depth) == (b->depth))) { onFail("a->depth (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR(
    ...
    const VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->rayTracingPositionFetch) == (b->rayTracingPositionFetch))) { onFail("a->rayTracingPositionFetch (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->maxPPictureL0ReferenceCount) == (b->maxPPictureL0ReferenceCount))) { onFail("a->maxPPictureL0ReferenceCount (Error: Value not equal)"); };
    if (!((a->maxBPictureL0ReferenceCount) == (b->maxBPictureL0ReferenceCount))) { onFail("a->maxBPictureL0ReferenceCount (Error: Value not equal)"); };
    if (!((a->maxL1ReferenceCount) == (b->maxL1ReferenceCount))) { onFail("a->maxL1ReferenceCount (Error: Value not equal)"); };
    if (!((a->motionVectorsOverPicBoundariesFlag) == (b->motionVectorsOverPicBoundariesFlag))) { onFail("a->motionVectorsOverPicBoundariesFlag (Error: Value not equal)"); };
    if (!((a->maxBytesPerPicDenom) == (b->maxBytesPerPicDenom))) { onFail("a->maxBytesPerPicDenom (Error: Value not equal)"); };
    if (!((a->maxBitsPerMbDenom) == (b->maxBitsPerMbDenom))) { onFail("a->maxBitsPerMbDenom (Error: Value not equal)"); };
    if (!((a->log2MaxMvLengthHorizontal) == (b->log2MaxMvLengthHorizontal))) { onFail("a->log2MaxMvLengthHorizontal (Error: Value not equal)"); };
    if (!((a->log2MaxMvLengthVertical) == (b->log2MaxMvLengthVertical))) { onFail("a->log2MaxMvLengthVertical (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->stdSPSCount) == (b->stdSPSCount))) { onFail("a->stdSPSCount (Error: Value not equal)"); };
    if (!((!(a->pStdSPSs) && !(b->pStdSPSs)) || ((a->pStdSPSs) && (b->pStdSPSs)))) { onFail("a->pStdSPSs (Error: Mismatch in optional field)"); };
    ...
    if (!((a->stdPPSCount) == (b->stdPPSCount))) { onFail("a->stdPPSCount (Error: Value not equal)"); };
    if (!((!(a->pStdPPSs) && !(b->pStdPPSs)) || ((a->pStdPPSs) && (b->pStdPPSs)))) { onFail("a->pStdPPSs (Error: Mismatch in optional field)"); };
...
void checkEqual_VkVideoEncodeH264NaluSliceInfoEXT(
    const VkVideoEncodeH264NaluSliceInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pStdReferenceFinalLists) && !(b->pStdReferenceFinalLists)) || ((a->pStdReferenceFinalLists) && (b->pStdReferenceFinalLists)))) { onFail("a->pStdReferenceFinalLists (Error: Mismatch in optional field)"); };
    if (a->pStdReferenceFinalLists && b->pStdReferenceFinalLists)
    {
        if (!((memcmp(a->pStdReferenceFinalLists, b->pStdReferenceFinalLists, sizeof(const StdVideoEncodeH264ReferenceListsInfo)) == 0))) { onFail("a->pStdReferenceFinalLists (Error: Unequal dyn array)"); };
    }
    if (!((memcmp(a->pStdSliceHeader, b->pStdSliceHeader, sizeof(const StdVideoEncodeH264SliceHeader)) == 0))) { onFail("a->pStdSliceHeader (Error: Unequal dyn array)"); };
}
    ...
    if ((a->pNaluSliceEntries) && (b->pNaluSliceEntries))
    {
        ...
        if ((a->naluSliceEntryCount) == (b->naluSliceEntryCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkVideoEncodeH264NaluSliceInfoEXT(a->pNaluSliceEntries + i, b->pNaluSliceEntries + i, onFail);
                }
            }
        }
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((memcmp(a->pStdReferenceInfo, b->pStdReferenceInfo, sizeof(const StdVideoEncodeH264ReferenceInfo)) == 0))) { onFail("a->pStdReferenceInfo (Error: Unequal dyn array)"); };
}

void checkEqual_VkVideoEncodeH264ProfileInfoEXT(
    const VkVideoEncodeH264ProfileInfoEXT* a,
...
void checkEqual_VkVideoEncodeH264RateControlInfoEXT(
    const VkVideoEncodeH264RateControlInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->gopFrameCount) == (b->gopFrameCount))) { onFail("a->gopFrameCount (Error: Value not equal)"); };
    if (!((a->idrPeriod) == (b->idrPeriod))) { onFail("a->idrPeriod (Error: Value not equal)"); };
    if (!((a->consecutiveBFrameCount) == (b->consecutiveBFrameCount))) { onFail("a->consecutiveBFrameCount (Error: Value not equal)"); };
    if (!((a->rateControlStructure) == (b->rateControlStructure))) { onFail("a->rateControlStructure (Error: Value not equal)"); };
    if (!((a->temporalLayerCount) == (b->temporalLayerCount))) { onFail("a->temporalLayerCount (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeH264QpEXT(
    const VkVideoEncodeH264QpEXT* a,
    const VkVideoEncodeH264QpEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->qpI) == (b->qpI))) { onFail("a->qpI (Error: Value not equal)"); };
    if (!((a->qpP) == (b->qpP))) { onFail("a->qpP (Error: Value not equal)"); };
    if (!((a->qpB) == (b->qpB))) { onFail("a->qpB (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeH264FrameSizeEXT(
    const VkVideoEncodeH264FrameSizeEXT* a,
    const VkVideoEncodeH264FrameSizeEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->frameISize) == (b->frameISize))) { onFail("a->frameISize (Error: Value not equal)"); };
    if (!((a->framePSize) == (b->framePSize))) { onFail("a->framePSize (Error: Value not equal)"); };
    if (!((a->frameBSize) == (b->frameBSize))) { onFail("a->frameBSize (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeH264RateControlLayerInfoEXT(
    const VkVideoEncodeH264RateControlLayerInfoEXT* a,
    const VkVideoEncodeH264RateControlLayerInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->temporalLayerId) == (b->temporalLayerId))) { onFail("a->temporalLayerId (Error: Value not equal)"); };
    if (!((a->useInitialRcQp) == (b->useInitialRcQp))) { onFail("a->useInitialRcQp (Error: Value not equal)"); };
    checkEqual_VkVideoEncodeH264QpEXT(&a->initialRcQp, &b->initialRcQp, onFail);
    if (!((a->useMinQp) == (b->useMinQp))) { onFail("a->useMinQp (Error: Value not equal)"); };
    checkEqual_VkVideoEncodeH264QpEXT(&a->minQp, &b->minQp, onFail);
    if (!((a->useMaxQp) == (b->useMaxQp))) { onFail("a->useMaxQp (Error: Value not equal)"); };
    checkEqual_VkVideoEncodeH264QpEXT(&a->maxQp, &b->maxQp, onFail);
    if (!((a->useMaxFrameSize) == (b->useMaxFrameSize))) { onFail("a->useMaxFrameSize (Error: Value not equal)"); };
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->transformBlockSizes) == (b->transformBlockSizes))) { onFail("a->transformBlockSizes (Error: Value not equal)"); };
    if (!((a->maxPPictureL0ReferenceCount) == (b->maxPPictureL0ReferenceCount))) { onFail("a->maxPPictureL0ReferenceCount (Error: Value not equal)"); };
    if (!((a->maxBPictureL0ReferenceCount) == (b->maxBPictureL0ReferenceCount))) { onFail("a->maxBPictureL0ReferenceCount (Error: Value not equal)"); };
    if (!((a->maxL1ReferenceCount) == (b->maxL1ReferenceCount))) { onFail("a->maxL1ReferenceCount (Error: Value not equal)"); };
    if (!((a->maxSubLayersCount) == (b->maxSubLayersCount))) { onFail("a->maxSubLayersCount (Error: Value not equal)"); };
    if (!((a->minLog2MinLumaCodingBlockSizeMinus3) == (b->minLog2MinLumaCodingBlockSizeMinus3))) { onFail("a->minLog2MinLumaCodingBlockSizeMinus3 (Error: Value not equal)"); };
    if (!((a->maxLog2MinLumaCodingBlockSizeMinus3) == (b->maxLog2MinLumaCodingBlockSizeMinus3))) { onFail("a->maxLog2MinLumaCodingBlockSizeMinus3 (Error: Value not equal)"); };
    if (!((a->minLog2MinLumaTransformBlockSizeMinus2) == (b->minLog2MinLumaTransformBlockSizeMinus2))) { onFail("a->minLog2MinLumaTransformBlockSizeMinus2 (Error: Value not equal)"); };
    if (!((a->maxLog2MinLumaTransformBlockSizeMinus2) == (b->maxLog2MinLumaTransformBlockSizeMinus2))) { onFail("a->maxLog2MinLumaTransformBlockSizeMinus2 (Error: Value not equal)"); };
    if (!((a->minMaxTransformHierarchyDepthInter) == (b->minMaxTransformHierarchyDepthInter))) { onFail("a->minMaxTransformHierarchyDepthInter (Error: Value not equal)"); };
    if (!((a->maxMaxTransformHierarchyDepthInter) == (b->maxMaxTransformHierarchyDepthInter))) { onFail("a->maxMaxTransformHierarchyDepthInter (Error: Value not equal)"); };
    if (!((a->minMaxTransformHierarchyDepthIntra) == (b->minMaxTransformHierarchyDepthIntra))) { onFail("a->minMaxTransformHierarchyDepthIntra (Error: Value not equal)"); };
    if (!((a->maxMaxTransformHierarchyDepthIntra) == (b->maxMaxTransformHierarchyDepthIntra))) { onFail("a->maxMaxTransformHierarchyDepthIntra (Error: Value not equal)"); };
    if (!((a->maxDiffCuQpDeltaDepth) == (b->maxDiffCuQpDeltaDepth))) { onFail("a->maxDiffCuQpDeltaDepth (Error: Value not equal)"); };
    if (!((a->minMaxNumMergeCand) == (b->minMaxNumMergeCand))) { onFail("a->minMaxNumMergeCand (Error: Value not equal)"); };
    if (!((a->maxMaxNumMergeCand) == (b->maxMaxNumMergeCand))) { onFail("a->maxMaxNumMergeCand (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->stdVPSCount) == (b->stdVPSCount))) { onFail("a->stdVPSCount (Error: Value not equal)"); };
    if (!((!(a->pStdVPSs) && !(b->pStdVPSs)) || ((a->pStdVPSs) && (b->pStdVPSs)))) { onFail("a->pStdVPSs (Error: Mismatch in optional field)"); };
...
void checkEqual_VkVideoEncodeH265NaluSliceSegmentInfoEXT(
    ...
    const VkVideoEncodeH265NaluSliceSegmentInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (a->pStdReferenceFinalLists && b->pStdReferenceFinalLists)
    {
        if (!((memcmp(a->pStdReferenceFinalLists, b->pStdReferenceFinalLists, sizeof(const StdVideoEncodeH265ReferenceListsInfo)) == 0))) { onFail("a->pStdReferenceFinalLists (Error: Unequal dyn array)"); };
    }
    if (!((memcmp(a->pStdSliceSegmentHeader, b->pStdSliceSegmentHeader, sizeof(const StdVideoEncodeH265SliceSegmentHeader)) == 0))) { onFail("a->pStdSliceSegmentHeader (Error: Unequal dyn array)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->naluSliceSegmentEntryCount) == (b->naluSliceSegmentEntryCount))) { onFail("a->naluSliceSegmentEntryCount (Error: Value not equal)"); };
    if ((a->pNaluSliceSegmentEntries) && (b->pNaluSliceSegmentEntries))
    {
        if (!((a->naluSliceSegmentEntryCount) == (b->naluSliceSegmentEntryCount))) { onFail("a->pNaluSliceSegmentEntries (Error: Lengths not equal)"); };
        if ((a->naluSliceSegmentEntryCount) == (b->naluSliceSegmentEntryCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkVideoEncodeH265NaluSliceSegmentInfoEXT(a->pNaluSliceSegmentEntries + i, b->pNaluSliceSegmentEntries + i, onFail);
                }
            }
        }
    }
    if (!((memcmp(a->pStdPictureInfo, b->pStdPictureInfo, sizeof(const StdVideoEncodeH265PictureInfo)) == 0))) { onFail("a->pStdPictureInfo (Error: Unequal dyn array)"); };
}
...
void checkEqual_VkVideoEncodeH265ProfileInfoEXT(
    const VkVideoEncodeH265ProfileInfoEXT* a,
...
void checkEqual_VkVideoEncodeH265RateControlInfoEXT(
    const VkVideoEncodeH265RateControlInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->consecutiveBFrameCount) == (b->consecutiveBFrameCount))) { onFail("a->consecutiveBFrameCount (Error: Value not equal)"); };
    if (!((a->rateControlStructure) == (b->rateControlStructure))) { onFail("a->rateControlStructure (Error: Value not equal)"); };
    if (!((a->subLayerCount) == (b->subLayerCount))) { onFail("a->subLayerCount (Error: Value not equal)"); };
}

void checkEqual_VkVideoEncodeH265QpEXT(
    const VkVideoEncodeH265QpEXT* a,
    const VkVideoEncodeH265QpEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->qpI) == (b->qpI))) { onFail("a->qpI (Error: Value not equal)"); };
    if (!((a->qpP) == (b->qpP))) { onFail("a->qpP (Error: Value not equal)"); };
...
void checkEqual_VkVideoEncodeH265FrameSizeEXT(
    const VkVideoEncodeH265FrameSizeEXT* a,
...
void checkEqual_VkVideoEncodeH265RateControlLayerInfoEXT(
    ...
    const VkVideoEncodeH265RateControlLayerInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->temporalId) == (b->temporalId))) { onFail("a->temporalId (Error: Value not equal)"); };
    if (!((a->useInitialRcQp) == (b->useInitialRcQp))) { onFail("a->useInitialRcQp (Error: Value not equal)"); };
...
void checkEqual_VkPhysicalDevicePipelineRobustnessFeaturesEXT(
    ...
    const VkPhysicalDevicePipelineRobustnessFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->pipelineRobustness) == (b->pipelineRobustness))) { onFail("a->pipelineRobustness (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDevicePipelineRobustnessPropertiesEXT(
    const VkPhysicalDevicePipelineRobustnessPropertiesEXT* a,
    const VkPhysicalDevicePipelineRobustnessPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->defaultRobustnessStorageBuffers) == (b->defaultRobustnessStorageBuffers))) { onFail("a->defaultRobustnessStorageBuffers (Error: Value not equal)"); };
    if (!((a->defaultRobustnessUniformBuffers) == (b->defaultRobustnessUniformBuffers))) { onFail("a->defaultRobustnessUniformBuffers (Error: Value not equal)"); };
    if (!((a->defaultRobustnessVertexInputs) == (b->defaultRobustnessVertexInputs))) { onFail("a->defaultRobustnessVertexInputs (Error: Value not equal)"); };
    if (!((a->defaultRobustnessImages) == (b->defaultRobustnessImages))) { onFail("a->defaultRobustnessImages (Error: Value not equal)"); };
}

void checkEqual_VkPipelineRobustnessCreateInfoEXT(
    const VkPipelineRobustnessCreateInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->storageBuffers) == (b->storageBuffers))) { onFail("a->storageBuffers (Error: Value not equal)"); };
    if (!((a->uniformBuffers) == (b->uniformBuffers))) { onFail("a->uniformBuffers (Error: Value not equal)"); };
    if (!((a->vertexInputs) == (b->vertexInputs))) { onFail("a->vertexInputs (Error: Value not equal)"); };
    if (!((a->images) == (b->images))) { onFail("a->images (Error: Value not equal)"); };
}
...
void checkEqual_VkSurfacePresentModeEXT(
    const VkSurfacePresentModeEXT* a,
...
void checkEqual_VkSurfacePresentScalingCapabilitiesEXT(
    ...
    const VkSurfacePresentScalingCapabilitiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->supportedPresentScaling) == (b->supportedPresentScaling))) { onFail("a->supportedPresentScaling (Error: Value not equal)"); };
    if (!((a->supportedPresentGravityX) == (b->supportedPresentGravityX))) { onFail("a->supportedPresentGravityX (Error: Value not equal)"); };
    if (!((a->supportedPresentGravityY) == (b->supportedPresentGravityY))) { onFail("a->supportedPresentGravityY (Error: Value not equal)"); };
...
void checkEqual_VkSurfacePresentModeCompatibilityEXT(
    const VkSurfacePresentModeCompatibilityEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->presentModeCount) == (b->presentModeCount))) { onFail("a->presentModeCount (Error: Value not equal)"); };
    if (!((!(a->pPresentModes) && !(b->pPresentModes)) || ((a->pPresentModes) && (b->pPresentModes)))) { onFail("a->pPresentModes (Error: Mismatch in optional field)"); };
    if (a->pPresentModes && b->pPresentModes)
    {
        if (!((a->presentModeCount) == (b->presentModeCount))) { onFail("a->pPresentModes (Error: Lengths not equal)"); };
        if (!((memcmp(a->pPresentModes, b->pPresentModes, a->presentModeCount * sizeof(VkPresentModeKHR)) == 0))) { onFail("a->pPresentModes (Error: Unequal dyn array)"); };
    }
}
...
void checkEqual_VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT(
    ...
    const VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->swapchainMaintenance1) == (b->swapchainMaintenance1))) { onFail("a->swapchainMaintenance1 (Error: Value not equal)"); };
}

void checkEqual_VkSwapchainPresentFenceInfoEXT(
    const VkSwapchainPresentFenceInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->swapchainCount) == (b->swapchainCount))) { onFail("a->swapchainCount (Error: Value not equal)"); };
    if (!((a->swapchainCount) == (b->swapchainCount))) { onFail("a->pFences (Error: Lengths not equal)"); };
    if (!((memcmp(a->pFences, b->pFences, a->swapchainCount * sizeof(const VkFence)) == 0))) { onFail("a->pFences (Error: Unequal dyn array)"); };
}

void checkEqual_VkSwapchainPresentModesCreateInfoEXT(
    const VkSwapchainPresentModesCreateInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->presentModeCount) == (b->presentModeCount))) { onFail("a->presentModeCount (Error: Value not equal)"); };
    if (!((a->presentModeCount) == (b->presentModeCount))) { onFail("a->pPresentModes (Error: Lengths not equal)"); };
    if (!((memcmp(a->pPresentModes, b->pPresentModes, a->presentModeCount * sizeof(const VkPresentModeKHR)) == 0))) { onFail("a->pPresentModes (Error: Unequal dyn array)"); };
}

void checkEqual_VkSwapchainPresentModeInfoEXT(
    const VkSwapchainPresentModeInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->swapchainCount) == (b->swapchainCount))) { onFail("a->swapchainCount (Error: Value not equal)"); };
    if (!((a->swapchainCount) == (b->swapchainCount))) { onFail("a->pPresentModes (Error: Lengths not equal)"); };
    if (!((memcmp(a->pPresentModes, b->pPresentModes, a->swapchainCount * sizeof(const VkPresentModeKHR)) == 0))) { onFail("a->pPresentModes (Error: Unequal dyn array)"); };
}

void checkEqual_VkSwapchainPresentScalingCreateInfoEXT(
    const VkSwapchainPresentScalingCreateInfoEXT* a,
    const VkSwapchainPresentScalingCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->scalingBehavior) == (b->scalingBehavior))) { onFail("a->scalingBehavior (Error: Value not equal)"); };
    if (!((a->presentGravityX) == (b->presentGravityX))) { onFail("a->presentGravityX (Error: Value not equal)"); };
    if (!((a->presentGravityY) == (b->presentGravityY))) { onFail("a->presentGravityY (Error: Value not equal)"); };
}

void checkEqual_VkReleaseSwapchainImagesInfoEXT(
    const VkReleaseSwapchainImagesInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->swapchain) == (b->swapchain))) { onFail("a->swapchain (Error: Value not equal)"); };
    if (!((a->imageIndexCount) == (b->imageIndexCount))) { onFail("a->imageIndexCount (Error: Value not equal)"); };
    if (!((a->imageIndexCount) == (b->imageIndexCount))) { onFail("a->pImageIndices (Error: Lengths not equal)"); };
    if (!((memcmp(a->pImageIndices, b->pImageIndices, a->imageIndexCount * sizeof(const uint32_t)) == 0))) { onFail("a->pImageIndices (Error: Unequal dyn array)"); };
}
...
void checkEqual_VkPhysicalDevicePresentBarrierFeaturesNV(
    ...
    const VkPhysicalDevicePresentBarrierFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->presentBarrier) == (b->presentBarrier))) { onFail("a->presentBarrier (Error: Value not equal)"); };
}

void checkEqual_VkSurfaceCapabilitiesPresentBarrierNV(
    const VkSurfaceCapabilitiesPresentBarrierNV* a,
    const VkSurfaceCapabilitiesPresentBarrierNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->presentBarrierSupported) == (b->presentBarrierSupported))) { onFail("a->presentBarrierSupported (Error: Value not equal)"); };
}

void checkEqual_VkSwapchainPresentBarrierCreateInfoNV(
    const VkSwapchainPresentBarrierCreateInfoNV* a,
    const VkSwapchainPresentBarrierCreateInfoNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->presentBarrierEnable) == (b->presentBarrierEnable))) { onFail("a->presentBarrierEnable (Error: Value not equal)"); };
}
...
void checkEqual_VkQueryLowLatencySupportNV(
    const VkQueryLowLatencySupportNV* a,
...
void checkEqual_VkExportMetalObjectCreateInfoEXT(
    const VkExportMetalObjectCreateInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->exportObjectType) == (b->exportObjectType))) { onFail("a->exportObjectType (Error: Value not equal)"); };
}

void checkEqual_VkExportMetalObjectsInfoEXT(
    const VkExportMetalObjectsInfoEXT* a,
...
void checkEqual_VkExportMetalDeviceInfoEXT(
    const VkExportMetalDeviceInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->mtlDevice) == (b->mtlDevice))) { onFail("a->mtlDevice (Error: Value not equal)"); };
}

void checkEqual_VkExportMetalCommandQueueInfoEXT(
    const VkExportMetalCommandQueueInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->queue) == (b->queue))) { onFail("a->queue (Error: Value not equal)"); };
    if (!((a->mtlCommandQueue) == (b->mtlCommandQueue))) { onFail("a->mtlCommandQueue (Error: Value not equal)"); };
}

void checkEqual_VkExportMetalBufferInfoEXT(
    const VkExportMetalBufferInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->memory) == (b->memory))) { onFail("a->memory (Error: Value not equal)"); };
    if (!((a->mtlBuffer) == (b->mtlBuffer))) { onFail("a->mtlBuffer (Error: Value not equal)"); };
}

void checkEqual_VkImportMetalBufferInfoEXT(
    const VkImportMetalBufferInfoEXT* a,
...
void checkEqual_VkExportMetalTextureInfoEXT(
    const VkExportMetalTextureInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->image) == (b->image))) { onFail("a->image (Error: Value not equal)"); };
    if (!((a->imageView) == (b->imageView))) { onFail("a->imageView (Error: Value not equal)"); };
    if (!((a->bufferView) == (b->bufferView))) { onFail("a->bufferView (Error: Value not equal)"); };
    if (!((a->plane) == (b->plane))) { onFail("a->plane (Error: Value not equal)"); };
    if (!((a->mtlTexture) == (b->mtlTexture))) { onFail("a->mtlTexture (Error: Value not equal)"); };
}

void checkEqual_VkImportMetalTextureInfoEXT(
    const VkImportMetalTextureInfoEXT* a,
...
void checkEqual_VkExportMetalIOSurfaceInfoEXT(
    const VkExportMetalIOSurfaceInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->image) == (b->image))) { onFail("a->image (Error: Value not equal)"); };
    if (!((a->ioSurface) == (b->ioSurface))) { onFail("a->ioSurface (Error: Value not equal)"); };
}

void checkEqual_VkImportMetalIOSurfaceInfoEXT(
    const VkImportMetalIOSurfaceInfoEXT* a,
...
void checkEqual_VkExportMetalSharedEventInfoEXT(
    const VkExportMetalSharedEventInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->semaphore) == (b->semaphore))) { onFail("a->semaphore (Error: Value not equal)"); };
    if (!((a->event) == (b->event))) { onFail("a->event (Error: Value not equal)"); };
    if (!((a->mtlSharedEvent) == (b->mtlSharedEvent))) { onFail("a->mtlSharedEvent (Error: Value not equal)"); };
}

void checkEqual_VkImportMetalSharedEventInfoEXT(
    const VkImportMetalSharedEventInfoEXT* a,
...
void checkEqual_VkPhysicalDeviceDescriptorBufferPropertiesEXT(
    ...
    const VkPhysicalDeviceDescriptorBufferPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->combinedImageSamplerDescriptorSingleArray) == (b->combinedImageSamplerDescriptorSingleArray))) { onFail("a->combinedImageSamplerDescriptorSingleArray (Error: Value not equal)"); };
    if (!((a->bufferlessPushDescriptors) == (b->bufferlessPushDescriptors))) { onFail("a->bufferlessPushDescriptors (Error: Value not equal)"); };
    if (!((a->allowSamplerImageViewPostSubmitCreation) == (b->allowSamplerImageViewPostSubmitCreation))) { onFail("a->allowSamplerImageViewPostSubmitCreation (Error: Value not equal)"); };
    if (!((a->descriptorBufferOffsetAlignment) == (b->descriptorBufferOffsetAlignment))) { onFail("a->descriptorBufferOffsetAlignment (Error: Value not equal)"); };
    if (!((a->maxDescriptorBufferBindings) == (b->maxDescriptorBufferBindings))) { onFail("a->maxDescriptorBufferBindings (Error: Value not equal)"); };
    if (!((a->maxResourceDescriptorBufferBindings) == (b->maxResourceDescriptorBufferBindings))) { onFail("a->maxResourceDescriptorBufferBindings (Error: Value not equal)"); };
    if (!((a->maxSamplerDescriptorBufferBindings) == (b->maxSamplerDescriptorBufferBindings))) { onFail("a->maxSamplerDescriptorBufferBindings (Error: Value not equal)"); };
    if (!((a->maxEmbeddedImmutableSamplerBindings) == (b->maxEmbeddedImmutableSamplerBindings))) { onFail("a->maxEmbeddedImmutableSamplerBindings (Error: Value not equal)"); };
    if (!((a->maxEmbeddedImmutableSamplers) == (b->maxEmbeddedImmutableSamplers))) { onFail("a->maxEmbeddedImmutableSamplers (Error: Value not equal)"); };
    if (!((a->bufferCaptureReplayDescriptorDataSize) == (b->bufferCaptureReplayDescriptorDataSize))) { onFail("a->bufferCaptureReplayDescriptorDataSize (Error: Value not equal)"); };
    if (!((a->imageCaptureReplayDescriptorDataSize) == (b->imageCaptureReplayDescriptorDataSize))) { onFail("a->imageCaptureReplayDescriptorDataSize (Error: Value not equal)"); };
    if (!((a->imageViewCaptureReplayDescriptorDataSize) == (b->imageViewCaptureReplayDescriptorDataSize))) { onFail("a->imageViewCaptureReplayDescriptorDataSize (Error: Value not equal)"); };
    if (!((a->samplerCaptureReplayDescriptorDataSize) == (b->samplerCaptureReplayDescriptorDataSize))) { onFail("a->samplerCaptureReplayDescriptorDataSize (Error: Value not equal)"); };
    if (!((a->accelerationStructureCaptureReplayDescriptorDataSize) == (b->accelerationStructureCaptureReplayDescriptorDataSize))) { onFail("a->accelerationStructureCaptureReplayDescriptorDataSize (Error: Value not equal)"); };
    if (!((a->samplerDescriptorSize) == (b->samplerDescriptorSize))) { onFail("a->samplerDescriptorSize (Error: Value not equal)"); };
    if (!((a->combinedImageSamplerDescriptorSize) == (b->combinedImageSamplerDescriptorSize))) { onFail("a->combinedImageSamplerDescriptorSize (Error: Value not equal)"); };
    if (!((a->sampledImageDescriptorSize) == (b->sampledImageDescriptorSize))) { onFail("a->sampledImageDescriptorSize (Error: Value not equal)"); };
    if (!((a->storageImageDescriptorSize) == (b->storageImageDescriptorSize))) { onFail("a->storageImageDescriptorSize (Error: Value not equal)"); };
    if (!((a->uniformTexelBufferDescriptorSize) == (b->uniformTexelBufferDescriptorSize))) { onFail("a->uniformTexelBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->robustUniformTexelBufferDescriptorSize) == (b->robustUniformTexelBufferDescriptorSize))) { onFail("a->robustUniformTexelBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->storageTexelBufferDescriptorSize) == (b->storageTexelBufferDescriptorSize))) { onFail("a->storageTexelBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->robustStorageTexelBufferDescriptorSize) == (b->robustStorageTexelBufferDescriptorSize))) { onFail("a->robustStorageTexelBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->uniformBufferDescriptorSize) == (b->uniformBufferDescriptorSize))) { onFail("a->uniformBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->robustUniformBufferDescriptorSize) == (b->robustUniformBufferDescriptorSize))) { onFail("a->robustUniformBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->storageBufferDescriptorSize) == (b->storageBufferDescriptorSize))) { onFail("a->storageBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->robustStorageBufferDescriptorSize) == (b->robustStorageBufferDescriptorSize))) { onFail("a->robustStorageBufferDescriptorSize (Error: Value not equal)"); };
    if (!((a->inputAttachmentDescriptorSize) == (b->inputAttachmentDescriptorSize))) { onFail("a->inputAttachmentDescriptorSize (Error: Value not equal)"); };
    if (!((a->accelerationStructureDescriptorSize) == (b->accelerationStructureDescriptorSize))) { onFail("a->accelerationStructureDescriptorSize (Error: Value not equal)"); };
    if (!((a->maxSamplerDescriptorBufferRange) == (b->maxSamplerDescriptorBufferRange))) { onFail("a->maxSamplerDescriptorBufferRange (Error: Value not equal)"); };
    if (!((a->maxResourceDescriptorBufferRange) == (b->maxResourceDescriptorBufferRange))) { onFail("a->maxResourceDescriptorBufferRange (Error: Value not equal)"); };
    if (!((a->samplerDescriptorBufferAddressSpaceSize) == (b->samplerDescriptorBufferAddressSpaceSize))) { onFail("a->samplerDescriptorBufferAddressSpaceSize (Error: Value not equal)"); };
    if (!((a->resourceDescriptorBufferAddressSpaceSize) == (b->resourceDescriptorBufferAddressSpaceSize))) { onFail("a->resourceDescriptorBufferAddressSpaceSize (Error: Value not equal)"); };
    if (!((a->descriptorBufferAddressSpaceSize) == (b->descriptorBufferAddressSpaceSize))) { onFail("a->descriptorBufferAddressSpaceSize (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT(
    ...
    const VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->combinedImageSamplerDensityMapDescriptorSize) == (b->combinedImageSamplerDensityMapDescriptorSize))) { onFail("a->combinedImageSamplerDensityMapDescriptorSize (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceDescriptorBufferFeaturesEXT(
    const VkPhysicalDeviceDescriptorBufferFeaturesEXT* a,
    const VkPhysicalDeviceDescriptorBufferFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->descriptorBuffer) == (b->descriptorBuffer))) { onFail("a->descriptorBuffer (Error: Value not equal)"); };
    if (!((a->descriptorBufferCaptureReplay) == (b->descriptorBufferCaptureReplay))) { onFail("a->descriptorBufferCaptureReplay (Error: Value not equal)"); };
    if (!((a->descriptorBufferImageLayoutIgnored) == (b->descriptorBufferImageLayoutIgnored))) { onFail("a->descriptorBufferImageLayoutIgnored (Error: Value not equal)"); };
    if (!((a->descriptorBufferPushDescriptors) == (b->descriptorBufferPushDescriptors))) { onFail("a->descriptorBufferPushDescriptors (Error: Value not equal)"); };
}

void checkEqual_VkDescriptorAddressInfoEXT(
    const VkDescriptorAddressInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->address) == (b->address))) { onFail("a->address (Error: Value not equal)"); };
    if (!((a->range) == (b->range))) { onFail("a->range (Error: Value not equal)"); };
    if (!((a->format) == (b->format))) { onFail("a->format (Error: Value not equal)"); };
}

void checkEqual_VkDescriptorBufferBindingInfoEXT(
    const VkDescriptorBufferBindingInfoEXT* a,
...
void checkEqual_VkDescriptorBufferBindingPushDescriptorBufferHandleEXT(
    ...
    const VkDescriptorBufferBindingPushDescriptorBufferHandleEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkDescriptorDataEXT(
    const VkDescriptorDataEXT* a,
    const VkDescriptorDataEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((memcmp(a->pSampler, b->pSampler, sizeof(const VkSampler)) == 0))) { onFail("a->pSampler (Error: Unequal dyn array)"); };
    if ((a->pCombinedImageSampler) && (b->pCombinedImageSampler))
    {
        checkEqual_VkDescriptorImageInfo(a->pCombinedImageSampler, b->pCombinedImageSampler, onFail);
    }
    if ((a->pInputAttachmentImage) && (b->pInputAttachmentImage))
    {
        checkEqual_VkDescriptorImageInfo(a->pInputAttachmentImage, b->pInputAttachmentImage, onFail);
    }
    if (!((!(a->pSampledImage) && !(b->pSampledImage)) || ((a->pSampledImage) && (b->pSampledImage)))) { onFail("a->pSampledImage (Error: Mismatch in optional field)"); };
    ...
    if (!((!(a->pStorageImage) && !(b->pStorageImage)) || ((a->pStorageImage) && (b->pStorageImage)))) { onFail("a->pStorageImage (Error: Mismatch in optional field)"); };
    ...
    if (!((!(a->pUniformTexelBuffer) && !(b->pUniformTexelBuffer)) || ((a->pUniformTexelBuffer) && (b->pUniformTexelBuffer)))) { onFail("a->pUniformTexelBuffer (Error: Mismatch in optional field)"); };
    if (a->pUniformTexelBuffer && b->pUniformTexelBuffer)
    {
        if ((a->pUniformTexelBuffer) && (b->pUniformTexelBuffer))
        {
            checkEqual_VkDescriptorAddressInfoEXT(a->pUniformTexelBuffer, b->pUniformTexelBuffer, onFail);
        }
    }
    if (!((!(a->pStorageTexelBuffer) && !(b->pStorageTexelBuffer)) || ((a->pStorageTexelBuffer) && (b->pStorageTexelBuffer)))) { onFail("a->pStorageTexelBuffer (Error: Mismatch in optional field)"); };
    if (a->pStorageTexelBuffer && b->pStorageTexelBuffer)
    {
        if ((a->pStorageTexelBuffer) && (b->pStorageTexelBuffer))
        {
            checkEqual_VkDescriptorAddressInfoEXT(a->pStorageTexelBuffer, b->pStorageTexelBuffer, onFail);
        }
    }
    if (!((!(a->pUniformBuffer) && !(b->pUniformBuffer)) || ((a->pUniformBuffer) && (b->pUniformBuffer)))) { onFail("a->pUniformBuffer (Error: Mismatch in optional field)"); };
    ...
    if (!((!(a->pStorageBuffer) && !(b->pStorageBuffer)) || ((a->pStorageBuffer) && (b->pStorageBuffer)))) { onFail("a->pStorageBuffer (Error: Mismatch in optional field)"); };
...
void checkEqual_VkDescriptorGetInfoEXT(
    const VkDescriptorGetInfoEXT* a,
    const VkDescriptorGetInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkBufferCaptureDescriptorDataInfoEXT(
    const VkBufferCaptureDescriptorDataInfoEXT* a,
...
void checkEqual_VkImageCaptureDescriptorDataInfoEXT(
    const VkImageCaptureDescriptorDataInfoEXT* a,
...
void checkEqual_VkImageViewCaptureDescriptorDataInfoEXT(
    ...
    const VkImageViewCaptureDescriptorDataInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkSamplerCaptureDescriptorDataInfoEXT(
    const VkSamplerCaptureDescriptorDataInfoEXT* a,
    const VkSamplerCaptureDescriptorDataInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkOpaqueCaptureDescriptorDataCreateInfoEXT(
    ...
    const VkOpaqueCaptureDescriptorDataCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkAccelerationStructureCaptureDescriptorDataInfoEXT(
    ...
    const VkAccelerationStructureCaptureDescriptorDataInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->accelerationStructure) == (b->accelerationStructure))) { onFail("a->accelerationStructure (Error: Value not equal)"); };
    if (!((a->accelerationStructureNV) == (b->accelerationStructureNV))) { onFail("a->accelerationStructureNV (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT(
    ...
    const VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->graphicsPipelineLibrary) == (b->graphicsPipelineLibrary))) { onFail("a->graphicsPipelineLibrary (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT(
    ...
    const VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->graphicsPipelineLibraryFastLinking) == (b->graphicsPipelineLibraryFastLinking))) { onFail("a->graphicsPipelineLibraryFastLinking (Error: Value not equal)"); };
    if (!((a->graphicsPipelineLibraryIndependentInterpolationDecoration) == (b->graphicsPipelineLibraryIndependentInterpolationDecoration))) { onFail("a->graphicsPipelineLibraryIndependentInterpolationDecoration (Error: Value not equal)"); };
}

void checkEqual_VkGraphicsPipelineLibraryCreateInfoEXT(
    const VkGraphicsPipelineLibraryCreateInfoEXT* a,
    const VkGraphicsPipelineLibraryCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD(
    ...
    const VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderEarlyAndLateFragmentTests) == (b->shaderEarlyAndLateFragmentTests))) { onFail("a->shaderEarlyAndLateFragmentTests (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceImageCompressionControlFeaturesEXT(
    ...
    const VkPhysicalDeviceImageCompressionControlFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->imageCompressionControl) == (b->imageCompressionControl))) { onFail("a->imageCompressionControl (Error: Value not equal)"); };
}

void checkEqual_VkImageCompressionControlEXT(
    const VkImageCompressionControlEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->compressionControlPlaneCount) == (b->compressionControlPlaneCount))) { onFail("a->compressionControlPlaneCount (Error: Value not equal)"); };
    if (!((!(a->pFixedRateFlags) && !(b->pFixedRateFlags)) || ((a->pFixedRateFlags) && (b->pFixedRateFlags)))) { onFail("a->pFixedRateFlags (Error: Mismatch in optional field)"); };
    if (a->pFixedRateFlags && b->pFixedRateFlags)
    {
        if (!((a->compressionControlPlaneCount) == (b->compressionControlPlaneCount))) { onFail("a->pFixedRateFlags (Error: Lengths not equal)"); };
        if (!((memcmp(a->pFixedRateFlags, b->pFixedRateFlags, a->compressionControlPlaneCount * sizeof(VkImageCompressionFixedRateFlagsEXT)) == 0))) { onFail("a->pFixedRateFlags (Error: Unequal dyn array)"); };
    }
}

void checkEqual_VkSubresourceLayout2EXT(
    const VkSubresourceLayout2EXT* a,
...
void checkEqual_VkImageSubresource2EXT(
    const VkImageSubresource2EXT* a,
    const VkImageSubresource2EXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkImageCompressionPropertiesEXT(
    const VkImageCompressionPropertiesEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->imageCompressionFlags) == (b->imageCompressionFlags))) { onFail("a->imageCompressionFlags (Error: Value not equal)"); };
    if (!((a->imageCompressionFixedRateFlags) == (b->imageCompressionFixedRateFlags))) { onFail("a->imageCompressionFixedRateFlags (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT(
    ...
    const VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->attachmentFeedbackLoopLayout) == (b->attachmentFeedbackLoopLayout))) { onFail("a->attachmentFeedbackLoopLayout (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceFaultFeaturesEXT(
    const VkPhysicalDeviceFaultFeaturesEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->deviceFault) == (b->deviceFault))) { onFail("a->deviceFault (Error: Value not equal)"); };
    if (!((a->deviceFaultVendorBinary) == (b->deviceFaultVendorBinary))) { onFail("a->deviceFaultVendorBinary (Error: Value not equal)"); };
}

void checkEqual_VkDeviceFaultCountsEXT(
    const VkDeviceFaultCountsEXT* a,
    const VkDeviceFaultCountsEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->addressInfoCount) == (b->addressInfoCount))) { onFail("a->addressInfoCount (Error: Value not equal)"); };
    if (!((a->vendorInfoCount) == (b->vendorInfoCount))) { onFail("a->vendorInfoCount (Error: Value not equal)"); };
    if (!((a->vendorBinarySize) == (b->vendorBinarySize))) { onFail("a->vendorBinarySize (Error: Value not equal)"); };
}

void checkEqual_VkDeviceFaultAddressInfoEXT(
    const VkDeviceFaultAddressInfoEXT* a,
    const VkDeviceFaultAddressInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->addressType) == (b->addressType))) { onFail("a->addressType (Error: Value not equal)"); };
    if (!((a->reportedAddress) == (b->reportedAddress))) { onFail("a->reportedAddress (Error: Value not equal)"); };
    if (!((a->addressPrecision) == (b->addressPrecision))) { onFail("a->addressPrecision (Error: Value not equal)"); };
}

void checkEqual_VkDeviceFaultVendorInfoEXT(
    const VkDeviceFaultVendorInfoEXT* a,
    const VkDeviceFaultVendorInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((memcmp(a->description, b->description, VK_MAX_DESCRIPTION_SIZE * sizeof(char)) == 0))) { onFail("a->description (Error: Unequal static array)"); };
    if (!((a->vendorFaultCode) == (b->vendorFaultCode))) { onFail("a->vendorFaultCode (Error: Value not equal)"); };
    if (!((a->vendorFaultData) == (b->vendorFaultData))) { onFail("a->vendorFaultData (Error: Value not equal)"); };
}

void checkEqual_VkDeviceFaultInfoEXT(
    const VkDeviceFaultInfoEXT* a,
    const VkDeviceFaultInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((memcmp(a->description, b->description, VK_MAX_DESCRIPTION_SIZE * sizeof(char)) == 0))) { onFail("a->description (Error: Unequal static array)"); };
    if (!((!(a->pAddressInfos) && !(b->pAddressInfos)) || ((a->pAddressInfos) && (b->pAddressInfos)))) { onFail("a->pAddressInfos (Error: Mismatch in optional field)"); };
    ...
    if (!((!(a->pVendorInfos) && !(b->pVendorInfos)) || ((a->pVendorInfos) && (b->pVendorInfos)))) { onFail("a->pVendorInfos (Error: Mismatch in optional field)"); };
    ...
    if (!((!(a->pVendorBinaryData) && !(b->pVendorBinaryData)) || ((a->pVendorBinaryData) && (b->pVendorBinaryData)))) { onFail("a->pVendorBinaryData (Error: Mismatch in optional field)"); };
}

void checkEqual_VkDeviceFaultVendorBinaryHeaderVersionOneEXT(
    const VkDeviceFaultVendorBinaryHeaderVersionOneEXT* a,
    const VkDeviceFaultVendorBinaryHeaderVersionOneEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->headerSize) == (b->headerSize))) { onFail("a->headerSize (Error: Value not equal)"); };
    if (!((a->headerVersion) == (b->headerVersion))) { onFail("a->headerVersion (Error: Value not equal)"); };
    ...
    if (!((a->driverVersion) == (b->driverVersion))) { onFail("a->driverVersion (Error: Value not equal)"); };
    if (!((memcmp(a->pipelineCacheUUID, b->pipelineCacheUUID, VK_UUID_SIZE * sizeof(uint8_t)) == 0))) { onFail("a->pipelineCacheUUID (Error: Unequal static array)"); };
    if (!((a->applicationNameOffset) == (b->applicationNameOffset))) { onFail("a->applicationNameOffset (Error: Value not equal)"); };
    if (!((a->applicationVersion) == (b->applicationVersion))) { onFail("a->applicationVersion (Error: Value not equal)"); };
    if (!((a->engineNameOffset) == (b->engineNameOffset))) { onFail("a->engineNameOffset (Error: Value not equal)"); };
    if (!((a->engineVersion) == (b->engineVersion))) { onFail("a->engineVersion (Error: Value not equal)"); };
    if (!((a->apiVersion) == (b->apiVersion))) { onFail("a->apiVersion (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->rasterizationOrderColorAttachmentAccess) == (b->rasterizationOrderColorAttachmentAccess))) { onFail("a->rasterizationOrderColorAttachmentAccess (Error: Value not equal)"); };
    if (!((a->rasterizationOrderDepthAttachmentAccess) == (b->rasterizationOrderDepthAttachmentAccess))) { onFail("a->rasterizationOrderDepthAttachmentAccess (Error: Value not equal)"); };
    if (!((a->rasterizationOrderStencilAttachmentAccess) == (b->rasterizationOrderStencilAttachmentAccess))) { onFail("a->rasterizationOrderStencilAttachmentAccess (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT(
    ...
    const VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkMutableDescriptorTypeListEXT(
    const VkMutableDescriptorTypeListEXT* a,
...
void checkEqual_VkMutableDescriptorTypeCreateInfoEXT(
    const VkMutableDescriptorTypeCreateInfoEXT* a,
    ...
    if ((a->pMutableDescriptorTypeLists) && (b->pMutableDescriptorTypeLists))
    {
        ...
        if ((a->mutableDescriptorTypeListCount) == (b->mutableDescriptorTypeListCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkMutableDescriptorTypeListEXT(a->pMutableDescriptorTypeLists + i, b->pMutableDescriptorTypeLists + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPhysicalDeviceAddressBindingReportFeaturesEXT(
    ...
    const VkPhysicalDeviceAddressBindingReportFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->reportAddressBinding) == (b->reportAddressBinding))) { onFail("a->reportAddressBinding (Error: Value not equal)"); };
}

void checkEqual_VkDeviceAddressBindingCallbackDataEXT(
    const VkDeviceAddressBindingCallbackDataEXT* a,
    const VkDeviceAddressBindingCallbackDataEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->baseAddress) == (b->baseAddress))) { onFail("a->baseAddress (Error: Value not equal)"); };
    if (!((a->size) == (b->size))) { onFail("a->size (Error: Value not equal)"); };
    if (!((a->bindingType) == (b->bindingType))) { onFail("a->bindingType (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceDepthClipControlFeaturesEXT(
    ...
    const VkPhysicalDeviceDepthClipControlFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->depthClipControl) == (b->depthClipControl))) { onFail("a->depthClipControl (Error: Value not equal)"); };
}

void checkEqual_VkPipelineViewportDepthClipControlCreateInfoEXT(
    const VkPipelineViewportDepthClipControlCreateInfoEXT* a,
    const VkPipelineViewportDepthClipControlCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->negativeOneToOne) == (b->negativeOneToOne))) { onFail("a->negativeOneToOne (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        if (!((a->colorSpaceCount) == (b->colorSpaceCount))) { onFail("a->pColorSpaces (Error: Lengths not equal)"); };
        if ((a->colorSpaceCount) == (b->colorSpaceCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkSysmemColorSpaceFUCHSIA(a->pColorSpaces + i, b->pColorSpaces + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPipelinePropertiesIdentifierEXT(
    const VkPipelinePropertiesIdentifierEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((memcmp(a->pipelineIdentifier, b->pipelineIdentifier, VK_UUID_SIZE * sizeof(uint8_t)) == 0))) { onFail("a->pipelineIdentifier (Error: Unequal static array)"); };
}

void checkEqual_VkPhysicalDevicePipelinePropertiesFeaturesEXT(
    const VkPhysicalDevicePipelinePropertiesFeaturesEXT* a,
    const VkPhysicalDevicePipelinePropertiesFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->pipelinePropertiesIdentifier) == (b->pipelinePropertiesIdentifier))) { onFail("a->pipelinePropertiesIdentifier (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->multisampledRenderToSingleSampled) == (b->multisampledRenderToSingleSampled))) { onFail("a->multisampledRenderToSingleSampled (Error: Value not equal)"); };
}

void checkEqual_VkSubpassResolvePerformanceQueryEXT(
    const VkSubpassResolvePerformanceQueryEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->optimal) == (b->optimal))) { onFail("a->optimal (Error: Value not equal)"); };
}

void checkEqual_VkMultisampledRenderToSingleSampledInfoEXT(
    const VkMultisampledRenderToSingleSampledInfoEXT* a,
    const VkMultisampledRenderToSingleSampledInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->multisampledRenderToSingleSampledEnable) == (b->multisampledRenderToSingleSampledEnable))) { onFail("a->multisampledRenderToSingleSampledEnable (Error: Value not equal)"); };
    if (!((a->rasterizationSamples) == (b->rasterizationSamples))) { onFail("a->rasterizationSamples (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(
    ...
    const VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->primitivesGeneratedQuery) == (b->primitivesGeneratedQuery))) { onFail("a->primitivesGeneratedQuery (Error: Value not equal)"); };
    if (!((a->primitivesGeneratedQueryWithRasterizerDiscard) == (b->primitivesGeneratedQueryWithRasterizerDiscard))) { onFail("a->primitivesGeneratedQueryWithRasterizerDiscard (Error: Value not equal)"); };
    if (!((a->primitivesGeneratedQueryWithNonZeroStreams) == (b->primitivesGeneratedQueryWithNonZeroStreams))) { onFail("a->primitivesGeneratedQueryWithNonZeroStreams (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceImageViewMinLodFeaturesEXT(
    ...
    const VkPhysicalDeviceImageViewMinLodFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkImageViewMinLodCreateInfoEXT(
    const VkImageViewMinLodCreateInfoEXT* a,
...
void checkEqual_VkPhysicalDeviceImage2DViewOf3DFeaturesEXT(
    ...
    const VkPhysicalDeviceImage2DViewOf3DFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->image2DViewOf3D) == (b->image2DViewOf3D))) { onFail("a->image2DViewOf3D (Error: Value not equal)"); };
    if (!((a->sampler2DViewOf3D) == (b->sampler2DViewOf3D))) { onFail("a->sampler2DViewOf3D (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceShaderTileImageFeaturesEXT(
    ...
    const VkPhysicalDeviceShaderTileImageFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderTileImageColorReadAccess) == (b->shaderTileImageColorReadAccess))) { onFail("a->shaderTileImageColorReadAccess (Error: Value not equal)"); };
    if (!((a->shaderTileImageDepthReadAccess) == (b->shaderTileImageDepthReadAccess))) { onFail("a->shaderTileImageDepthReadAccess (Error: Value not equal)"); };
    if (!((a->shaderTileImageStencilReadAccess) == (b->shaderTileImageStencilReadAccess))) { onFail("a->shaderTileImageStencilReadAccess (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceShaderTileImagePropertiesEXT(
    const VkPhysicalDeviceShaderTileImagePropertiesEXT* a,
    const VkPhysicalDeviceShaderTileImagePropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderTileImageCoherentReadAccelerated) == (b->shaderTileImageCoherentReadAccelerated))) { onFail("a->shaderTileImageCoherentReadAccelerated (Error: Value not equal)"); };
    if (!((a->shaderTileImageReadSampleFromPixelRateInvocation) == (b->shaderTileImageReadSampleFromPixelRateInvocation))) { onFail("a->shaderTileImageReadSampleFromPixelRateInvocation (Error: Value not equal)"); };
    if (!((a->shaderTileImageReadFromHelperInvocation) == (b->shaderTileImageReadFromHelperInvocation))) { onFail("a->shaderTileImageReadFromHelperInvocation (Error: Value not equal)"); };
}

#endif
#ifdef VK_EXT_opacity_micromap
void checkEqual_VkMicromapUsageEXT(
    const VkMicromapUsageEXT* a,
    const VkMicromapUsageEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->count) == (b->count))) { onFail("a->count (Error: Value not equal)"); };
    if (!((a->subdivisionLevel) == (b->subdivisionLevel))) { onFail("a->subdivisionLevel (Error: Value not equal)"); };
    if (!((a->format) == (b->format))) { onFail("a->format (Error: Value not equal)"); };
}
...
void checkEqual_VkMicromapBuildInfoEXT(
    const VkMicromapBuildInfoEXT* a,
    const VkMicromapBuildInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->mode) == (b->mode))) { onFail("a->mode (Error: Value not equal)"); };
    if (!((a->dstMicromap) == (b->dstMicromap))) { onFail("a->dstMicromap (Error: Value not equal)"); };
    if (!((a->usageCountsCount) == (b->usageCountsCount))) { onFail("a->usageCountsCount (Error: Value not equal)"); };
    if (!((!(a->pUsageCounts) && !(b->pUsageCounts)) || ((a->pUsageCounts) && (b->pUsageCounts)))) { onFail("a->pUsageCounts (Error: Mismatch in optional field)"); };
    if (a->pUsageCounts && b->pUsageCounts)
    {
        if ((a->pUsageCounts) && (b->pUsageCounts))
        {
            if (!((a->usageCountsCount) == (b->usageCountsCount))) { onFail("a->pUsageCounts (Error: Lengths not equal)"); };
            if ((a->usageCountsCount) == (b->usageCountsCount))
            {
                if (a)
                {
                    ...
                    {
                        checkEqual_VkMicromapUsageEXT(a->pUsageCounts + i, b->pUsageCounts + i, onFail);
                    }
                }
            }
        }
    ...
    if (!((a->triangleArrayStride) == (b->triangleArrayStride))) { onFail("a->triangleArrayStride (Error: Value not equal)"); };
}

void checkEqual_VkMicromapCreateInfoEXT(
    const VkMicromapCreateInfoEXT* a,
...
void checkEqual_VkPhysicalDeviceOpacityMicromapFeaturesEXT(
    ...
    const VkPhysicalDeviceOpacityMicromapFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->micromap) == (b->micromap))) { onFail("a->micromap (Error: Value not equal)"); };
    if (!((a->micromapCaptureReplay) == (b->micromapCaptureReplay))) { onFail("a->micromapCaptureReplay (Error: Value not equal)"); };
    if (!((a->micromapHostCommands) == (b->micromapHostCommands))) { onFail("a->micromapHostCommands (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceOpacityMicromapPropertiesEXT(
    const VkPhysicalDeviceOpacityMicromapPropertiesEXT* a,
    const VkPhysicalDeviceOpacityMicromapPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxOpacity2StateSubdivisionLevel) == (b->maxOpacity2StateSubdivisionLevel))) { onFail("a->maxOpacity2StateSubdivisionLevel (Error: Value not equal)"); };
    if (!((a->maxOpacity4StateSubdivisionLevel) == (b->maxOpacity4StateSubdivisionLevel))) { onFail("a->maxOpacity4StateSubdivisionLevel (Error: Value not equal)"); };
}

void checkEqual_VkMicromapVersionInfoEXT(
    const VkMicromapVersionInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((latexmath:[2 \times \mathtt{VK\_UUID\_SIZE}]) == (latexmath:[2 \times \mathtt{VK\_UUID\_SIZE}]))) { onFail("a->pVersionData (Error: Lengths not equal)"); };
    if (!((memcmp(a->pVersionData, b->pVersionData, latexmath:[2 \times \mathtt{VK\_UUID\_SIZE}] * sizeof(const uint8_t)) == 0))) { onFail("a->pVersionData (Error: Unequal dyn array)"); };
}

void checkEqual_VkCopyMicromapToMemoryInfoEXT(
    const VkCopyMicromapToMemoryInfoEXT* a,
...
void checkEqual_VkCopyMemoryToMicromapInfoEXT(
    const VkCopyMemoryToMicromapInfoEXT* a,
...
void checkEqual_VkCopyMicromapInfoEXT(
    const VkCopyMicromapInfoEXT* a,
    const VkCopyMicromapInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkMicromapBuildSizesInfoEXT(
    const VkMicromapBuildSizesInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->micromapSize) == (b->micromapSize))) { onFail("a->micromapSize (Error: Value not equal)"); };
    if (!((a->buildScratchSize) == (b->buildScratchSize))) { onFail("a->buildScratchSize (Error: Value not equal)"); };
    if (!((a->discardable) == (b->discardable))) { onFail("a->discardable (Error: Value not equal)"); };
}
...
void checkEqual_VkAccelerationStructureTrianglesOpacityMicromapEXT(
    ...
    const VkAccelerationStructureTrianglesOpacityMicromapEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->indexStride) == (b->indexStride))) { onFail("a->indexStride (Error: Value not equal)"); };
    if (!((a->baseTriangle) == (b->baseTriangle))) { onFail("a->baseTriangle (Error: Value not equal)"); };
    if (!((a->usageCountsCount) == (b->usageCountsCount))) { onFail("a->usageCountsCount (Error: Value not equal)"); };
    if (!((!(a->pUsageCounts) && !(b->pUsageCounts)) || ((a->pUsageCounts) && (b->pUsageCounts)))) { onFail("a->pUsageCounts (Error: Mismatch in optional field)"); };
    if (a->pUsageCounts && b->pUsageCounts)
    {
...
void checkEqual_VkMicromapTriangleEXT(
    const VkMicromapTriangleEXT* a,
    const VkMicromapTriangleEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->dataOffset) == (b->dataOffset))) { onFail("a->dataOffset (Error: Value not equal)"); };
    if (!((a->subdivisionLevel) == (b->subdivisionLevel))) { onFail("a->subdivisionLevel (Error: Value not equal)"); };
    if (!((a->format) == (b->format))) { onFail("a->format (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceDisplacementMicromapFeaturesNV(
    ...
    const VkPhysicalDeviceDisplacementMicromapFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->displacementMicromap) == (b->displacementMicromap))) { onFail("a->displacementMicromap (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceDisplacementMicromapPropertiesNV(
    const VkPhysicalDeviceDisplacementMicromapPropertiesNV* a,
    const VkPhysicalDeviceDisplacementMicromapPropertiesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxDisplacementMicromapSubdivisionLevel) == (b->maxDisplacementMicromapSubdivisionLevel))) { onFail("a->maxDisplacementMicromapSubdivisionLevel (Error: Value not equal)"); };
}
...
void checkEqual_VkAccelerationStructureTrianglesDisplacementMicromapNV(
    ...
    const VkAccelerationStructureTrianglesDisplacementMicromapNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->displacementBiasAndScaleFormat) == (b->displacementBiasAndScaleFormat))) { onFail("a->displacementBiasAndScaleFormat (Error: Value not equal)"); };
    if (!((a->displacementVectorFormat) == (b->displacementVectorFormat))) { onFail("a->displacementVectorFormat (Error: Value not equal)"); };
    checkEqual_VkDeviceOrHostAddressConstKHR(&a->displacementBiasAndScaleBuffer, &b->displacementBiasAndScaleBuffer, onFail);
    if (!((a->displacementBiasAndScaleStride) == (b->displacementBiasAndScaleStride))) { onFail("a->displacementBiasAndScaleStride (Error: Value not equal)"); };
    checkEqual_VkDeviceOrHostAddressConstKHR(&a->displacementVectorBuffer, &b->displacementVectorBuffer, onFail);
    if (!((a->displacementVectorStride) == (b->displacementVectorStride))) { onFail("a->displacementVectorStride (Error: Value not equal)"); };
    checkEqual_VkDeviceOrHostAddressConstKHR(&a->displacedMicromapPrimitiveFlags, &b->displacedMicromapPrimitiveFlags, onFail);
    if (!((a->displacedMicromapPrimitiveFlagsStride) == (b->displacedMicromapPrimitiveFlagsStride))) { onFail("a->displacedMicromapPrimitiveFlagsStride (Error: Value not equal)"); };
    if (!((a->indexType) == (b->indexType))) { onFail("a->indexType (Error: Value not equal)"); };
    checkEqual_VkDeviceOrHostAddressConstKHR(&a->indexBuffer, &b->indexBuffer, onFail);
    if (!((a->indexStride) == (b->indexStride))) { onFail("a->indexStride (Error: Value not equal)"); };
    if (!((a->baseTriangle) == (b->baseTriangle))) { onFail("a->baseTriangle (Error: Value not equal)"); };
...
void checkEqual_VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI(
    ...
    const VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->clustercullingShader) == (b->clustercullingShader))) { onFail("a->clustercullingShader (Error: Value not equal)"); };
    if (!((a->multiviewClusterCullingShader) == (b->multiviewClusterCullingShader))) { onFail("a->multiviewClusterCullingShader (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI(
    ...
    const VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((memcmp(a->maxWorkGroupCount, b->maxWorkGroupCount, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxWorkGroupCount (Error: Unequal static array)"); };
    if (!((memcmp(a->maxWorkGroupSize, b->maxWorkGroupSize, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxWorkGroupSize (Error: Unequal static array)"); };
    if (!((a->maxOutputClusterCount) == (b->maxOutputClusterCount))) { onFail("a->maxOutputClusterCount (Error: Value not equal)"); };
    if (!((a->indirectBufferOffsetAlignment) == (b->indirectBufferOffsetAlignment))) { onFail("a->indirectBufferOffsetAlignment (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceShaderCorePropertiesARM(
    ...
    const VkPhysicalDeviceShaderCorePropertiesARM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->pixelRate) == (b->pixelRate))) { onFail("a->pixelRate (Error: Value not equal)"); };
    if (!((a->texelRate) == (b->texelRate))) { onFail("a->texelRate (Error: Value not equal)"); };
    if (!((a->fmaRate) == (b->fmaRate))) { onFail("a->fmaRate (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT(
    ...
    const VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->imageSlicedViewOf3D) == (b->imageSlicedViewOf3D))) { onFail("a->imageSlicedViewOf3D (Error: Value not equal)"); };
}

void checkEqual_VkImageViewSlicedCreateInfoEXT(
    const VkImageViewSlicedCreateInfoEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->sliceOffset) == (b->sliceOffset))) { onFail("a->sliceOffset (Error: Value not equal)"); };
    if (!((a->sliceCount) == (b->sliceCount))) { onFail("a->sliceCount (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE(
    ...
    const VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->descriptorSetHostMapping) == (b->descriptorSetHostMapping))) { onFail("a->descriptorSetHostMapping (Error: Value not equal)"); };
}

void checkEqual_VkDescriptorSetBindingReferenceVALVE(
    const VkDescriptorSetBindingReferenceVALVE* a,
...
void checkEqual_VkDescriptorSetLayoutHostMappingInfoVALVE(
    ...
    const VkDescriptorSetLayoutHostMappingInfoVALVE* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->descriptorOffset) == (b->descriptorOffset))) { onFail("a->descriptorOffset (Error: Value not equal)"); };
    if (!((a->descriptorSize) == (b->descriptorSize))) { onFail("a->descriptorSize (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceDepthClampZeroOneFeaturesEXT(
    ...
    const VkPhysicalDeviceDepthClampZeroOneFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->depthClampZeroOne) == (b->depthClampZeroOne))) { onFail("a->depthClampZeroOne (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT(
    ...
    const VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->nonSeamlessCubeMap) == (b->nonSeamlessCubeMap))) { onFail("a->nonSeamlessCubeMap (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM(
    ...
    const VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->fragmentDensityMapOffset) == (b->fragmentDensityMapOffset))) { onFail("a->fragmentDensityMapOffset (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM(
    ...
    const VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    checkEqual_VkExtent2D(&a->fragmentDensityOffsetGranularity, &b->fragmentDensityOffsetGranularity, onFail);
}

void checkEqual_VkSubpassFragmentDensityMapOffsetEndInfoQCOM(
    const VkSubpassFragmentDensityMapOffsetEndInfoQCOM* a,
    const VkSubpassFragmentDensityMapOffsetEndInfoQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->fragmentDensityOffsetCount) == (b->fragmentDensityOffsetCount))) { onFail("a->fragmentDensityOffsetCount (Error: Value not equal)"); };
    if ((a->pFragmentDensityOffsets) && (b->pFragmentDensityOffsets))
    {
        if (!((a->fragmentDensityOffsetCount) == (b->fragmentDensityOffsetCount))) { onFail("a->pFragmentDensityOffsets (Error: Lengths not equal)"); };
        if ((a->fragmentDensityOffsetCount) == (b->fragmentDensityOffsetCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkOffset2D(a->pFragmentDensityOffsets + i, b->pFragmentDensityOffsets + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkCopyMemoryIndirectCommandNV(
    const VkCopyMemoryIndirectCommandNV* a,
    const VkCopyMemoryIndirectCommandNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->srcAddress) == (b->srcAddress))) { onFail("a->srcAddress (Error: Value not equal)"); };
    if (!((a->dstAddress) == (b->dstAddress))) { onFail("a->dstAddress (Error: Value not equal)"); };
    if (!((a->size) == (b->size))) { onFail("a->size (Error: Value not equal)"); };
}

void checkEqual_VkCopyMemoryToImageIndirectCommandNV(
    const VkCopyMemoryToImageIndirectCommandNV* a,
...
void checkEqual_VkPhysicalDeviceCopyMemoryIndirectFeaturesNV(
    ...
    const VkPhysicalDeviceCopyMemoryIndirectFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->indirectCopy) == (b->indirectCopy))) { onFail("a->indirectCopy (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(
    const VkPhysicalDeviceCopyMemoryIndirectPropertiesNV* a,
    const VkPhysicalDeviceCopyMemoryIndirectPropertiesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->supportedQueues) == (b->supportedQueues))) { onFail("a->supportedQueues (Error: Value not equal)"); };
}

#endif
#ifdef VK_NV_memory_decompression
void checkEqual_VkDecompressMemoryRegionNV(
    const VkDecompressMemoryRegionNV* a,
    const VkDecompressMemoryRegionNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->srcAddress) == (b->srcAddress))) { onFail("a->srcAddress (Error: Value not equal)"); };
    if (!((a->dstAddress) == (b->dstAddress))) { onFail("a->dstAddress (Error: Value not equal)"); };
    if (!((a->compressedSize) == (b->compressedSize))) { onFail("a->compressedSize (Error: Value not equal)"); };
    if (!((a->decompressedSize) == (b->decompressedSize))) { onFail("a->decompressedSize (Error: Value not equal)"); };
    if (!((a->decompressionMethod) == (b->decompressionMethod))) { onFail("a->decompressionMethod (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceMemoryDecompressionFeaturesNV(
    const VkPhysicalDeviceMemoryDecompressionFeaturesNV* a,
    const VkPhysicalDeviceMemoryDecompressionFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->memoryDecompression) == (b->memoryDecompression))) { onFail("a->memoryDecompression (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceMemoryDecompressionPropertiesNV(
    const VkPhysicalDeviceMemoryDecompressionPropertiesNV* a,
    const VkPhysicalDeviceMemoryDecompressionPropertiesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->decompressionMethods) == (b->decompressionMethods))) { onFail("a->decompressionMethods (Error: Value not equal)"); };
    if (!((a->maxDecompressionIndirectCount) == (b->maxDecompressionIndirectCount))) { onFail("a->maxDecompressionIndirectCount (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceLinearColorAttachmentFeaturesNV(
    ...
    const VkPhysicalDeviceLinearColorAttachmentFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->linearColorAttachment) == (b->linearColorAttachment))) { onFail("a->linearColorAttachment (Error: Value not equal)"); };
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->imageCompressionControlSwapchain) == (b->imageCompressionControlSwapchain))) { onFail("a->imageCompressionControlSwapchain (Error: Value not equal)"); };
}

#endif
#ifdef VK_QCOM_image_processing
void checkEqual_VkImageViewSampleWeightCreateInfoQCOM(
    const VkImageViewSampleWeightCreateInfoQCOM* a,
    const VkImageViewSampleWeightCreateInfoQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->numPhases) == (b->numPhases))) { onFail("a->numPhases (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceImageProcessingFeaturesQCOM(
    const VkPhysicalDeviceImageProcessingFeaturesQCOM* a,
    const VkPhysicalDeviceImageProcessingFeaturesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->textureSampleWeighted) == (b->textureSampleWeighted))) { onFail("a->textureSampleWeighted (Error: Value not equal)"); };
    if (!((a->textureBoxFilter) == (b->textureBoxFilter))) { onFail("a->textureBoxFilter (Error: Value not equal)"); };
    if (!((a->textureBlockMatch) == (b->textureBlockMatch))) { onFail("a->textureBlockMatch (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceImageProcessingPropertiesQCOM(
    const VkPhysicalDeviceImageProcessingPropertiesQCOM* a,
    const VkPhysicalDeviceImageProcessingPropertiesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxWeightFilterPhases) == (b->maxWeightFilterPhases))) { onFail("a->maxWeightFilterPhases (Error: Value not equal)"); };
...
void checkEqual_VkPhysicalDeviceExtendedDynamicState3FeaturesEXT(
    ...
    const VkPhysicalDeviceExtendedDynamicState3FeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->extendedDynamicState3TessellationDomainOrigin) == (b->extendedDynamicState3TessellationDomainOrigin))) { onFail("a->extendedDynamicState3TessellationDomainOrigin (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3DepthClampEnable) == (b->extendedDynamicState3DepthClampEnable))) { onFail("a->extendedDynamicState3DepthClampEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3PolygonMode) == (b->extendedDynamicState3PolygonMode))) { onFail("a->extendedDynamicState3PolygonMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3RasterizationSamples) == (b->extendedDynamicState3RasterizationSamples))) { onFail("a->extendedDynamicState3RasterizationSamples (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3SampleMask) == (b->extendedDynamicState3SampleMask))) { onFail("a->extendedDynamicState3SampleMask (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3AlphaToCoverageEnable) == (b->extendedDynamicState3AlphaToCoverageEnable))) { onFail("a->extendedDynamicState3AlphaToCoverageEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3AlphaToOneEnable) == (b->extendedDynamicState3AlphaToOneEnable))) { onFail("a->extendedDynamicState3AlphaToOneEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3LogicOpEnable) == (b->extendedDynamicState3LogicOpEnable))) { onFail("a->extendedDynamicState3LogicOpEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ColorBlendEnable) == (b->extendedDynamicState3ColorBlendEnable))) { onFail("a->extendedDynamicState3ColorBlendEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ColorBlendEquation) == (b->extendedDynamicState3ColorBlendEquation))) { onFail("a->extendedDynamicState3ColorBlendEquation (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ColorWriteMask) == (b->extendedDynamicState3ColorWriteMask))) { onFail("a->extendedDynamicState3ColorWriteMask (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3RasterizationStream) == (b->extendedDynamicState3RasterizationStream))) { onFail("a->extendedDynamicState3RasterizationStream (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ConservativeRasterizationMode) == (b->extendedDynamicState3ConservativeRasterizationMode))) { onFail("a->extendedDynamicState3ConservativeRasterizationMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ExtraPrimitiveOverestimationSize) == (b->extendedDynamicState3ExtraPrimitiveOverestimationSize))) { onFail("a->extendedDynamicState3ExtraPrimitiveOverestimationSize (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3DepthClipEnable) == (b->extendedDynamicState3DepthClipEnable))) { onFail("a->extendedDynamicState3DepthClipEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3SampleLocationsEnable) == (b->extendedDynamicState3SampleLocationsEnable))) { onFail("a->extendedDynamicState3SampleLocationsEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ColorBlendAdvanced) == (b->extendedDynamicState3ColorBlendAdvanced))) { onFail("a->extendedDynamicState3ColorBlendAdvanced (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ProvokingVertexMode) == (b->extendedDynamicState3ProvokingVertexMode))) { onFail("a->extendedDynamicState3ProvokingVertexMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3LineRasterizationMode) == (b->extendedDynamicState3LineRasterizationMode))) { onFail("a->extendedDynamicState3LineRasterizationMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3LineStippleEnable) == (b->extendedDynamicState3LineStippleEnable))) { onFail("a->extendedDynamicState3LineStippleEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3DepthClipNegativeOneToOne) == (b->extendedDynamicState3DepthClipNegativeOneToOne))) { onFail("a->extendedDynamicState3DepthClipNegativeOneToOne (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ViewportWScalingEnable) == (b->extendedDynamicState3ViewportWScalingEnable))) { onFail("a->extendedDynamicState3ViewportWScalingEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ViewportSwizzle) == (b->extendedDynamicState3ViewportSwizzle))) { onFail("a->extendedDynamicState3ViewportSwizzle (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageToColorEnable) == (b->extendedDynamicState3CoverageToColorEnable))) { onFail("a->extendedDynamicState3CoverageToColorEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageToColorLocation) == (b->extendedDynamicState3CoverageToColorLocation))) { onFail("a->extendedDynamicState3CoverageToColorLocation (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageModulationMode) == (b->extendedDynamicState3CoverageModulationMode))) { onFail("a->extendedDynamicState3CoverageModulationMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageModulationTableEnable) == (b->extendedDynamicState3CoverageModulationTableEnable))) { onFail("a->extendedDynamicState3CoverageModulationTableEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageModulationTable) == (b->extendedDynamicState3CoverageModulationTable))) { onFail("a->extendedDynamicState3CoverageModulationTable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3CoverageReductionMode) == (b->extendedDynamicState3CoverageReductionMode))) { onFail("a->extendedDynamicState3CoverageReductionMode (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3RepresentativeFragmentTestEnable) == (b->extendedDynamicState3RepresentativeFragmentTestEnable))) { onFail("a->extendedDynamicState3RepresentativeFragmentTestEnable (Error: Value not equal)"); };
    if (!((a->extendedDynamicState3ShadingRateImageEnable) == (b->extendedDynamicState3ShadingRateImageEnable))) { onFail("a->extendedDynamicState3ShadingRateImageEnable (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(
    ...
    const VkPhysicalDeviceExtendedDynamicState3PropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->dynamicPrimitiveTopologyUnrestricted) == (b->dynamicPrimitiveTopologyUnrestricted))) { onFail("a->dynamicPrimitiveTopologyUnrestricted (Error: Value not equal)"); };
}

void checkEqual_VkColorBlendEquationEXT(
    const VkColorBlendEquationEXT* a,
...
void checkEqual_VkColorBlendAdvancedEXT(
    const VkColorBlendAdvancedEXT* a,
    const VkColorBlendAdvancedEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->advancedBlendOp) == (b->advancedBlendOp))) { onFail("a->advancedBlendOp (Error: Value not equal)"); };
    if (!((a->srcPremultiplied) == (b->srcPremultiplied))) { onFail("a->srcPremultiplied (Error: Value not equal)"); };
    if (!((a->dstPremultiplied) == (b->dstPremultiplied))) { onFail("a->dstPremultiplied (Error: Value not equal)"); };
    if (!((a->blendOverlap) == (b->blendOverlap))) { onFail("a->blendOverlap (Error: Value not equal)"); };
    if (!((a->clampResults) == (b->clampResults))) { onFail("a->clampResults (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(
    ...
    const VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->subpassMergeFeedback) == (b->subpassMergeFeedback))) { onFail("a->subpassMergeFeedback (Error: Value not equal)"); };
}

void checkEqual_VkRenderPassCreationControlEXT(
    const VkRenderPassCreationControlEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->disallowMerging) == (b->disallowMerging))) { onFail("a->disallowMerging (Error: Value not equal)"); };
}

void checkEqual_VkRenderPassCreationFeedbackInfoEXT(
    const VkRenderPassCreationFeedbackInfoEXT* a,
    const VkRenderPassCreationFeedbackInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->postMergeSubpassCount) == (b->postMergeSubpassCount))) { onFail("a->postMergeSubpassCount (Error: Value not equal)"); };
}

void checkEqual_VkRenderPassCreationFeedbackCreateInfoEXT(
    const VkRenderPassCreationFeedbackCreateInfoEXT* a,
    const VkRenderPassCreationFeedbackCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    {
        checkEqual_VkRenderPassCreationFeedbackInfoEXT(a->pRenderPassFeedback, b->pRenderPassFeedback, onFail);
    }
}

void checkEqual_VkRenderPassSubpassFeedbackInfoEXT(
    const VkRenderPassSubpassFeedbackInfoEXT* a,
    const VkRenderPassSubpassFeedbackInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->subpassMergeStatus) == (b->subpassMergeStatus))) { onFail("a->subpassMergeStatus (Error: Value not equal)"); };
    if (!((memcmp(a->description, b->description, VK_MAX_DESCRIPTION_SIZE * sizeof(char)) == 0))) { onFail("a->description (Error: Unequal static array)"); };
    if (!((a->postMergeIndex) == (b->postMergeIndex))) { onFail("a->postMergeIndex (Error: Value not equal)"); };
}

void checkEqual_VkRenderPassSubpassFeedbackCreateInfoEXT(
    const VkRenderPassSubpassFeedbackCreateInfoEXT* a,
    const VkRenderPassSubpassFeedbackCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    {
        checkEqual_VkRenderPassSubpassFeedbackInfoEXT(a->pSubpassFeedback, b->pSubpassFeedback, onFail);
    }
}

#endif
#ifdef VK_LUNARG_direct_driver_loading
void checkEqual_VkDirectDriverLoadingInfoLUNARG(
    const VkDirectDriverLoadingInfoLUNARG* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->pfnGetInstanceProcAddr) == (b->pfnGetInstanceProcAddr))) { onFail("a->pfnGetInstanceProcAddr (Error: Value not equal)"); };
}

void checkEqual_VkDirectDriverLoadingListLUNARG(
    const VkDirectDriverLoadingListLUNARG* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->mode) == (b->mode))) { onFail("a->mode (Error: Value not equal)"); };
    if (!((a->driverCount) == (b->driverCount))) { onFail("a->driverCount (Error: Value not equal)"); };
    if ((a->pDrivers) && (b->pDrivers))
    {
        if (!((a->driverCount) == (b->driverCount))) { onFail("a->pDrivers (Error: Lengths not equal)"); };
        if ((a->driverCount) == (b->driverCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkDirectDriverLoadingInfoLUNARG(a->pDrivers + i, b->pDrivers + i, onFail);
                }
            }
        }
    }
...
void checkEqual_VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT(
    ...
    const VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderModuleIdentifier) == (b->shaderModuleIdentifier))) { onFail("a->shaderModuleIdentifier (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT(
    ...
    const VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((memcmp(a->shaderModuleIdentifierAlgorithmUUID, b->shaderModuleIdentifierAlgorithmUUID, VK_UUID_SIZE * sizeof(uint8_t)) == 0))) { onFail("a->shaderModuleIdentifierAlgorithmUUID (Error: Unequal static array)"); };
}
...
void checkEqual_VkPipelineShaderStageModuleIdentifierCreateInfoEXT(
    ...
    const VkPipelineShaderStageModuleIdentifierCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->identifierSize) == (b->identifierSize))) { onFail("a->identifierSize (Error: Value not equal)"); };
    if (!((a->identifierSize) == (b->identifierSize))) { onFail("a->pIdentifier (Error: Lengths not equal)"); };
    if (!((memcmp(a->pIdentifier, b->pIdentifier, a->identifierSize * sizeof(const uint8_t)) == 0))) { onFail("a->pIdentifier (Error: Unequal dyn array)"); };
}

void checkEqual_VkShaderModuleIdentifierEXT(
    const VkShaderModuleIdentifierEXT* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->identifierSize) == (b->identifierSize))) { onFail("a->identifierSize (Error: Value not equal)"); };
    if (!((memcmp(a->identifier, b->identifier, VK_MAX_SHADER_MODULE_IDENTIFIER_SIZE_EXT * sizeof(uint8_t)) == 0))) { onFail("a->identifier (Error: Unequal static array)"); };
}
...
void checkEqual_VkPhysicalDeviceOpticalFlowFeaturesNV(
    const VkPhysicalDeviceOpticalFlowFeaturesNV* a,
    const VkPhysicalDeviceOpticalFlowFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->opticalFlow) == (b->opticalFlow))) { onFail("a->opticalFlow (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceOpticalFlowPropertiesNV(
    const VkPhysicalDeviceOpticalFlowPropertiesNV* a,
    const VkPhysicalDeviceOpticalFlowPropertiesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->supportedOutputGridSizes) == (b->supportedOutputGridSizes))) { onFail("a->supportedOutputGridSizes (Error: Value not equal)"); };
    if (!((a->supportedHintGridSizes) == (b->supportedHintGridSizes))) { onFail("a->supportedHintGridSizes (Error: Value not equal)"); };
    if (!((a->hintSupported) == (b->hintSupported))) { onFail("a->hintSupported (Error: Value not equal)"); };
    if (!((a->costSupported) == (b->costSupported))) { onFail("a->costSupported (Error: Value not equal)"); };
    if (!((a->bidirectionalFlowSupported) == (b->bidirectionalFlowSupported))) { onFail("a->bidirectionalFlowSupported (Error: Value not equal)"); };
    if (!((a->globalFlowSupported) == (b->globalFlowSupported))) { onFail("a->globalFlowSupported (Error: Value not equal)"); };
    if (!((a->minWidth) == (b->minWidth))) { onFail("a->minWidth (Error: Value not equal)"); };
    if (!((a->minHeight) == (b->minHeight))) { onFail("a->minHeight (Error: Value not equal)"); };
    if (!((a->maxWidth) == (b->maxWidth))) { onFail("a->maxWidth (Error: Value not equal)"); };
    if (!((a->maxHeight) == (b->maxHeight))) { onFail("a->maxHeight (Error: Value not equal)"); };
    if (!((a->maxNumRegionsOfInterest) == (b->maxNumRegionsOfInterest))) { onFail("a->maxNumRegionsOfInterest (Error: Value not equal)"); };
}

void checkEqual_VkOpticalFlowImageFormatInfoNV(
    const VkOpticalFlowImageFormatInfoNV* a,
...
void checkEqual_VkOpticalFlowImageFormatPropertiesNV(
    const VkOpticalFlowImageFormatPropertiesNV* a,
...
void checkEqual_VkOpticalFlowSessionCreateInfoNV(
    const VkOpticalFlowSessionCreateInfoNV* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->height) == (b->height))) { onFail("a->height (Error: Value not equal)"); };
    if (!((a->imageFormat) == (b->imageFormat))) { onFail("a->imageFormat (Error: Value not equal)"); };
    if (!((a->flowVectorFormat) == (b->flowVectorFormat))) { onFail("a->flowVectorFormat (Error: Value not equal)"); };
    if (!((a->costFormat) == (b->costFormat))) { onFail("a->costFormat (Error: Value not equal)"); };
    if (!((a->outputGridSize) == (b->outputGridSize))) { onFail("a->outputGridSize (Error: Value not equal)"); };
    if (!((a->hintGridSize) == (b->hintGridSize))) { onFail("a->hintGridSize (Error: Value not equal)"); };
    if (!((a->performanceLevel) == (b->performanceLevel))) { onFail("a->performanceLevel (Error: Value not equal)"); };
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
}

void checkEqual_VkOpticalFlowSessionCreatePrivateDataInfoNV(
    const VkOpticalFlowSessionCreatePrivateDataInfoNV* a,
    const VkOpticalFlowSessionCreatePrivateDataInfoNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->id) == (b->id))) { onFail("a->id (Error: Value not equal)"); };
    if (!((a->size) == (b->size))) { onFail("a->size (Error: Value not equal)"); };
}

void checkEqual_VkOpticalFlowExecuteInfoNV(
    const VkOpticalFlowExecuteInfoNV* a,
...
void checkEqual_VkPhysicalDeviceLegacyDitheringFeaturesEXT(
    ...
    const VkPhysicalDeviceLegacyDitheringFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->legacyDithering) == (b->legacyDithering))) { onFail("a->legacyDithering (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDevicePipelineProtectedAccessFeaturesEXT(
    ...
    const VkPhysicalDevicePipelineProtectedAccessFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->pipelineProtectedAccess) == (b->pipelineProtectedAccess))) { onFail("a->pipelineProtectedAccess (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceShaderObjectFeaturesEXT(
    ...
    const VkPhysicalDeviceShaderObjectFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderObject) == (b->shaderObject))) { onFail("a->shaderObject (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceShaderObjectPropertiesEXT(
    const VkPhysicalDeviceShaderObjectPropertiesEXT* a,
    const VkPhysicalDeviceShaderObjectPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((memcmp(a->shaderBinaryUUID, b->shaderBinaryUUID, VK_UUID_SIZE * sizeof(uint8_t)) == 0))) { onFail("a->shaderBinaryUUID (Error: Unequal static array)"); };
    if (!((a->shaderBinaryVersion) == (b->shaderBinaryVersion))) { onFail("a->shaderBinaryVersion (Error: Value not equal)"); };
}

void checkEqual_VkShaderCreateInfoEXT(
    const VkShaderCreateInfoEXT* a,
    const VkShaderCreateInfoEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->flags) == (b->flags))) { onFail("a->flags (Error: Value not equal)"); };
    if (!((a->stage) == (b->stage))) { onFail("a->stage (Error: Value not equal)"); };
    if (!((a->nextStage) == (b->nextStage))) { onFail("a->nextStage (Error: Value not equal)"); };
    if (!((a->codeType) == (b->codeType))) { onFail("a->codeType (Error: Value not equal)"); };
    if (!((a->codeSize) == (b->codeSize))) { onFail("a->codeSize (Error: Value not equal)"); };
    if (!((!(a->pName) && !(b->pName)) || ((a->pName) && (b->pName)))) { onFail("a->pName (Error: Mismatch in optional field)"); };
    if (a->pName && b->pName)
    {
    ...
    if (!((a->pushConstantRangeCount) == (b->pushConstantRangeCount))) { onFail("a->pushConstantRangeCount (Error: Value not equal)"); };
    if (!((!(a->pPushConstantRanges) && !(b->pPushConstantRanges)) || ((a->pPushConstantRanges) && (b->pPushConstantRanges)))) { onFail("a->pPushConstantRanges (Error: Mismatch in optional field)"); };
    if (a->pPushConstantRanges && b->pPushConstantRanges)
    {
        if ((a->pPushConstantRanges) && (b->pPushConstantRanges))
        {
...
void checkEqual_VkPhysicalDeviceTilePropertiesFeaturesQCOM(
    ...
    const VkPhysicalDeviceTilePropertiesFeaturesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->tileProperties) == (b->tileProperties))) { onFail("a->tileProperties (Error: Value not equal)"); };
}

void checkEqual_VkTilePropertiesQCOM(
    const VkTilePropertiesQCOM* a,
    const VkTilePropertiesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
...
void checkEqual_VkPhysicalDeviceAmigoProfilingFeaturesSEC(
    ...
    const VkPhysicalDeviceAmigoProfilingFeaturesSEC* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->amigoProfiling) == (b->amigoProfiling))) { onFail("a->amigoProfiling (Error: Value not equal)"); };
}

void checkEqual_VkAmigoProfilingSubmitInfoSEC(
    const VkAmigoProfilingSubmitInfoSEC* a,
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->firstDrawTimestamp) == (b->firstDrawTimestamp))) { onFail("a->firstDrawTimestamp (Error: Value not equal)"); };
    if (!((a->swapBufferTimestamp) == (b->swapBufferTimestamp))) { onFail("a->swapBufferTimestamp (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM(
    ...
    const VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->multiviewPerViewViewports) == (b->multiviewPerViewViewports))) { onFail("a->multiviewPerViewViewports (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(
    ...
    const VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->rayTracingInvocationReorderReorderingHint) == (b->rayTracingInvocationReorderReorderingHint))) { onFail("a->rayTracingInvocationReorderReorderingHint (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV(
    ...
    const VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->rayTracingInvocationReorder) == (b->rayTracingInvocationReorder))) { onFail("a->rayTracingInvocationReorder (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM(
    ...
    const VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderCoreBuiltins) == (b->shaderCoreBuiltins))) { onFail("a->shaderCoreBuiltins (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM(
    const VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM* a,
    const VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->shaderCoreMask) == (b->shaderCoreMask))) { onFail("a->shaderCoreMask (Error: Value not equal)"); };
    if (!((a->shaderCoreCount) == (b->shaderCoreCount))) { onFail("a->shaderCoreCount (Error: Value not equal)"); };
    if (!((a->shaderWarpsPerCore) == (b->shaderWarpsPerCore))) { onFail("a->shaderWarpsPerCore (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT(
    ...
    const VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->pipelineLibraryGroupHandles) == (b->pipelineLibraryGroupHandles))) { onFail("a->pipelineLibraryGroupHandles (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(
    ...
    const VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->multiviewPerViewRenderAreas) == (b->multiviewPerViewRenderAreas))) { onFail("a->multiviewPerViewRenderAreas (Error: Value not equal)"); };
}
...
void checkEqual_VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM(
    ...
    const VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->perViewRenderAreaCount) == (b->perViewRenderAreaCount))) { onFail("a->perViewRenderAreaCount (Error: Value not equal)"); };
    if ((a->pPerViewRenderAreas) && (b->pPerViewRenderAreas))
    {
        if (!((a->perViewRenderAreaCount) == (b->perViewRenderAreaCount))) { onFail("a->pPerViewRenderAreas (Error: Lengths not equal)"); };
        if ((a->perViewRenderAreaCount) == (b->perViewRenderAreaCount))
        {
            if (a)
            {
                ...
                {
                    checkEqual_VkRect2D(a->pPerViewRenderAreas + i, b->pPerViewRenderAreas + i, onFail);
                }
            }
        }
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->attachmentFeedbackLoopDynamicState) == (b->attachmentFeedbackLoopDynamicState))) { onFail("a->attachmentFeedbackLoopDynamicState (Error: Value not equal)"); };
}
...
void checkEqual_VkPhysicalDeviceMeshShaderFeaturesEXT(
    const VkPhysicalDeviceMeshShaderFeaturesEXT* a,
    const VkPhysicalDeviceMeshShaderFeaturesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->taskShader) == (b->taskShader))) { onFail("a->taskShader (Error: Value not equal)"); };
    if (!((a->meshShader) == (b->meshShader))) { onFail("a->meshShader (Error: Value not equal)"); };
    if (!((a->multiviewMeshShader) == (b->multiviewMeshShader))) { onFail("a->multiviewMeshShader (Error: Value not equal)"); };
    if (!((a->primitiveFragmentShadingRateMeshShader) == (b->primitiveFragmentShadingRateMeshShader))) { onFail("a->primitiveFragmentShadingRateMeshShader (Error: Value not equal)"); };
    if (!((a->meshShaderQueries) == (b->meshShaderQueries))) { onFail("a->meshShaderQueries (Error: Value not equal)"); };
}

void checkEqual_VkPhysicalDeviceMeshShaderPropertiesEXT(
    const VkPhysicalDeviceMeshShaderPropertiesEXT* a,
    const VkPhysicalDeviceMeshShaderPropertiesEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) { onFail("a->sType (Error: Value not equal)"); };
    if (a->pNext)
    ...
    if (!((a->maxTaskWorkGroupTotalCount) == (b->maxTaskWorkGroupTotalCount))) { onFail("a->maxTaskWorkGroupTotalCount (Error: Value not equal)"); };
    if (!((memcmp(a->maxTaskWorkGroupCount, b->maxTaskWorkGroupCount, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxTaskWorkGroupCount (Error: Unequal static array)"); };
    if (!((a->maxTaskWorkGroupInvocations) == (b->maxTaskWorkGroupInvocations))) { onFail("a->maxTaskWorkGroupInvocations (Error: Value not equal)"); };
    if (!((memcmp(a->maxTaskWorkGroupSize, b->maxTaskWorkGroupSize, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxTaskWorkGroupSize (Error: Unequal static array)"); };
    if (!((a->maxTaskPayloadSize) == (b->maxTaskPayloadSize))) { onFail("a->maxTaskPayloadSize (Error: Value not equal)"); };
    if (!((a->maxTaskSharedMemorySize) == (b->maxTaskSharedMemorySize))) { onFail("a->maxTaskSharedMemorySize (Error: Value not equal)"); };
    if (!((a->maxTaskPayloadAndSharedMemorySize) == (b->maxTaskPayloadAndSharedMemorySize))) { onFail("a->maxTaskPayloadAndSharedMemorySize (Error: Value not equal)"); };
    if (!((a->maxMeshWorkGroupTotalCount) == (b->maxMeshWorkGroupTotalCount))) { onFail("a->maxMeshWorkGroupTotalCount (Error: Value not equal)"); };
    if (!((memcmp(a->maxMeshWorkGroupCount, b->maxMeshWorkGroupCount, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxMeshWorkGroupCount (Error: Unequal static array)"); };
    if (!((a->maxMeshWorkGroupInvocations) == (b->maxMeshWorkGroupInvocations))) { onFail("a->maxMeshWorkGroupInvocations (Error: Value not equal)"); };
    if (!((memcmp(a->maxMeshWorkGroupSize, b->maxMeshWorkGroupSize, 3 * sizeof(uint32_t)) == 0))) { onFail("a->maxMeshWorkGroupSize (Error: Unequal static array)"); };
    if (!((a->maxMeshSharedMemorySize) == (b->maxMeshSharedMemorySize))) { onFail("a->maxMeshSharedMemorySize (Error: Value not equal)"); };
    if (!((a->maxMeshPayloadAndSharedMemorySize) == (b->maxMeshPayloadAndSharedMemorySize))) { onFail("a->maxMeshPayloadAndSharedMemorySize (Error: Value not equal)"); };
    if (!((a->maxMeshOutputMemorySize) == (b->maxMeshOutputMemorySize))) { onFail("a->maxMeshOutputMemorySize (Error: Value not equal)"); };
    if (!((a->maxMeshPayloadAndOutputMemorySize) == (b->maxMeshPayloadAndOutputMemorySize))) { onFail("a->maxMeshPayloadAndOutputMemorySize (Error: Value not equal)"); };
    if (!((a->maxMeshOutputComponents) == (b->maxMeshOutputComponents))) { onFail("a->maxMeshOutputComponents (Error: Value not equal)"); };
    if (!((a->maxMeshOutputVertices) == (b->maxMeshOutputVertices))) { onFail("a->maxMeshOutputVertices (Error: Value not equal)"); };
    if (!((a->maxMeshOutputPrimitives) == (b->maxMeshOutputPrimitives))) { onFail("a->maxMeshOutputPrimitives (Error: Value not equal)"); };
    if (!((a->maxMeshOutputLayers) == (b->maxMeshOutputLayers))) { onFail("a->maxMeshOutputLayers (Error: Value not equal)"); };
    if (!((a->maxMeshMultiviewViewCount) == (b->maxMeshMultiviewViewCount))) { onFail("a->maxMeshMultiviewViewCount (Error: Value not equal)"); };
    if (!((a->meshOutputPerVertexGranularity) == (b->meshOutputPerVertexGranularity))) { onFail("a->meshOutputPerVertexGranularity (Error: Value not equal)"); };
    if (!((a->meshOutputPerPrimitiveGranularity) == (b->meshOutputPerPrimitiveGranularity))) { onFail("a->meshOutputPerPrimitiveGranularity (Error: Value not equal)"); };
    if (!((a->maxPreferredTaskWorkGroupInvocations) == (b->maxPreferredTaskWorkGroupInvocations))) { onFail("a->maxPreferredTaskWorkGroupInvocations (Error: Value not equal)"); };
    if (!((a->maxPreferredMeshWorkGroupInvocations) == (b->maxPreferredMeshWorkGroupInvocations))) { onFail("a->maxPreferredMeshWorkGroupInvocations (Error: Value not equal)"); };
    if (!((a->prefersLocalInvocationVertexOutput) == (b->prefersLocalInvocationVertexOutput))) { onFail("a->prefersLocalInvocationVertexOutput (Error: Value not equal)"); };
    if (!((a->prefersLocalInvocationPrimitiveOutput) == (b->prefersLocalInvocationPrimitiveOutput))) { onFail("a->prefersLocalInvocationPrimitiveOutput (Error: Value not equal)"); };
    if (!((a->prefersCompactVertexOutput) == (b->prefersCompactVertexOutput))) { onFail("a->prefersCompactVertexOutput (Error: Value not equal)"); };
    if (!((a->prefersCompactPrimitiveOutput) == (b->prefersCompactPrimitiveOutput))) { onFail("a->prefersCompactPrimitiveOutput (Error: Value not equal)"); };
}

void checkEqual_VkDrawMeshTasksIndirectCommandEXT(
    const VkDrawMeshTasksIndirectCommandEXT* a,
    const VkDrawMeshTasksIndirectCommandEXT* b,
    OnFailCompareFunc onFail)
{
    if (!((a->groupCountX) == (b->groupCountX))) { onFail("a->groupCountX (Error: Value not equal)"); };
    if (!((a->groupCountY) == (b->groupCountY))) { onFail("a->groupCountY (Error: Value not equal)"); };
    if (!((a->groupCountZ) == (b->groupCountZ))) { onFail("a->groupCountZ (Error: Value not equal)"); };
}
