...
REGISTER_VK_STRUCT_ID(VkExportMetalObjectCreateInfoEXT, VK_STRUCTURE_TYPE_EXPORT_METAL_OBJECT_CREATE_INFO_EXT);
REGISTER_VK_STRUCT_ID(VkExportMetalTextureInfoEXT, VK_STRUCTURE_TYPE_EXPORT_METAL_TEXTURE_INFO_EXT);
REGISTER_VK_STRUCT_ID(VkExportMetalBufferInfoEXT, VK_STRUCTURE_TYPE_EXPORT_METAL_TEXTURE_INFO_EXT);
