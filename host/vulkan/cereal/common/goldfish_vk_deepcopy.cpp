    ...
    VkPipelineCreationFeedbackCreateInfo* to)
{
    ...
    *to = *from;
    ...
    {
        to->pPipelineCreationFeedback = (VkPipelineCreationFeedback*)alloc->alloc(sizeof(VkPipelineCreationFeedback));
        deepcopy_VkPipelineCreationFeedback(alloc, rootType, from->pPipelineCreationFeedback, (VkPipelineCreationFeedback*)(to->pPipelineCreationFeedback));
    }
    if (from)
    {
        ...
        {
            to->pPipelineStageCreationFeedbacks = (VkPipelineCreationFeedback*)alloc->alloc(from->pipelineStageCreationFeedbackCount * sizeof(VkPipelineCreationFeedback));
            ...
            {
                deepcopy_VkPipelineCreationFeedback(alloc, rootType, from->pPipelineStageCreationFeedbacks + i, (VkPipelineCreationFeedback*)(to->pPipelineStageCreationFeedbacks + i));
            }
        }
    }
}
    ...
    VkDependencyInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pMemoryBarriers = (VkMemoryBarrier2*)alloc->alloc(from->memoryBarrierCount * sizeof(const VkMemoryBarrier2));
            to->memoryBarrierCount = from->memoryBarrierCount;
            for (uint32_t i = 0; i < (uint32_t)from->memoryBarrierCount; ++i)
            {
                deepcopy_VkMemoryBarrier2(alloc, rootType, from->pMemoryBarriers + i, (VkMemoryBarrier2*)(to->pMemoryBarriers + i));
            }
        }
    }
    if (from)
    {
        ...
        {
            to->pBufferMemoryBarriers = (VkBufferMemoryBarrier2*)alloc->alloc(from->bufferMemoryBarrierCount * sizeof(const VkBufferMemoryBarrier2));
            to->bufferMemoryBarrierCount = from->bufferMemoryBarrierCount;
            for (uint32_t i = 0; i < (uint32_t)from->bufferMemoryBarrierCount; ++i)
            {
                deepcopy_VkBufferMemoryBarrier2(alloc, rootType, from->pBufferMemoryBarriers + i, (VkBufferMemoryBarrier2*)(to->pBufferMemoryBarriers + i));
            }
        }
    }
    if (from)
    {
        ...
        {
            to->pImageMemoryBarriers = (VkImageMemoryBarrier2*)alloc->alloc(from->imageMemoryBarrierCount * sizeof(const VkImageMemoryBarrier2));
            to->imageMemoryBarrierCount = from->imageMemoryBarrierCount;
            for (uint32_t i = 0; i < (uint32_t)from->imageMemoryBarrierCount; ++i)
            {
                deepcopy_VkImageMemoryBarrier2(alloc, rootType, from->pImageMemoryBarriers + i, (VkImageMemoryBarrier2*)(to->pImageMemoryBarriers + i));
            }
        }
    }
}
    ...
    VkSubmitInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pWaitSemaphoreInfos = (VkSemaphoreSubmitInfo*)alloc->alloc(from->waitSemaphoreInfoCount * sizeof(const VkSemaphoreSubmitInfo));
            to->waitSemaphoreInfoCount = from->waitSemaphoreInfoCount;
            for (uint32_t i = 0; i < (uint32_t)from->waitSemaphoreInfoCount; ++i)
            {
                deepcopy_VkSemaphoreSubmitInfo(alloc, rootType, from->pWaitSemaphoreInfos + i, (VkSemaphoreSubmitInfo*)(to->pWaitSemaphoreInfos + i));
            }
        }
    }
    if (from)
    {
        ...
        {
            to->pCommandBufferInfos = (VkCommandBufferSubmitInfo*)alloc->alloc(from->commandBufferInfoCount * sizeof(const VkCommandBufferSubmitInfo));
            to->commandBufferInfoCount = from->commandBufferInfoCount;
            for (uint32_t i = 0; i < (uint32_t)from->commandBufferInfoCount; ++i)
            {
                deepcopy_VkCommandBufferSubmitInfo(alloc, rootType, from->pCommandBufferInfos + i, (VkCommandBufferSubmitInfo*)(to->pCommandBufferInfos + i));
            }
        }
    }
    if (from)
    {
        ...
        {
            to->pSignalSemaphoreInfos = (VkSemaphoreSubmitInfo*)alloc->alloc(from->signalSemaphoreInfoCount * sizeof(const VkSemaphoreSubmitInfo));
            to->signalSemaphoreInfoCount = from->signalSemaphoreInfoCount;
            for (uint32_t i = 0; i < (uint32_t)from->signalSemaphoreInfoCount; ++i)
            {
                deepcopy_VkSemaphoreSubmitInfo(alloc, rootType, from->pSignalSemaphoreInfos + i, (VkSemaphoreSubmitInfo*)(to->pSignalSemaphoreInfos + i));
            }
        }
    }
}
    ...
    VkCopyBufferInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkBufferCopy2*)alloc->alloc(from->regionCount * sizeof(const VkBufferCopy2));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkBufferCopy2(alloc, rootType, from->pRegions + i, (VkBufferCopy2*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkCopyImageInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkImageCopy2*)alloc->alloc(from->regionCount * sizeof(const VkImageCopy2));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkImageCopy2(alloc, rootType, from->pRegions + i, (VkImageCopy2*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkCopyBufferToImageInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkBufferImageCopy2*)alloc->alloc(from->regionCount * sizeof(const VkBufferImageCopy2));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkBufferImageCopy2(alloc, rootType, from->pRegions + i, (VkBufferImageCopy2*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkBlitImageInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkImageBlit2*)alloc->alloc(from->regionCount * sizeof(const VkImageBlit2));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkImageBlit2(alloc, rootType, from->pRegions + i, (VkImageBlit2*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkResolveImageInfo2* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkImageResolve2*)alloc->alloc(from->regionCount * sizeof(const VkImageResolve2));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkImageResolve2(alloc, rootType, from->pRegions + i, (VkImageResolve2*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkRenderingInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pColorAttachments)
        {
            to->pColorAttachments = (VkRenderingAttachmentInfo*)alloc->alloc(from->colorAttachmentCount * sizeof(const VkRenderingAttachmentInfo));
            to->colorAttachmentCount = from->colorAttachmentCount;
            for (uint32_t i = 0; i < (uint32_t)from->colorAttachmentCount; ++i)
            {
                deepcopy_VkRenderingAttachmentInfo(alloc, rootType, from->pColorAttachments + i, (VkRenderingAttachmentInfo*)(to->pColorAttachments + i));
            }
        }
    }
    ...
    {
        to->pDepthAttachment = (VkRenderingAttachmentInfo*)alloc->alloc(sizeof(const VkRenderingAttachmentInfo));
        deepcopy_VkRenderingAttachmentInfo(alloc, rootType, from->pDepthAttachment, (VkRenderingAttachmentInfo*)(to->pDepthAttachment));
    }
    to->pStencilAttachment = nullptr;
    if (from->pStencilAttachment)
    {
        to->pStencilAttachment = (VkRenderingAttachmentInfo*)alloc->alloc(sizeof(const VkRenderingAttachmentInfo));
        deepcopy_VkRenderingAttachmentInfo(alloc, rootType, from->pStencilAttachment, (VkRenderingAttachmentInfo*)(to->pStencilAttachment));
    }
}
...
void deepcopy_VkQueueFamilyVideoPropertiesKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoProfileInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    const VkVideoProfileInfoKHR* from,
    VkVideoProfileInfoKHR* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkVideoProfileListInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoProfileListInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pProfiles)
        {
            to->pProfiles = (VkVideoProfileInfoKHR*)alloc->alloc(from->profileCount * sizeof(const VkVideoProfileInfoKHR));
            to->profileCount = from->profileCount;
            for (uint32_t i = 0; i < (uint32_t)from->profileCount; ++i)
            {
                deepcopy_VkVideoProfileInfoKHR(alloc, rootType, from->pProfiles + i, (VkVideoProfileInfoKHR*)(to->pProfiles + i));
            }
        }
    }
}
    ...
    VkVideoCapabilitiesKHR* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkExtent2D(alloc, rootType, &from->pictureAccessGranularity, (VkExtent2D*)(&to->pictureAccessGranularity));
    ...
    deepcopy_VkExtensionProperties(alloc, rootType, &from->stdHeaderVersion, (VkExtensionProperties*)(&to->stdHeaderVersion));
}
    ...
    VkVideoFormatPropertiesKHR* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkComponentMapping(alloc, rootType, &from->componentMapping, (VkComponentMapping*)(&to->componentMapping));
}

void deepcopy_VkVideoPictureResourceInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoReferenceSlotInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoReferenceSlotInfoKHR* to)
{
    ...
    *to = *from;
    ...
    {
        to->pPictureResource = (VkVideoPictureResourceInfoKHR*)alloc->alloc(sizeof(const VkVideoPictureResourceInfoKHR));
        deepcopy_VkVideoPictureResourceInfoKHR(alloc, rootType, from->pPictureResource, (VkVideoPictureResourceInfoKHR*)(to->pPictureResource));
    }
}

void deepcopy_VkVideoSessionMemoryRequirementsKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkBindVideoSessionMemoryInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoSessionCreateInfoKHR* to)
{
    ...
    *to = *from;
    ...
    {
        to->pVideoProfile = (VkVideoProfileInfoKHR*)alloc->alloc(sizeof(const VkVideoProfileInfoKHR));
        deepcopy_VkVideoProfileInfoKHR(alloc, rootType, from->pVideoProfile, (VkVideoProfileInfoKHR*)(to->pVideoProfile));
    }
    deepcopy_VkExtent2D(alloc, rootType, &from->maxCodedExtent, (VkExtent2D*)(&to->maxCodedExtent));
    to->pStdHeaderVersion = nullptr;
    if (from->pStdHeaderVersion)
    {
        to->pStdHeaderVersion = (VkExtensionProperties*)alloc->alloc(sizeof(const VkExtensionProperties));
        deepcopy_VkExtensionProperties(alloc, rootType, from->pStdHeaderVersion, (VkExtensionProperties*)(to->pStdHeaderVersion));
    }
}
    ...
    VkVideoBeginCodingInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pReferenceSlots = (VkVideoReferenceSlotInfoKHR*)alloc->alloc(from->referenceSlotCount * sizeof(const VkVideoReferenceSlotInfoKHR));
            to->referenceSlotCount = from->referenceSlotCount;
            for (uint32_t i = 0; i < (uint32_t)from->referenceSlotCount; ++i)
            {
                deepcopy_VkVideoReferenceSlotInfoKHR(alloc, rootType, from->pReferenceSlots + i, (VkVideoReferenceSlotInfoKHR*)(to->pReferenceSlots + i));
            }
        }
    }
}
...
void deepcopy_VkVideoDecodeCapabilitiesKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoDecodeUsageInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoDecodeInfoKHR* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkVideoPictureResourceInfoKHR(alloc, rootType, &from->dstPictureResource, (VkVideoPictureResourceInfoKHR*)(&to->dstPictureResource));
    to->pSetupReferenceSlot = nullptr;
    if (from->pSetupReferenceSlot)
    {
        to->pSetupReferenceSlot = (VkVideoReferenceSlotInfoKHR*)alloc->alloc(sizeof(const VkVideoReferenceSlotInfoKHR));
        deepcopy_VkVideoReferenceSlotInfoKHR(alloc, rootType, from->pSetupReferenceSlot, (VkVideoReferenceSlotInfoKHR*)(to->pSetupReferenceSlot));
    }
    if (from)
    {
        to->pReferenceSlots = nullptr;
...
void deepcopy_VkVideoDecodeH264ProfileInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoDecodeH264CapabilitiesKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoDecodeH264SessionParametersAddInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from->pStdSPSs)
    {
        to->pStdSPSs = (StdVideoH264SequenceParameterSet*)alloc->dupArray(from->pStdSPSs, from->stdSPSCount * sizeof(const StdVideoH264SequenceParameterSet));
    }
    to->pStdPPSs = nullptr;
    if (from->pStdPPSs)
    {
        to->pStdPPSs = (StdVideoH264PictureParameterSet*)alloc->dupArray(from->pStdPPSs, from->stdPPSCount * sizeof(const StdVideoH264PictureParameterSet));
    }
}
    ...
    VkVideoDecodeH264SessionParametersCreateInfoKHR* to)
{
    ...
    *to = *from;
    ...
    {
        to->pParametersAddInfo = (VkVideoDecodeH264SessionParametersAddInfoKHR*)alloc->alloc(sizeof(const VkVideoDecodeH264SessionParametersAddInfoKHR));
        deepcopy_VkVideoDecodeH264SessionParametersAddInfoKHR(alloc, rootType, from->pParametersAddInfo, (VkVideoDecodeH264SessionParametersAddInfoKHR*)(to->pParametersAddInfo));
    }
}

void deepcopy_VkVideoDecodeH264PictureInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoDecodeH264PictureInfoKHR* to)
{
    ...
    *to = *from;
    ...
    {
        to->pSliceOffsets = (uint32_t*)alloc->dupArray(from->pSliceOffsets, from->sliceCount * sizeof(const uint32_t));
    }
}

void deepcopy_VkVideoDecodeH264DpbSlotInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoDecodeH265ProfileInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoDecodeH265CapabilitiesKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoDecodeH265SessionParametersAddInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from->pStdVPSs)
    {
        to->pStdVPSs = (StdVideoH265VideoParameterSet*)alloc->dupArray(from->pStdVPSs, from->stdVPSCount * sizeof(const StdVideoH265VideoParameterSet));
    }
    to->pStdSPSs = nullptr;
    if (from->pStdSPSs)
    {
        to->pStdSPSs = (StdVideoH265SequenceParameterSet*)alloc->dupArray(from->pStdSPSs, from->stdSPSCount * sizeof(const StdVideoH265SequenceParameterSet));
    }
    to->pStdPPSs = nullptr;
    if (from->pStdPPSs)
    {
        to->pStdPPSs = (StdVideoH265PictureParameterSet*)alloc->dupArray(from->pStdPPSs, from->stdPPSCount * sizeof(const StdVideoH265PictureParameterSet));
    }
}
    ...
    VkVideoDecodeH265SessionParametersCreateInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from->pParametersAddInfo)
    {
        to->pParametersAddInfo = (VkVideoDecodeH265SessionParametersAddInfoKHR*)alloc->alloc(sizeof(const VkVideoDecodeH265SessionParametersAddInfoKHR));
        deepcopy_VkVideoDecodeH265SessionParametersAddInfoKHR(alloc, rootType, from->pParametersAddInfo, (VkVideoDecodeH265SessionParametersAddInfoKHR*)(to->pParametersAddInfo));
    }
}

void deepcopy_VkVideoDecodeH265PictureInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoDecodeH265PictureInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from->pStdPictureInfo)
    {
        to->pStdPictureInfo = (StdVideoDecodeH265PictureInfo*)alloc->dupArray(from->pStdPictureInfo, sizeof(const StdVideoDecodeH265PictureInfo));
    }
    to->pSliceSegmentOffsets = nullptr;
    if (from->pSliceSegmentOffsets)
    {
        to->pSliceSegmentOffsets = (uint32_t*)alloc->dupArray(from->pSliceSegmentOffsets, from->sliceSegmentCount * sizeof(const uint32_t));
    }
}

void deepcopy_VkVideoDecodeH265DpbSlotInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkQueueFamilyGlobalPriorityPropertiesKHR* to)
{
    ...
    *to = *from;
    ...
    memcpy(to->priorities, from->priorities, VK_MAX_GLOBAL_PRIORITY_SIZE_KHR * sizeof(VkQueueGlobalPriorityKHR));
}
...
void deepcopy_VkMemoryMapInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    const VkMemoryMapInfoKHR* from,
    VkMemoryMapInfoKHR* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkMemoryUnmapInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    const VkMemoryUnmapInfoKHR* from,
    VkMemoryUnmapInfoKHR* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
    ...
    VkVideoEncodeInfoKHR* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkVideoPictureResourceInfoKHR(alloc, rootType, &from->srcPictureResource, (VkVideoPictureResourceInfoKHR*)(&to->srcPictureResource));
    to->pSetupReferenceSlot = nullptr;
    if (from->pSetupReferenceSlot)
    {
        to->pSetupReferenceSlot = (VkVideoReferenceSlotInfoKHR*)alloc->alloc(sizeof(const VkVideoReferenceSlotInfoKHR));
...
void deepcopy_VkVideoEncodeCapabilitiesKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoEncodeCapabilitiesKHR* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkExtent2D(alloc, rootType, &from->inputImageDataFillAlignment, (VkExtent2D*)(&to->inputImageDataFillAlignment));
}
...
void deepcopy_VkVideoEncodeUsageInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeRateControlLayerInfoKHR(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoEncodeRateControlInfoKHR* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pLayers)
        {
            to->pLayers = (VkVideoEncodeRateControlLayerInfoKHR*)alloc->alloc(from->layerCount * sizeof(const VkVideoEncodeRateControlLayerInfoKHR));
            to->layerCount = from->layerCount;
            for (uint32_t i = 0; i < (uint32_t)from->layerCount; ++i)
            {
                deepcopy_VkVideoEncodeRateControlLayerInfoKHR(alloc, rootType, from->pLayers + i, (VkVideoEncodeRateControlLayerInfoKHR*)(to->pLayers + i));
            }
        }
    }
}
...
void deepcopy_VkTraceRaysIndirectCommand2KHR(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH264NaluSliceInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoEncodeH264NaluSliceInfoEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pStdReferenceFinalLists = (StdVideoEncodeH264ReferenceListsInfo*)alloc->dupArray(from->pStdReferenceFinalLists, sizeof(const StdVideoEncodeH264ReferenceListsInfo));
    }
    to->pStdSliceHeader = nullptr;
    if (from->pStdSliceHeader)
    {
        to->pStdSliceHeader = (StdVideoEncodeH264SliceHeader*)alloc->dupArray(from->pStdSliceHeader, sizeof(const StdVideoEncodeH264SliceHeader));
    }
}
    ...
    VkVideoEncodeH264VclFrameInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pNaluSliceEntries = (VkVideoEncodeH264NaluSliceInfoEXT*)alloc->alloc(from->naluSliceEntryCount * sizeof(const VkVideoEncodeH264NaluSliceInfoEXT));
            to->naluSliceEntryCount = from->naluSliceEntryCount;
            for (uint32_t i = 0; i < (uint32_t)from->naluSliceEntryCount; ++i)
            {
                deepcopy_VkVideoEncodeH264NaluSliceInfoEXT(alloc, rootType, from->pNaluSliceEntries + i, (VkVideoEncodeH264NaluSliceInfoEXT*)(to->pNaluSliceEntries + i));
            }
        }
    }
    to->pStdPictureInfo = nullptr;
    ...
    VkVideoEncodeH264DpbSlotInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pStdReferenceInfo)
    {
        to->pStdReferenceInfo = (StdVideoEncodeH264ReferenceInfo*)alloc->dupArray(from->pStdReferenceInfo, sizeof(const StdVideoEncodeH264ReferenceInfo));
    }
}

void deepcopy_VkVideoEncodeH264ProfileInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH264RateControlInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH264QpEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH264FrameSizeEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoEncodeH264RateControlLayerInfoEXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkVideoEncodeH264QpEXT(alloc, rootType, &from->initialRcQp, (VkVideoEncodeH264QpEXT*)(&to->initialRcQp));
    deepcopy_VkVideoEncodeH264QpEXT(alloc, rootType, &from->minQp, (VkVideoEncodeH264QpEXT*)(&to->minQp));
    deepcopy_VkVideoEncodeH264QpEXT(alloc, rootType, &from->maxQp, (VkVideoEncodeH264QpEXT*)(&to->maxQp));
    deepcopy_VkVideoEncodeH264FrameSizeEXT(alloc, rootType, &from->maxFrameSize, (VkVideoEncodeH264FrameSizeEXT*)(&to->maxFrameSize));
}
    ...
    VkVideoEncodeH265NaluSliceSegmentInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pStdReferenceFinalLists)
    {
        to->pStdReferenceFinalLists = (StdVideoEncodeH265ReferenceListsInfo*)alloc->dupArray(from->pStdReferenceFinalLists, sizeof(const StdVideoEncodeH265ReferenceListsInfo));
    }
    to->pStdSliceSegmentHeader = nullptr;
    if (from->pStdSliceSegmentHeader)
    {
        to->pStdSliceSegmentHeader = (StdVideoEncodeH265SliceSegmentHeader*)alloc->dupArray(from->pStdSliceSegmentHeader, sizeof(const StdVideoEncodeH265SliceSegmentHeader));
    }
}
    ...
    VkVideoEncodeH265VclFrameInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pNaluSliceSegmentEntries = (VkVideoEncodeH265NaluSliceSegmentInfoEXT*)alloc->alloc(from->naluSliceSegmentEntryCount * sizeof(const VkVideoEncodeH265NaluSliceSegmentInfoEXT));
            ...
            {
                deepcopy_VkVideoEncodeH265NaluSliceSegmentInfoEXT(alloc, rootType, from->pNaluSliceSegmentEntries + i, (VkVideoEncodeH265NaluSliceSegmentInfoEXT*)(to->pNaluSliceSegmentEntries + i));
            }
        }
    }
    to->pStdPictureInfo = nullptr;
    if (from->pStdPictureInfo)
    {
        to->pStdPictureInfo = (StdVideoEncodeH265PictureInfo*)alloc->dupArray(from->pStdPictureInfo, sizeof(const StdVideoEncodeH265PictureInfo));
    }
}
...
void deepcopy_VkVideoEncodeH265RateControlInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH265QpEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkVideoEncodeH265FrameSizeEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkVideoEncodeH265RateControlLayerInfoEXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkVideoEncodeH265QpEXT(alloc, rootType, &from->initialRcQp, (VkVideoEncodeH265QpEXT*)(&to->initialRcQp));
    deepcopy_VkVideoEncodeH265QpEXT(alloc, rootType, &from->minQp, (VkVideoEncodeH265QpEXT*)(&to->minQp));
    deepcopy_VkVideoEncodeH265QpEXT(alloc, rootType, &from->maxQp, (VkVideoEncodeH265QpEXT*)(&to->maxQp));
    deepcopy_VkVideoEncodeH265FrameSizeEXT(alloc, rootType, &from->maxFrameSize, (VkVideoEncodeH265FrameSizeEXT*)(&to->maxFrameSize));
}
...
void deepcopy_VkPipelineRobustnessCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkDebugUtilsMessengerCallbackDataEXT* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pQueueLabels = (VkDebugUtilsLabelEXT*)alloc->alloc(from->queueLabelCount * sizeof(const VkDebugUtilsLabelEXT));
    ...
    if (from)
    {
        ...
        {
            to->pCmdBufLabels = (VkDebugUtilsLabelEXT*)alloc->alloc(from->cmdBufLabelCount * sizeof(const VkDebugUtilsLabelEXT));
    ...
    if (from)
    {
        ...
        if (from->pObjects)
        {
            to->pObjects = (VkDebugUtilsObjectNameInfoEXT*)alloc->alloc(from->objectCount * sizeof(const VkDebugUtilsObjectNameInfoEXT));
...
void deepcopy_VkSurfacePresentModeEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkSurfacePresentScalingCapabilitiesEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkSurfacePresentScalingCapabilitiesEXT* from,
    VkSurfacePresentScalingCapabilitiesEXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkExtent2D(alloc, rootType, &from->minScaledImageExtent, (VkExtent2D*)(&to->minScaledImageExtent));
    deepcopy_VkExtent2D(alloc, rootType, &from->maxScaledImageExtent, (VkExtent2D*)(&to->maxScaledImageExtent));
}

void deepcopy_VkSurfacePresentModeCompatibilityEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkSurfacePresentModeCompatibilityEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pPresentModes = (VkPresentModeKHR*)alloc->dupArray(from->pPresentModes, from->presentModeCount * sizeof(VkPresentModeKHR));
    }
}
...
void deepcopy_VkSwapchainPresentFenceInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkSwapchainPresentFenceInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pFences)
    {
        to->pFences = (VkFence*)alloc->dupArray(from->pFences, from->swapchainCount * sizeof(const VkFence));
    }
}

void deepcopy_VkSwapchainPresentModesCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkSwapchainPresentModesCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pPresentModes)
    {
        to->pPresentModes = (VkPresentModeKHR*)alloc->dupArray(from->pPresentModes, from->presentModeCount * sizeof(const VkPresentModeKHR));
    }
}
    ...
    VkSwapchainPresentModeInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pPresentModes)
    {
        to->pPresentModes = (VkPresentModeKHR*)alloc->dupArray(from->pPresentModes, from->swapchainCount * sizeof(const VkPresentModeKHR));
    }
}
...
void deepcopy_VkSwapchainPresentScalingCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkSwapchainPresentScalingCreateInfoEXT* from,
...
void deepcopy_VkReleaseSwapchainImagesInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkReleaseSwapchainImagesInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pImageIndices)
    {
        to->pImageIndices = (uint32_t*)alloc->dupArray(from->pImageIndices, from->imageIndexCount * sizeof(const uint32_t));
    }
}
...
void deepcopy_VkSurfaceCapabilitiesPresentBarrierNV(
    Allocator* alloc,
    VkStructureType rootType,
    const VkSurfaceCapabilitiesPresentBarrierNV* from,
...
void deepcopy_VkSwapchainPresentBarrierCreateInfoNV(
    Allocator* alloc,
    VkStructureType rootType,
    const VkSwapchainPresentBarrierCreateInfoNV* from,
...
void deepcopy_VkQueryLowLatencySupportNV(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkQueryLowLatencySupportNV* to)
{
    ...
    *to = *from;
    ...
    {
        to->pQueriedLowLatencyData = (void*)alloc->dupArray(from->pQueriedLowLatencyData, sizeof(uint8_t));
    }
}

#endif
#ifdef VK_EXT_metal_objects
void deepcopy_VkExportMetalObjectCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalObjectsInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalCommandQueueInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalBufferInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImportMetalBufferInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalTextureInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImportMetalTextureInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalIOSurfaceInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImportMetalIOSurfaceInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkExportMetalSharedEventInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImportMetalSharedEventInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDescriptorAddressInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDescriptorBufferBindingInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDescriptorDataEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkDescriptorDataEXT* from,
    VkDescriptorDataEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
    ...
    {
        to->pCombinedImageSampler = (VkDescriptorImageInfo*)alloc->alloc(sizeof(const VkDescriptorImageInfo));
        deepcopy_VkDescriptorImageInfo(alloc, rootType, from->pCombinedImageSampler, (VkDescriptorImageInfo*)(to->pCombinedImageSampler));
    }
    to->pInputAttachmentImage = nullptr;
    if (from->pInputAttachmentImage)
    {
        to->pInputAttachmentImage = (VkDescriptorImageInfo*)alloc->alloc(sizeof(const VkDescriptorImageInfo));
        deepcopy_VkDescriptorImageInfo(alloc, rootType, from->pInputAttachmentImage, (VkDescriptorImageInfo*)(to->pInputAttachmentImage));
    }
    to->pSampledImage = nullptr;
    if (from->pSampledImage)
    {
        to->pSampledImage = (VkDescriptorImageInfo*)alloc->alloc(sizeof(const VkDescriptorImageInfo));
        deepcopy_VkDescriptorImageInfo(alloc, rootType, from->pSampledImage, (VkDescriptorImageInfo*)(to->pSampledImage));
    }
    to->pStorageImage = nullptr;
    if (from->pStorageImage)
    {
        to->pStorageImage = (VkDescriptorImageInfo*)alloc->alloc(sizeof(const VkDescriptorImageInfo));
        deepcopy_VkDescriptorImageInfo(alloc, rootType, from->pStorageImage, (VkDescriptorImageInfo*)(to->pStorageImage));
    }
    to->pUniformTexelBuffer = nullptr;
    if (from->pUniformTexelBuffer)
    {
        to->pUniformTexelBuffer = (VkDescriptorAddressInfoEXT*)alloc->alloc(sizeof(const VkDescriptorAddressInfoEXT));
        deepcopy_VkDescriptorAddressInfoEXT(alloc, rootType, from->pUniformTexelBuffer, (VkDescriptorAddressInfoEXT*)(to->pUniformTexelBuffer));
    }
    to->pStorageTexelBuffer = nullptr;
    if (from->pStorageTexelBuffer)
    {
        to->pStorageTexelBuffer = (VkDescriptorAddressInfoEXT*)alloc->alloc(sizeof(const VkDescriptorAddressInfoEXT));
        deepcopy_VkDescriptorAddressInfoEXT(alloc, rootType, from->pStorageTexelBuffer, (VkDescriptorAddressInfoEXT*)(to->pStorageTexelBuffer));
    }
    to->pUniformBuffer = nullptr;
    if (from->pUniformBuffer)
    {
        to->pUniformBuffer = (VkDescriptorAddressInfoEXT*)alloc->alloc(sizeof(const VkDescriptorAddressInfoEXT));
        deepcopy_VkDescriptorAddressInfoEXT(alloc, rootType, from->pUniformBuffer, (VkDescriptorAddressInfoEXT*)(to->pUniformBuffer));
    }
    to->pStorageBuffer = nullptr;
    if (from->pStorageBuffer)
    {
        to->pStorageBuffer = (VkDescriptorAddressInfoEXT*)alloc->alloc(sizeof(const VkDescriptorAddressInfoEXT));
        deepcopy_VkDescriptorAddressInfoEXT(alloc, rootType, from->pStorageBuffer, (VkDescriptorAddressInfoEXT*)(to->pStorageBuffer));
    }
}

void deepcopy_VkDescriptorGetInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImageCaptureDescriptorDataInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImageViewCaptureDescriptorDataInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkImageViewCaptureDescriptorDataInfoEXT* from,
...
void deepcopy_VkSamplerCaptureDescriptorDataInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkSamplerCaptureDescriptorDataInfoEXT* from,
    ...
    VkOpaqueCaptureDescriptorDataCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->opaqueCaptureDescriptorData = (void*)alloc->dupArray(from->opaqueCaptureDescriptorData, sizeof(const uint8_t));
    }
}
    ...
    VkImageCompressionControlEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pFixedRateFlags = (VkImageCompressionFixedRateFlagsEXT*)alloc->dupArray(from->pFixedRateFlags, from->compressionControlPlaneCount * sizeof(VkImageCompressionFixedRateFlagsEXT));
    }
}

void deepcopy_VkSubresourceLayout2EXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkSubresourceLayout2EXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkSubresourceLayout(alloc, rootType, &from->subresourceLayout, (VkSubresourceLayout*)(&to->subresourceLayout));
}

void deepcopy_VkImageSubresource2EXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkImageSubresource2EXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkImageSubresource(alloc, rootType, &from->imageSubresource, (VkImageSubresource*)(&to->imageSubresource));
}
...
void deepcopy_VkPhysicalDeviceFaultFeaturesEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDeviceFaultCountsEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDeviceFaultAddressInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDeviceFaultVendorInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDeviceFaultInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkDeviceFaultInfoEXT* from,
    VkDeviceFaultInfoEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
    ...
    {
        to->pAddressInfos = (VkDeviceFaultAddressInfoEXT*)alloc->alloc(sizeof(VkDeviceFaultAddressInfoEXT));
        deepcopy_VkDeviceFaultAddressInfoEXT(alloc, rootType, from->pAddressInfos, (VkDeviceFaultAddressInfoEXT*)(to->pAddressInfos));
    }
    to->pVendorInfos = nullptr;
    if (from->pVendorInfos)
    {
        to->pVendorInfos = (VkDeviceFaultVendorInfoEXT*)alloc->alloc(sizeof(VkDeviceFaultVendorInfoEXT));
        deepcopy_VkDeviceFaultVendorInfoEXT(alloc, rootType, from->pVendorInfos, (VkDeviceFaultVendorInfoEXT*)(to->pVendorInfos));
    }
...
void deepcopy_VkMutableDescriptorTypeListEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkMutableDescriptorTypeCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkMutableDescriptorTypeCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pMutableDescriptorTypeLists = (VkMutableDescriptorTypeListEXT*)alloc->alloc(from->mutableDescriptorTypeListCount * sizeof(const VkMutableDescriptorTypeListEXT));
            ...
            {
                deepcopy_VkMutableDescriptorTypeListEXT(alloc, rootType, from->pMutableDescriptorTypeLists + i, (VkMutableDescriptorTypeListEXT*)(to->pMutableDescriptorTypeLists + i));
            }
        }
    }
}
...
void deepcopy_VkDeviceAddressBindingCallbackDataEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkDeviceAddressBindingCallbackDataEXT* from,
    ...
    VkImageFormatConstraintsInfoFUCHSIA* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pColorSpaces = (VkSysmemColorSpaceFUCHSIA*)alloc->alloc(from->colorSpaceCount * sizeof(const VkSysmemColorSpaceFUCHSIA));
            to->colorSpaceCount = from->colorSpaceCount;
            for (uint32_t i = 0; i < (uint32_t)from->colorSpaceCount; ++i)
            {
                deepcopy_VkSysmemColorSpaceFUCHSIA(alloc, rootType, from->pColorSpaces + i, (VkSysmemColorSpaceFUCHSIA*)(to->pColorSpaces + i));
            }
        }
    }
}
...
void deepcopy_VkPipelinePropertiesIdentifierEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkSubpassResolvePerformanceQueryEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImageViewMinLodCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkMicromapUsageEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkMicromapUsageEXT* from,
    VkMicromapUsageEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkMicromapBuildInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkMicromapBuildInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pUsageCounts = (VkMicromapUsageEXT*)alloc->alloc(from->usageCountsCount * sizeof(const VkMicromapUsageEXT));
            to->usageCountsCount = from->usageCountsCount;
            for (uint32_t i = 0; i < (uint32_t)from->usageCountsCount; ++i)
            {
                deepcopy_VkMicromapUsageEXT(alloc, rootType, from->pUsageCounts + i, (VkMicromapUsageEXT*)(to->pUsageCounts + i));
            }
        }
    }
    ...
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->triangleArray, (VkDeviceOrHostAddressConstKHR*)(&to->triangleArray));
}

void deepcopy_VkMicromapCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkMicromapVersionInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkMicromapVersionInfoEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pVersionData = (uint8_t*)alloc->dupArray(from->pVersionData, latexmath:[2 \times \mathtt{VK\_UUID\_SIZE}] * sizeof(const uint8_t));
    }
}

void deepcopy_VkCopyMicromapToMemoryInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkCopyMemoryToMicromapInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkCopyMicromapInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkCopyMicromapInfoEXT* from,
    VkCopyMicromapInfoEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkMicromapBuildSizesInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkAccelerationStructureTrianglesOpacityMicromapEXT* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->indexBuffer, (VkDeviceOrHostAddressConstKHR*)(&to->indexBuffer));
    if (from)
    {
        to->pUsageCounts = nullptr;
        if (from->pUsageCounts)
...
void deepcopy_VkMicromapTriangleEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkMicromapTriangleEXT* from,
    VkMicromapTriangleEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
    ...
    VkAccelerationStructureTrianglesDisplacementMicromapNV* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->displacementBiasAndScaleBuffer, (VkDeviceOrHostAddressConstKHR*)(&to->displacementBiasAndScaleBuffer));
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->displacementVectorBuffer, (VkDeviceOrHostAddressConstKHR*)(&to->displacementVectorBuffer));
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->displacedMicromapPrimitiveFlags, (VkDeviceOrHostAddressConstKHR*)(&to->displacedMicromapPrimitiveFlags));
    deepcopy_VkDeviceOrHostAddressConstKHR(alloc, rootType, &from->indexBuffer, (VkDeviceOrHostAddressConstKHR*)(&to->indexBuffer));
    if (from)
    {
        to->pUsageCounts = nullptr;
...
void deepcopy_VkPhysicalDeviceShaderCorePropertiesARM(
    Allocator* alloc,
    VkStructureType rootType,
    const VkPhysicalDeviceShaderCorePropertiesARM* from,
...
void deepcopy_VkImageViewSlicedCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDescriptorSetBindingReferenceVALVE(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkExtent2D(alloc, rootType, &from->fragmentDensityOffsetGranularity, (VkExtent2D*)(&to->fragmentDensityOffsetGranularity));
}
    ...
    VkSubpassFragmentDensityMapOffsetEndInfoQCOM* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pFragmentDensityOffsets = (VkOffset2D*)alloc->alloc(from->fragmentDensityOffsetCount * sizeof(const VkOffset2D));
            ...
            {
                deepcopy_VkOffset2D(alloc, rootType, from->pFragmentDensityOffsets + i, (VkOffset2D*)(to->pFragmentDensityOffsets + i));
            }
        }
    }
}
...
void deepcopy_VkCopyMemoryIndirectCommandNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkCopyMemoryToImageIndirectCommandNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDecompressMemoryRegionNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkImageViewSampleWeightCreateInfoQCOM(
    Allocator* alloc,
    VkStructureType rootType,
    const VkImageViewSampleWeightCreateInfoQCOM* from,
    ...
    VkPhysicalDeviceImageProcessingPropertiesQCOM* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkExtent2D(alloc, rootType, &from->maxWeightFilterDimension, (VkExtent2D*)(&to->maxWeightFilterDimension));
    deepcopy_VkExtent2D(alloc, rootType, &from->maxBlockMatchRegion, (VkExtent2D*)(&to->maxBlockMatchRegion));
    deepcopy_VkExtent2D(alloc, rootType, &from->maxBoxFilterBlockSize, (VkExtent2D*)(&to->maxBoxFilterBlockSize));
}
...
void deepcopy_VkColorBlendEquationEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkColorBlendAdvancedEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkRenderPassCreationControlEXT(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkRenderPassCreationFeedbackInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkRenderPassCreationFeedbackCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pRenderPassFeedback = (VkRenderPassCreationFeedbackInfoEXT*)alloc->alloc(sizeof(VkRenderPassCreationFeedbackInfoEXT));
        deepcopy_VkRenderPassCreationFeedbackInfoEXT(alloc, rootType, from->pRenderPassFeedback, (VkRenderPassCreationFeedbackInfoEXT*)(to->pRenderPassFeedback));
    }
}
    ...
    VkRenderPassSubpassFeedbackCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pSubpassFeedback = (VkRenderPassSubpassFeedbackInfoEXT*)alloc->alloc(sizeof(VkRenderPassSubpassFeedbackInfoEXT));
        deepcopy_VkRenderPassSubpassFeedbackInfoEXT(alloc, rootType, from->pSubpassFeedback, (VkRenderPassSubpassFeedbackInfoEXT*)(to->pSubpassFeedback));
    }
}

#endif
#ifdef VK_LUNARG_direct_driver_loading
void deepcopy_VkDirectDriverLoadingInfoLUNARG(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkDirectDriverLoadingListLUNARG(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkDirectDriverLoadingListLUNARG* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pDrivers)
        {
            to->pDrivers = (VkDirectDriverLoadingInfoLUNARG*)alloc->alloc(from->driverCount * sizeof(const VkDirectDriverLoadingInfoLUNARG));
            to->driverCount = from->driverCount;
            for (uint32_t i = 0; i < (uint32_t)from->driverCount; ++i)
            {
                deepcopy_VkDirectDriverLoadingInfoLUNARG(alloc, rootType, from->pDrivers + i, (VkDirectDriverLoadingInfoLUNARG*)(to->pDrivers + i));
            }
        }
    }
}
    ...
    VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT* to)
{
    ...
    *to = *from;
    ...
    memcpy(to->shaderModuleIdentifierAlgorithmUUID, from->shaderModuleIdentifierAlgorithmUUID, VK_UUID_SIZE * sizeof(uint8_t));
}
    ...
    VkPipelineShaderStageModuleIdentifierCreateInfoEXT* to)
{
    ...
    *to = *from;
    ...
    if (from->pIdentifier)
    {
        to->pIdentifier = (uint8_t*)alloc->dupArray(from->pIdentifier, from->identifierSize * sizeof(const uint8_t));
    }
}

void deepcopy_VkShaderModuleIdentifierEXT(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkShaderModuleIdentifierEXT* to)
{
    ...
    *to = *from;
    ...
    memcpy(to->identifier, from->identifier, VK_MAX_SHADER_MODULE_IDENTIFIER_SIZE_EXT * sizeof(uint8_t));
}
...
void deepcopy_VkPhysicalDeviceOpticalFlowFeaturesNV(
    Allocator* alloc,
    VkStructureType rootType,
    const VkPhysicalDeviceOpticalFlowFeaturesNV* from,
...
void deepcopy_VkPhysicalDeviceOpticalFlowPropertiesNV(
    Allocator* alloc,
    VkStructureType rootType,
    const VkPhysicalDeviceOpticalFlowPropertiesNV* from,
...
void deepcopy_VkOpticalFlowImageFormatInfoNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkOpticalFlowImageFormatPropertiesNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkOpticalFlowSessionCreateInfoNV(
    Allocator* alloc,
    VkStructureType rootType,
...
void deepcopy_VkOpticalFlowExecuteInfoNV(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            ...
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkRect2D(alloc, rootType, from->pRegions + i, (VkRect2D*)(to->pRegions + i));
            }
        }
    }
}
...
void deepcopy_VkPhysicalDeviceShaderObjectFeaturesEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkPhysicalDeviceShaderObjectFeaturesEXT* from,
...
void deepcopy_VkShaderCreateInfoEXT(
    Allocator* alloc,
    VkStructureType rootType,
    const VkShaderCreateInfoEXT* from,
    VkShaderCreateInfoEXT* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkTilePropertiesQCOM(
    Allocator* alloc,
    VkStructureType rootType,
    const VkTilePropertiesQCOM* from,
    VkTilePropertiesQCOM* to)
{
    (void)alloc;
    (void)rootType;
    *to = *from;
...
void deepcopy_VkAmigoProfilingSubmitInfoSEC(
    Allocator* alloc,
    VkStructureType rootType,
    ...
    VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pPerViewRenderAreas = (VkRect2D*)alloc->alloc(from->perViewRenderAreaCount * sizeof(const VkRect2D));
            to->perViewRenderAreaCount = from->perViewRenderAreaCount;
            for (uint32_t i = 0; i < (uint32_t)from->perViewRenderAreaCount; ++i)
            {
                deepcopy_VkRect2D(alloc, rootType, from->pPerViewRenderAreas + i, (VkRect2D*)(to->pPerViewRenderAreas + i));
            }
        }
    }
}
...
void deepcopy_VkDrawMeshTasksIndirectCommandEXT(
    Allocator* alloc,
    VkStructureType rootType,
