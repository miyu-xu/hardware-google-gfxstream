...
class AndroidNativeBufferInfo {
   public:
    ...
    VkResult on_vkAcquireImageANDROID(VulkanDispatch* vk, VkDevice device, VkQueue defaultQueue,
                                      uint32_t defaultQueueFamilyIndex,
                                      std::mutex* defaultQueueMutex, VkSemaphore semaphore,
                                      VkFence fence);

    VkResult on_vkQueueSignalReleaseImageANDROID(gfxstream::host::BackendCallbacks& callbacks,
