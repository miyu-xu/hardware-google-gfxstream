...
class VkDecoderTestDispatch {
   public:
    ...
    VkResult vkAllocateCommandBuffers(VkDevice device,
        ...
        return mDgs->on_vkAllocateCommandBuffers(mBp, nullptr, device, pAllocateInfo, pCommandBuffers);
    }
    ...
    void vkCmdCopyImage(VkCommandBuffer commandBuffer, VkImage srcImage,
        ...
        mDgs->on_vkCmdCopyImage(mBp, nullptr, commandBuffer, unbox_VkImage(srcImage), srcImageLayout,
    ...
    void vkCmdCopyImageToBuffer(VkCommandBuffer commandBuffer, VkImage srcImage,
        ...
        mDgs->on_vkCmdCopyImageToBuffer(mBp, nullptr, commandBuffer, unbox_VkImage(srcImage), srcImageLayout,
    ...
    VkResult vkCreateCommandPool(VkDevice device, const VkCommandPoolCreateInfo* pCreateInfo,
        ...
        return mDgs->on_vkCreateCommandPool(mBp, nullptr, device, pCreateInfo, pAllocator, pCommandPool);
    }
    ...
    VkResult vkCreateDevice(VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo,
        ...
        return mDgs->on_vkCreateDevice(mBp, nullptr, physicalDevice, pCreateInfo, pAllocator, pDevice);
    }
    ...
    void vkDestroyCommandPool(VkDevice device, VkCommandPool commandPool,
                              const VkAllocationCallbacks* pAllocator) {
        mDgs->on_vkDestroyCommandPool(mBp, nullptr, device, unbox_VkCommandPool(commandPool), pAllocator);
    ...
    void vkGetPhysicalDeviceMemoryProperties(VkPhysicalDevice physicalDevice,
        ...
        mDgs->on_vkGetPhysicalDeviceMemoryProperties(mBp, nullptr, physicalDevice, pMemoryProperties);
    }
    ...
    VkResult vkMapMemory(VkDevice device, VkDeviceMemory memory, VkDeviceSize offset,
        ...
        return mDgs->on_vkMapMemory(mBp, nullptr, device, unbox_VkDeviceMemory(memory), offset, size, flags,
                                    ppData);
    }
