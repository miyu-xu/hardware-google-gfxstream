...
void CompositorVk::buildCompositionVk(const CompositionRequest& compositionRequest,
    ...
    for (const CompositionRequestLayer& layer : compositionRequest.layers) {
        ...
        if (layer.props.composeMode == HWC2_COMPOSITION_SOLID_COLOR) {
            ...
            ERR("jasonjason SOLID_COLOR alpha:%f crop: {l:%f r:%f t:%f b:%f} display_frame: {l:%d r:%d t:%d b:%d} color:{r:%d g:%d b:%d a:%d}", 
                layer.props.alpha,
                layer.props.crop.left,
                layer.props.crop.right,
                layer.props.crop.top,
                layer.props.crop.bottom,
                layer.props.displayFrame.left,
                layer.props.displayFrame.right,
                layer.props.displayFrame.top,
                layer.props.displayFrame.bottom,
                layer.props.color.r,
                layer.props.color.g,
                layer.props.color.b,
                layer.props.color.a
            ...
            .binding1 =
                {
                    ...
                    .alpha = glm::vec4(layer.props.alpha, layer.props.alpha, layer.props.alpha, layer.props.alpha),
                },
        };
