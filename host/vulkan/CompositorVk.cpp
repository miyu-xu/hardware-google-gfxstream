...
void CompositorVk::setUpDefaultImage() {
    ...
    auto memoryTypeIndexOpt = findMemoryType(imageMemoryRequirements.memoryTypeBits,
                                             VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
    ...
    VK_CHECK_MEMALLOC(m_vk.vkAllocateMemory(m_vkDevice,
    ...
    runSingleTimeCommands(m_vkQueue, m_vkQueueLock, [&, this, stagingBuffer](const VkCommandBuffer& cmdBuff) {
