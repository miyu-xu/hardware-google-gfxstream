    ...
    while (end - ptr >= 8) {
        ...
        switch (opcode) {
            ...
            case OP_vkCmdBindPipeline: {
                ...
                *(VkPipeline*)&pipeline =
                    (VkPipeline)try_unbox_VkPipeline((VkPipeline)(*&cgen_var_0));
            ...
            case OP_vkCmdBindDescriptorSets: {
                ...
                *readStreamPtrPtr += 1 * 8;
                *(VkPipelineLayout*)&layout =
                    (VkPipelineLayout)try_unbox_VkPipelineLayout((VkPipelineLayout)(*&cgen_var_0));
                    ...
                    *readStreamPtrPtr += 8 * ((descriptorSetCount));
                    for (uint32_t k = 0; k < ((descriptorSetCount)); ++k) {
                        ...
                        *(((VkDescriptorSet*)pDescriptorSets) + k) =
                            tmpval ? (VkDescriptorSet)try_unbox_VkDescriptorSet(
            ...
            case OP_vkCmdBindIndexBuffer: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&buffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_0));
                ...
                if (((bindingCount))) {
                    ...
                    *readStreamPtrPtr += 8 * ((bindingCount));
                    for (uint32_t k = 0; k < ((bindingCount)); ++k) {
                        ...
                        *(((VkBuffer*)pBuffers) + k) =
                            tmpval ? (VkBuffer)try_unbox_VkBuffer((VkBuffer)tmpval)
                                   : VK_NULL_HANDLE;
                    }
                }
                if (((bindingCount)) <= MAX_STACK_ITEMS) {
            ...
            case OP_vkCmdCopyBuffer: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&srcBuffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_0));
                uint64_t cgen_var_1;
                memcpy((uint64_t*)&cgen_var_1, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&dstBuffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_1));
            ...
            case OP_vkCmdCopyImage: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkImage*)&srcImage = (VkImage)try_unbox_VkImage((VkImage)(*&cgen_var_0));
                memcpy((VkImageLayout*)&srcImageLayout, *readStreamPtrPtr, sizeof(VkImageLayout));
                *readStreamPtrPtr += sizeof(VkImageLayout);
                uint64_t cgen_var_1;
                memcpy((uint64_t*)&cgen_var_1, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkImage*)&dstImage = (VkImage)try_unbox_VkImage((VkImage)(*&cgen_var_1));
            ...
            case OP_vkCmdUpdateBuffer: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&dstBuffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_0));
            ...
            case OP_vkCmdClearColorImage: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkImage*)&image = (VkImage)try_unbox_VkImage((VkImage)(*&cgen_var_0));
            ...
            case OP_vkCmdSetEvent: {
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkEvent*)&event = (VkEvent)try_unbox_VkEvent((VkEvent)(*&cgen_var_0));
                ...
                if (((eventCount))) {
                    ...
                    *readStreamPtrPtr += 8 * ((eventCount));
                    for (uint32_t k = 0; k < ((eventCount)); ++k) {
                        ...
                        memcpy(&tmpval, cgen_var_0_ptr + k * 8, sizeof(uint64_t));
                        *(((VkEvent*)pEvents) + k) =
                            tmpval ? (VkEvent)try_unbox_VkEvent((VkEvent)tmpval) : VK_NULL_HANDLE;
                    }
                }
            ...
            case OP_vkCmdBeginQuery: {
                ...
                *readStreamPtrPtr += 1 * 8;
                *(VkQueryPool*)&queryPool =
                    (VkQueryPool)try_unbox_VkQueryPool((VkQueryPool)(*&cgen_var_0));
                    ...
                    *readStreamPtrPtr += 8 * ((commandBufferCount));
                    for (uint32_t k = 0; k < ((commandBufferCount)); ++k) {
                        ...
                        *(((VkCommandBuffer*)pCommandBuffers) + k) =
                            tmpval ? (VkCommandBuffer)try_unbox_VkCommandBuffer(
            ...
            case OP_vkCmdDrawIndirectCount: {
                ...
                *readStreamPtrPtr += sizeof(VkDeviceSize);
                ...
                memcpy((uint64_t*)&cgen_var_1, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&countBuffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_1));
            ...
            case OP_vkCmdDrawIndirectByteCountEXT: {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
                *(VkBuffer*)&counterBuffer = (VkBuffer)try_unbox_VkBuffer((VkBuffer)(*&cgen_var_0));
