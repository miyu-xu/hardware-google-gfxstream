    ...
    while (end - ptr >= 8)
    {
        ...
        switch (opcode)
        {
            ...
            case OP_vkBeginCommandBuffer:
            {
                ...
                vkBeginCommandBuffer_VkResult_return = this->on_vkBeginCommandBuffer(pool, (VkCommandBuffer)(boxed_dispatchHandle), pBeginInfo, context);
            ...
            case OP_vkEndCommandBuffer:
            {
                ...
                vkEndCommandBuffer_VkResult_return = this->on_vkEndCommandBuffer(pool, (VkCommandBuffer)(boxed_dispatchHandle), context);
            ...
            case OP_vkCmdCopyBufferToImage:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                this->on_vkCmdCopyBufferToImage(pool, (VkCommandBuffer)(boxed_dispatchHandle), srcBuffer, dstImage, dstImageLayout, regionCount, pRegions, context);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetEvent2:
            {
                ...
                *(VkEvent*)&event = (VkEvent)unbox_VkEvent((VkEvent)(*&cgen_var_0));
                ...
                reservedunmarshal_VkDependencyInfo(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkDependencyInfo*)(pDependencyInfo), readStreamPtrPtr);
                if (pDependencyInfo)
                {
                    transform_tohost_VkDependencyInfo(globalstate, (VkDependencyInfo*)(pDependencyInfo));
                }
            ...
            case OP_vkCmdResetEvent2:
            {
                ...
                *readStreamPtrPtr += 1 * 8;
                *(VkEvent*)&event = (VkEvent)unbox_VkEvent((VkEvent)(*&cgen_var_0));
                memcpy((VkPipelineStageFlags2*)&stageMask, *readStreamPtrPtr, sizeof(VkPipelineStageFlags2));
            ...
            case OP_vkCmdWaitEvents2:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pDependencyInfos, ((eventCount)) * sizeof(const VkDependencyInfo));
                }
                for (uint32_t i = 0; i < (uint32_t)((eventCount)); ++i)
                {
                    reservedunmarshal_VkDependencyInfo(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkDependencyInfo*)(pDependencyInfos + i), readStreamPtrPtr);
                }
                if (pDependencyInfos)
                {
                    for (uint32_t i = 0; i < (uint32_t)((eventCount)); ++i)
                    {
                        transform_tohost_VkDependencyInfo(globalstate, (VkDependencyInfo*)(pDependencyInfos + i));
                    }
                }
                vk->vkCmdWaitEvents2((VkCommandBuffer)dispatchHandle, eventCount, pEvents, pDependencyInfos);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdWriteTimestamp2:
            {
                ...
                VkQueryPool queryPool;
                uint32_t query;
                memcpy((VkPipelineStageFlags2*)&stage, *readStreamPtrPtr, sizeof(VkPipelineStageFlags2));
                *readStreamPtrPtr += sizeof(VkPipelineStageFlags2);
                uint64_t cgen_var_0;
                memcpy((uint64_t*)&cgen_var_0, *readStreamPtrPtr, 1 * 8);
                *readStreamPtrPtr += 1 * 8;
            ...
            case OP_vkCmdCopyBuffer2:
            {
                ...
                reservedunmarshal_VkCopyBufferInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyBufferInfo2*)(pCopyBufferInfo), readStreamPtrPtr);
                if (pCopyBufferInfo)
                {
                    transform_tohost_VkCopyBufferInfo2(globalstate, (VkCopyBufferInfo2*)(pCopyBufferInfo));
                }
            ...
            case OP_vkCmdCopyImage2:
            {
                ...
                reservedunmarshal_VkCopyImageInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyImageInfo2*)(pCopyImageInfo), readStreamPtrPtr);
                if (pCopyImageInfo)
                {
                    transform_tohost_VkCopyImageInfo2(globalstate, (VkCopyImageInfo2*)(pCopyImageInfo));
                }
            ...
            case OP_vkCmdCopyBufferToImage2:
            {
                ...
                reservedunmarshal_VkCopyBufferToImageInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyBufferToImageInfo2*)(pCopyBufferToImageInfo), readStreamPtrPtr);
                if (pCopyBufferToImageInfo)
                {
                    transform_tohost_VkCopyBufferToImageInfo2(globalstate, (VkCopyBufferToImageInfo2*)(pCopyBufferToImageInfo));
                }
                vk->vkCmdCopyBufferToImage2((VkCommandBuffer)dispatchHandle, pCopyBufferToImageInfo);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdCopyImageToBuffer2:
            {
                ...
                reservedunmarshal_VkCopyImageToBufferInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyImageToBufferInfo2*)(pCopyImageToBufferInfo), readStreamPtrPtr);
                if (pCopyImageToBufferInfo)
                {
                    transform_tohost_VkCopyImageToBufferInfo2(globalstate, (VkCopyImageToBufferInfo2*)(pCopyImageToBufferInfo));
                }
                vk->vkCmdCopyImageToBuffer2((VkCommandBuffer)dispatchHandle, pCopyImageToBufferInfo);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdBlitImage2:
            {
                ...
                reservedunmarshal_VkBlitImageInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkBlitImageInfo2*)(pBlitImageInfo), readStreamPtrPtr);
                if (pBlitImageInfo)
                {
                    transform_tohost_VkBlitImageInfo2(globalstate, (VkBlitImageInfo2*)(pBlitImageInfo));
                }
            ...
            case OP_vkCmdResolveImage2:
            {
                ...
                reservedunmarshal_VkResolveImageInfo2(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkResolveImageInfo2*)(pResolveImageInfo), readStreamPtrPtr);
                if (pResolveImageInfo)
                {
                    transform_tohost_VkResolveImageInfo2(globalstate, (VkResolveImageInfo2*)(pResolveImageInfo));
                }
            ...
            case OP_vkCmdBeginRendering:
            {
                ...
                reservedunmarshal_VkRenderingInfo(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkRenderingInfo*)(pRenderingInfo), readStreamPtrPtr);
                if (pRenderingInfo)
                {
                    transform_tohost_VkRenderingInfo(globalstate, (VkRenderingInfo*)(pRenderingInfo));
                }
            ...
            case OP_vkCmdSetViewportWithCount:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                vk->vkCmdSetViewportWithCount((VkCommandBuffer)dispatchHandle, viewportCount, pViewports);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetScissorWithCount:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                vk->vkCmdSetScissorWithCount((VkCommandBuffer)dispatchHandle, scissorCount, pScissors);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdBindVertexBuffers2:
            {
                ...
                *readStreamPtrPtr += 8;
                ...
                vk->vkCmdBindVertexBuffers2((VkCommandBuffer)dispatchHandle, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetDepthBoundsTestEnable:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetDepthBoundsTestEnable((VkCommandBuffer)dispatchHandle, depthBoundsTestEnable);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetStencilOp:
            {
                ...
                *readStreamPtrPtr += sizeof(VkCompareOp);
                vk->vkCmdSetStencilOp((VkCommandBuffer)dispatchHandle, faceMask, failOp, passOp, depthFailOp, compareOp);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetRasterizerDiscardEnable:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetRasterizerDiscardEnable((VkCommandBuffer)dispatchHandle, rasterizerDiscardEnable);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetPrimitiveRestartEnable:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetPrimitiveRestartEnable((VkCommandBuffer)dispatchHandle, primitiveRestartEnable);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdDecodeVideoKHR:
            {
                ...
                reservedunmarshal_VkVideoDecodeInfoKHR(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkVideoDecodeInfoKHR*)(pDecodeInfo), readStreamPtrPtr);
                if (pDecodeInfo)
                {
                    transform_tohost_VkVideoDecodeInfoKHR(globalstate, (VkVideoDecodeInfoKHR*)(pDecodeInfo));
                }
            ...
            case OP_vkCmdTraceRaysIndirect2KHR:
            {
                ...
                *readStreamPtrPtr += sizeof(VkDeviceAddress);
                vk->vkCmdTraceRaysIndirect2KHR((VkCommandBuffer)dispatchHandle, indirectDeviceAddress);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdSetDiscardRectangleEnableEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetDiscardRectangleEnableEXT((VkCommandBuffer)dispatchHandle, discardRectangleEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetDiscardRectangleModeEXT:
            {
                ...
                memcpy((VkDiscardRectangleModeEXT*)&discardRectangleMode, *readStreamPtrPtr, sizeof(VkDiscardRectangleModeEXT));
                *readStreamPtrPtr += sizeof(VkDiscardRectangleModeEXT);
                vk->vkCmdSetDiscardRectangleModeEXT((VkCommandBuffer)dispatchHandle, discardRectangleMode);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdSetExclusiveScissorEnableNV:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pExclusiveScissorEnables, ((exclusiveScissorCount)) * sizeof(const VkBool32));
                }
                memcpy((VkBool32*)pExclusiveScissorEnables, *readStreamPtrPtr, ((exclusiveScissorCount)) * sizeof(const VkBool32));
                *readStreamPtrPtr += ((exclusiveScissorCount)) * sizeof(const VkBool32);
                vk->vkCmdSetExclusiveScissorEnableNV((VkCommandBuffer)dispatchHandle, firstExclusiveScissor, exclusiveScissorCount, pExclusiveScissorEnables);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetPerformanceMarkerINTEL:
            {
                ...
                this->on_CheckOutOfMemory(vkCmdSetPerformanceMarkerINTEL_VkResult_return, opcode, context);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetPerformanceStreamMarkerINTEL:
            {
                ...
                this->on_CheckOutOfMemory(vkCmdSetPerformanceStreamMarkerINTEL_VkResult_return, opcode, context);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetPerformanceOverrideINTEL:
            {
                ...
                this->on_CheckOutOfMemory(vkCmdSetPerformanceOverrideINTEL_VkResult_return, opcode, context);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdBindDescriptorBuffersEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pBindingInfos, ((bufferCount)) * sizeof(const VkDescriptorBufferBindingInfoEXT));
                }
                for (uint32_t i = 0; i < (uint32_t)((bufferCount)); ++i)
                {
                    reservedunmarshal_VkDescriptorBufferBindingInfoEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkDescriptorBufferBindingInfoEXT*)(pBindingInfos + i), readStreamPtrPtr);
                }
                if (pBindingInfos)
                {
                    for (uint32_t i = 0; i < (uint32_t)((bufferCount)); ++i)
                    {
                        transform_tohost_VkDescriptorBufferBindingInfoEXT(globalstate, (VkDescriptorBufferBindingInfoEXT*)(pBindingInfos + i));
                    }
                }
                vk->vkCmdBindDescriptorBuffersEXT((VkCommandBuffer)dispatchHandle, bufferCount, pBindingInfos);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetDescriptorBufferOffsetsEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pBufferIndices, ((setCount)) * sizeof(const uint32_t));
                }
                memcpy((uint32_t*)pBufferIndices, *readStreamPtrPtr, ((setCount)) * sizeof(const uint32_t));
                *readStreamPtrPtr += ((setCount)) * sizeof(const uint32_t);
                ...
                memcpy((VkDeviceSize*)pOffsets, *readStreamPtrPtr, ((setCount)) * sizeof(const VkDeviceSize));
                *readStreamPtrPtr += ((setCount)) * sizeof(const VkDeviceSize);
                vk->vkCmdSetDescriptorBufferOffsetsEXT((VkCommandBuffer)dispatchHandle, pipelineBindPoint, layout, firstSet, setCount, pBufferIndices, pOffsets);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdBindDescriptorBufferEmbeddedSamplersEXT:
            {
                ...
                *(VkPipelineLayout*)&layout = (VkPipelineLayout)unbox_VkPipelineLayout((VkPipelineLayout)(*&cgen_var_0));
                memcpy((uint32_t*)&set, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdBindDescriptorBufferEmbeddedSamplersEXT((VkCommandBuffer)dispatchHandle, pipelineBindPoint, layout, set);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdBuildMicromapsEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pInfos, ((infoCount)) * sizeof(const VkMicromapBuildInfoEXT));
                }
                for (uint32_t i = 0; i < (uint32_t)((infoCount)); ++i)
                {
                    reservedunmarshal_VkMicromapBuildInfoEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkMicromapBuildInfoEXT*)(pInfos + i), readStreamPtrPtr);
                }
                if (pInfos)
                {
                    for (uint32_t i = 0; i < (uint32_t)((infoCount)); ++i)
                    {
                        transform_tohost_VkMicromapBuildInfoEXT(globalstate, (VkMicromapBuildInfoEXT*)(pInfos + i));
                    }
                }
            ...
            case OP_vkCmdCopyMicromapEXT:
            {
                ...
                reservedunmarshal_VkCopyMicromapInfoEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyMicromapInfoEXT*)(pInfo), readStreamPtrPtr);
                if (pInfo)
                {
                    transform_tohost_VkCopyMicromapInfoEXT(globalstate, (VkCopyMicromapInfoEXT*)(pInfo));
                }
            ...
            case OP_vkCmdCopyMicromapToMemoryEXT:
            {
                ...
                reservedunmarshal_VkCopyMicromapToMemoryInfoEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyMicromapToMemoryInfoEXT*)(pInfo), readStreamPtrPtr);
                if (pInfo)
                {
                    transform_tohost_VkCopyMicromapToMemoryInfoEXT(globalstate, (VkCopyMicromapToMemoryInfoEXT*)(pInfo));
                }
            ...
            case OP_vkCmdCopyMemoryToMicromapEXT:
            {
                ...
                reservedunmarshal_VkCopyMemoryToMicromapInfoEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkCopyMemoryToMicromapInfoEXT*)(pInfo), readStreamPtrPtr);
                if (pInfo)
                {
                    transform_tohost_VkCopyMemoryToMicromapInfoEXT(globalstate, (VkCopyMemoryToMicromapInfoEXT*)(pInfo));
                }
            ...
            case OP_vkCmdWriteMicromapsPropertiesEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pMicromaps, ((micromapCount)) * sizeof(const VkMicromapEXT));
                }
                ...
                *(VkQueryPool*)&queryPool = (VkQueryPool)unbox_VkQueryPool((VkQueryPool)(*&cgen_var_0));
                memcpy((uint32_t*)&firstQuery, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdWriteMicromapsPropertiesEXT((VkCommandBuffer)dispatchHandle, micromapCount, pMicromaps, queryType, queryPool, firstQuery);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdDrawClusterHUAWEI:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                memcpy((uint32_t*)&groupCountZ, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdDrawClusterHUAWEI((VkCommandBuffer)dispatchHandle, groupCountX, groupCountY, groupCountZ);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdCopyMemoryIndirectNV:
            {
                ...
                uint32_t copyCount;
                uint32_t stride;
                memcpy((VkDeviceAddress*)&copyBufferAddress, *readStreamPtrPtr, sizeof(VkDeviceAddress));
                *readStreamPtrPtr += sizeof(VkDeviceAddress);
                memcpy((uint32_t*)&copyCount, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                memcpy((uint32_t*)&stride, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdCopyMemoryIndirectNV((VkCommandBuffer)dispatchHandle, copyBufferAddress, copyCount, stride);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdCopyMemoryToImageIndirectNV:
            {
                ...
                *readStreamPtrPtr += sizeof(VkImageLayout);
                ...
                {
                    readStream->alloc((void**)&pImageSubresources, ((copyCount)) * sizeof(const VkImageSubresourceLayers));
                }
                for (uint32_t i = 0; i < (uint32_t)((copyCount)); ++i)
                {
                    reservedunmarshal_VkImageSubresourceLayers(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkImageSubresourceLayers*)(pImageSubresources + i), readStreamPtrPtr);
                }
                if (pImageSubresources)
                {
                    for (uint32_t i = 0; i < (uint32_t)((copyCount)); ++i)
                    {
                        transform_tohost_VkImageSubresourceLayers(globalstate, (VkImageSubresourceLayers*)(pImageSubresources + i));
                    }
                }
                vk->vkCmdCopyMemoryToImageIndirectNV((VkCommandBuffer)dispatchHandle, copyBufferAddress, copyCount, stride, dstImage, dstImageLayout, pImageSubresources);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdDecompressMemoryNV:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    pDecompressMemoryRegions = (VkDecompressMemoryRegionNV*)stack_pDecompressMemoryRegions;
                }
                else
                {
                    readStream->alloc((void**)&pDecompressMemoryRegions, ((decompressRegionCount)) * sizeof(const VkDecompressMemoryRegionNV));
                }
                for (uint32_t i = 0; i < (uint32_t)((decompressRegionCount)); ++i)
                {
                    reservedunmarshal_VkDecompressMemoryRegionNV(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkDecompressMemoryRegionNV*)(pDecompressMemoryRegions + i), readStreamPtrPtr);
                }
                if (pDecompressMemoryRegions)
                {
                    for (uint32_t i = 0; i < (uint32_t)((decompressRegionCount)); ++i)
                    {
                        transform_tohost_VkDecompressMemoryRegionNV(globalstate, (VkDecompressMemoryRegionNV*)(pDecompressMemoryRegions + i));
                    }
                }
                vk->vkCmdDecompressMemoryNV((VkCommandBuffer)dispatchHandle, decompressRegionCount, pDecompressMemoryRegions);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdDecompressMemoryIndirectCountNV:
            {
                ...
                uint32_t stride;
                memcpy((VkDeviceAddress*)&indirectCommandsAddress, *readStreamPtrPtr, sizeof(VkDeviceAddress));
                *readStreamPtrPtr += sizeof(VkDeviceAddress);
                memcpy((VkDeviceAddress*)&indirectCommandsCountAddress, *readStreamPtrPtr, sizeof(VkDeviceAddress));
                *readStreamPtrPtr += sizeof(VkDeviceAddress);
                memcpy((uint32_t*)&stride, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdDecompressMemoryIndirectCountNV((VkCommandBuffer)dispatchHandle, indirectCommandsAddress, indirectCommandsCountAddress, stride);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdSetTessellationDomainOriginEXT:
            {
                ...
                memcpy((VkTessellationDomainOrigin*)&domainOrigin, *readStreamPtrPtr, sizeof(VkTessellationDomainOrigin));
                *readStreamPtrPtr += sizeof(VkTessellationDomainOrigin);
                vk->vkCmdSetTessellationDomainOriginEXT((VkCommandBuffer)dispatchHandle, domainOrigin);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetRasterizationSamplesEXT:
            {
                ...
                memcpy((VkSampleCountFlagBits*)&rasterizationSamples, *readStreamPtrPtr, sizeof(VkSampleCountFlagBits));
                *readStreamPtrPtr += sizeof(VkSampleCountFlagBits);
                vk->vkCmdSetRasterizationSamplesEXT((VkCommandBuffer)dispatchHandle, rasterizationSamples);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetSampleMaskEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkSampleCountFlagBits);
                if (latexmath:[\lceil{\mathit{samples} \over 32}\rceil] <= MAX_STACK_ITEMS)
                {
                    pSampleMask = (VkSampleMask*)stack_pSampleMask;
                }
                else
                {
                    readStream->alloc((void**)&pSampleMask, latexmath:[\lceil{\mathit{samples} \over 32}\rceil] * sizeof(const VkSampleMask));
                }
                memcpy((VkSampleMask*)pSampleMask, *readStreamPtrPtr, latexmath:[\lceil{\mathit{samples} \over 32}\rceil] * sizeof(const VkSampleMask));
                *readStreamPtrPtr += latexmath:[\lceil{\mathit{samples} \over 32}\rceil] * sizeof(const VkSampleMask);
            ...
            case OP_vkCmdSetAlphaToCoverageEnableEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetAlphaToCoverageEnableEXT((VkCommandBuffer)dispatchHandle, alphaToCoverageEnable);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetColorBlendEnableEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pColorBlendEnables, ((attachmentCount)) * sizeof(const VkBool32));
                }
                memcpy((VkBool32*)pColorBlendEnables, *readStreamPtrPtr, ((attachmentCount)) * sizeof(const VkBool32));
                *readStreamPtrPtr += ((attachmentCount)) * sizeof(const VkBool32);
                vk->vkCmdSetColorBlendEnableEXT((VkCommandBuffer)dispatchHandle, firstAttachment, attachmentCount, pColorBlendEnables);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetColorBlendEquationEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pColorBlendEquations, ((attachmentCount)) * sizeof(const VkColorBlendEquationEXT));
                }
                for (uint32_t i = 0; i < (uint32_t)((attachmentCount)); ++i)
                {
                    reservedunmarshal_VkColorBlendEquationEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkColorBlendEquationEXT*)(pColorBlendEquations + i), readStreamPtrPtr);
                }
                if (pColorBlendEquations)
                {
                    for (uint32_t i = 0; i < (uint32_t)((attachmentCount)); ++i)
                    {
                        transform_tohost_VkColorBlendEquationEXT(globalstate, (VkColorBlendEquationEXT*)(pColorBlendEquations + i));
                    }
                }
                vk->vkCmdSetColorBlendEquationEXT((VkCommandBuffer)dispatchHandle, firstAttachment, attachmentCount, pColorBlendEquations);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetColorWriteMaskEXT:
            {
                ...
                *readStreamPtrPtr += 8;
                if (pColorWriteMasks)
                {
                    ...
                    {
                        readStream->alloc((void**)&pColorWriteMasks, ((attachmentCount)) * sizeof(const VkColorComponentFlags));
                    }
                    memcpy((VkColorComponentFlags*)pColorWriteMasks, *readStreamPtrPtr, ((attachmentCount)) * sizeof(const VkColorComponentFlags));
                    *readStreamPtrPtr += ((attachmentCount)) * sizeof(const VkColorComponentFlags);
                }
                vk->vkCmdSetColorWriteMaskEXT((VkCommandBuffer)dispatchHandle, firstAttachment, attachmentCount, pColorWriteMasks);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetRasterizationStreamEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdSetRasterizationStreamEXT((VkCommandBuffer)dispatchHandle, rasterizationStream);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetConservativeRasterizationModeEXT:
            {
                ...
                memcpy((VkConservativeRasterizationModeEXT*)&conservativeRasterizationMode, *readStreamPtrPtr, sizeof(VkConservativeRasterizationModeEXT));
                *readStreamPtrPtr += sizeof(VkConservativeRasterizationModeEXT);
                vk->vkCmdSetConservativeRasterizationModeEXT((VkCommandBuffer)dispatchHandle, conservativeRasterizationMode);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetExtraPrimitiveOverestimationSizeEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(float);
                vk->vkCmdSetExtraPrimitiveOverestimationSizeEXT((VkCommandBuffer)dispatchHandle, extraPrimitiveOverestimationSize);
                android::base::endTrace();
                break;
            }
            ...
            case OP_vkCmdSetSampleLocationsEnableEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetSampleLocationsEnableEXT((VkCommandBuffer)dispatchHandle, sampleLocationsEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetColorBlendAdvancedEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pColorBlendAdvanced, ((attachmentCount)) * sizeof(const VkColorBlendAdvancedEXT));
                }
                for (uint32_t i = 0; i < (uint32_t)((attachmentCount)); ++i)
                {
                    reservedunmarshal_VkColorBlendAdvancedEXT(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkColorBlendAdvancedEXT*)(pColorBlendAdvanced + i), readStreamPtrPtr);
                }
                if (pColorBlendAdvanced)
                {
                    for (uint32_t i = 0; i < (uint32_t)((attachmentCount)); ++i)
                    {
                        transform_tohost_VkColorBlendAdvancedEXT(globalstate, (VkColorBlendAdvancedEXT*)(pColorBlendAdvanced + i));
                    }
                }
                vk->vkCmdSetColorBlendAdvancedEXT((VkCommandBuffer)dispatchHandle, firstAttachment, attachmentCount, pColorBlendAdvanced);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetProvokingVertexModeEXT:
            {
                ...
                memcpy((VkProvokingVertexModeEXT*)&provokingVertexMode, *readStreamPtrPtr, sizeof(VkProvokingVertexModeEXT));
                *readStreamPtrPtr += sizeof(VkProvokingVertexModeEXT);
                vk->vkCmdSetProvokingVertexModeEXT((VkCommandBuffer)dispatchHandle, provokingVertexMode);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetLineRasterizationModeEXT:
            {
                ...
                memcpy((VkLineRasterizationModeEXT*)&lineRasterizationMode, *readStreamPtrPtr, sizeof(VkLineRasterizationModeEXT));
                *readStreamPtrPtr += sizeof(VkLineRasterizationModeEXT);
                vk->vkCmdSetLineRasterizationModeEXT((VkCommandBuffer)dispatchHandle, lineRasterizationMode);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetLineStippleEnableEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetLineStippleEnableEXT((VkCommandBuffer)dispatchHandle, stippledLineEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetDepthClipNegativeOneToOneEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetDepthClipNegativeOneToOneEXT((VkCommandBuffer)dispatchHandle, negativeOneToOne);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetViewportWScalingEnableNV:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetViewportWScalingEnableNV((VkCommandBuffer)dispatchHandle, viewportWScalingEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetViewportSwizzleNV:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pViewportSwizzles, ((viewportCount)) * sizeof(const VkViewportSwizzleNV));
                }
                for (uint32_t i = 0; i < (uint32_t)((viewportCount)); ++i)
                {
                    reservedunmarshal_VkViewportSwizzleNV(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkViewportSwizzleNV*)(pViewportSwizzles + i), readStreamPtrPtr);
                }
                if (pViewportSwizzles)
                {
                    for (uint32_t i = 0; i < (uint32_t)((viewportCount)); ++i)
                    {
                        transform_tohost_VkViewportSwizzleNV(globalstate, (VkViewportSwizzleNV*)(pViewportSwizzles + i));
                    }
                }
                vk->vkCmdSetViewportSwizzleNV((VkCommandBuffer)dispatchHandle, firstViewport, viewportCount, pViewportSwizzles);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageToColorEnableNV:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetCoverageToColorEnableNV((VkCommandBuffer)dispatchHandle, coverageToColorEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageToColorLocationNV:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdSetCoverageToColorLocationNV((VkCommandBuffer)dispatchHandle, coverageToColorLocation);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageModulationModeNV:
            {
                ...
                memcpy((VkCoverageModulationModeNV*)&coverageModulationMode, *readStreamPtrPtr, sizeof(VkCoverageModulationModeNV));
                *readStreamPtrPtr += sizeof(VkCoverageModulationModeNV);
                vk->vkCmdSetCoverageModulationModeNV((VkCommandBuffer)dispatchHandle, coverageModulationMode);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageModulationTableEnableNV:
            {
                ...
                memcpy((VkBool32*)&coverageModulationTableEnable, *readStreamPtrPtr, sizeof(VkBool32));
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetCoverageModulationTableEnableNV((VkCommandBuffer)dispatchHandle, coverageModulationTableEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageModulationTableNV:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pCoverageModulationTable, ((coverageModulationTableCount)) * sizeof(const float));
                }
                memcpy((float*)pCoverageModulationTable, *readStreamPtrPtr, ((coverageModulationTableCount)) * sizeof(const float));
                *readStreamPtrPtr += ((coverageModulationTableCount)) * sizeof(const float);
                vk->vkCmdSetCoverageModulationTableNV((VkCommandBuffer)dispatchHandle, coverageModulationTableCount, pCoverageModulationTable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetShadingRateImageEnableNV:
            {
                ...
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetShadingRateImageEnableNV((VkCommandBuffer)dispatchHandle, shadingRateImageEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetRepresentativeFragmentTestEnableNV:
            {
                ...
                memcpy((VkBool32*)&representativeFragmentTestEnable, *readStreamPtrPtr, sizeof(VkBool32));
                *readStreamPtrPtr += sizeof(VkBool32);
                vk->vkCmdSetRepresentativeFragmentTestEnableNV((VkCommandBuffer)dispatchHandle, representativeFragmentTestEnable);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdSetCoverageReductionModeNV:
            {
                ...
                memcpy((VkCoverageReductionModeNV*)&coverageReductionMode, *readStreamPtrPtr, sizeof(VkCoverageReductionModeNV));
                *readStreamPtrPtr += sizeof(VkCoverageReductionModeNV);
                vk->vkCmdSetCoverageReductionModeNV((VkCommandBuffer)dispatchHandle, coverageReductionMode);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdOpticalFlowExecuteNV:
            {
                ...
                *readStreamPtrPtr += 8;
                ...
                reservedunmarshal_VkOpticalFlowExecuteInfoNV(readStream, VK_STRUCTURE_TYPE_MAX_ENUM, (VkOpticalFlowExecuteInfoNV*)(pExecuteInfo), readStreamPtrPtr);
                if (pExecuteInfo)
                {
                    transform_tohost_VkOpticalFlowExecuteInfoNV(globalstate, (VkOpticalFlowExecuteInfoNV*)(pExecuteInfo));
                }
                vk->vkCmdOpticalFlowExecuteNV((VkCommandBuffer)dispatchHandle, session, pExecuteInfo);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdBindShadersEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                ...
                {
                    readStream->alloc((void**)&pStages, ((stageCount)) * sizeof(const VkShaderStageFlagBits));
                }
                memcpy((VkShaderStageFlagBits*)pStages, *readStreamPtrPtr, ((stageCount)) * sizeof(const VkShaderStageFlagBits));
                ...
                *readStreamPtrPtr += 8;
                if (pShaders)
                {
                    ...
                    {
                        readStream->alloc((void**)&pShaders, ((stageCount)) * sizeof(const VkShaderEXT));
                    }
                ...
                vk->vkCmdBindShadersEXT((VkCommandBuffer)dispatchHandle, stageCount, pStages, pShaders);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdSetAttachmentFeedbackLoopEnableEXT:
            {
                ...
                memcpy((VkImageAspectFlags*)&aspectMask, *readStreamPtrPtr, sizeof(VkImageAspectFlags));
                *readStreamPtrPtr += sizeof(VkImageAspectFlags);
                vk->vkCmdSetAttachmentFeedbackLoopEnableEXT((VkCommandBuffer)dispatchHandle, aspectMask);
                android::base::endTrace();
                break;
            }
#endif
            ...
            case OP_vkCmdDrawMeshTasksEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                memcpy((uint32_t*)&groupCountZ, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdDrawMeshTasksEXT((VkCommandBuffer)dispatchHandle, groupCountX, groupCountY, groupCountZ);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdDrawMeshTasksIndirectEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                memcpy((uint32_t*)&stride, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdDrawMeshTasksIndirectEXT((VkCommandBuffer)dispatchHandle, buffer, offset, drawCount, stride);
                android::base::endTrace();
                break;
            }
            case OP_vkCmdDrawMeshTasksIndirectCountEXT:
            {
                ...
                *readStreamPtrPtr += sizeof(uint32_t);
                memcpy((uint32_t*)&stride, *readStreamPtrPtr, sizeof(uint32_t));
                *readStreamPtrPtr += sizeof(uint32_t);
                vk->vkCmdDrawMeshTasksIndirectCountEXT((VkCommandBuffer)dispatchHandle, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
                android::base::endTrace();
                break;
            }
#endif
