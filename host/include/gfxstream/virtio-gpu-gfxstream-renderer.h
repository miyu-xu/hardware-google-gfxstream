...
#define STREAM_FENCE_HANDLE_TYPE_EVENT_FD 0xa
#define STREAM_MEM_HANDLE_TYPE_SCREEN_BUFFER_QNX 0xb
#define STREAM_PLATFORM_HANDLE_TYPE_EGL_NATIVE_PIXMAP 0xc
