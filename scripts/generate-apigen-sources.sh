...
./build/gfxstream-generic-apigen -i ./codegen/gles1 -D ./host/gl/gles1_dec -B gles1
./build/gfxstream-generic-apigen -i ./codegen/gles1 -E ./guest/GLESv1_enc -B gl
...
./build/gfxstream-generic-apigen -i ./codegen/gles2 -D ./host/gl/gles2_dec -B gles2
./build/gfxstream-generic-apigen -i ./codegen/gles2 -E ./guest/GLESv2_enc -B gl2
rm codegen/gles2/gl2.attrib
rm codegen/gles2/gl2.in
rm codegen/gles2/gl2.types

./build/gfxstream-generic-apigen -i ./codegen/renderControl -D ./host/renderControl_dec -B renderControl
./build/gfxstream-generic-apigen -i ./codegen/renderControl -E ./guest/renderControl_enc -B renderControl
